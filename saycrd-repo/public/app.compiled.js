/* Auto-generated from app.jsx by build/compile.js — do not edit directly. */
const {
  useState,
  useEffect,
  useLayoutEffect,
...
function normalizeSentKey(t) {
  return (t || "").trim().replace(/\s+/g, " ").slice(0, 100);
}
function saveCapture(text, note, source) {
  ...
  try {
    window.dispatchEvent(new CustomEvent("saycrd-captures-updated"));
  } catch (x) {}
}
...
var SENTENCE_FEEDBACK_OPTIONS = [{
  ...
  id: "something_to_consider",
  label: "Something to Consider",
  color: "#8B7CC7"
}, {
  id: "hadnt_thought",
  label: "Hadn't Thought of This",
  color: "#6BBF7A"
}, {
  id: "doesnt_fit",
  label: "Doesn't Fit Quite Right",
  color: "#94A3B8"
}, {
  id: "not_feeling",
  label: "Not Feeling That",
  color: "#64748B"
}];
function SentenceFeedbackButtons({
  text,
  onFeedback,
  onClose,
  onGreyFlowActive,
  ...
  useEffect(function () {
    if (showCommentBox && textareaRef.current) textareaRef.current.focus();
  }, [showCommentBox]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, !showCommentBox && /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      position: "absolute",
      top: 14,
  ...
  }, "How did this land?"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, "\"", text.length > 80 ? text.slice(0, 77) + "…" : text, "\""), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 10
  ...
  }, "\u2726"), " Capture this"), showCommentBox && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      overflow: "hidden",
  ...
  }, pendingOption === "capture" ? "What do you want to remember?" : pendingOption === "dont_understand" ? "What would help? What's unclear?" : "What would you add or change?"), /*#__PURE__*/React.createElement("textarea", {
    ref: textareaRef,
    placeholder: pendingOption === "capture" ? "Your thoughts, reflections, what this sparked…" : pendingOption === "dont_understand" ? "What would make this clearer? What are you wondering?" : "Share what doesn't land or what you'd say instead…",
    value: optionalNote,
    onChange: function (e) {
    ...
    style: {
      ...
      fontWeight: 600,
      color: "#fff",
      background: pendingOption === "capture" ? "#6BB8FF" : "#4A8A8A",
      border: "none",
      borderRadius: 12,
      cursor: "pointer",
      boxShadow: pendingOption === "capture" ? "0 2px 8px rgba(107,184,255,0.35)" : "0 2px 4px rgba(74,138,138,0.3)"
    }
  }, pendingOption === "capture" ? "Save to journal" : "Save note"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      submit(false);
    },
    style: {
  ...
  }, pendingOption === "capture" ? "Save snippet only" : "Done without note"))), !showCommentBox && /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      marginTop: 14,
      fontSize: 12,
...
function HighlightableText({
  ...
  var opt = feedback ? SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
    return o.id === feedback;
  }) : null;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    ...
    onMouseEnter: function (e) {
      if (!feedback) e.currentTarget.style.background = dark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.04)";
    },
    onMouseLeave: function (e) {
      if (!feedback) e.currentTarget.style.background = "transparent";
    }
  }, text), open && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 2147483647,
      ...
      animation: "riseUp 0.2s ease both"
    },
    onClick: function () {
      if (!greyFlowActive) {
        setOpen(false);
        setGreyFlowActive(false);
      }
    }
  }, /*#__PURE__*/React.createElement("div", {
    onClick: function (e) {
  ...
  }, /*#__PURE__*/React.createElement(SentenceFeedbackButtons, {
    text: text,
    onFeedback: function (_text, optionId, optionalComment) {
      onFeedback && onFeedback(text, optionId, optionalComment);
      setOpen(false);
      setGreyFlowActive(false);
    },
    onClose: function () {
    ...
    onGreyFlowActive: setGreyFlowActive,
...
function getCurrentUid() {
  return typeof window !== "undefined" && window.currentUser && window.currentUser.id ? window.currentUser.id : "local";
}
...
function checkCrisisText(text) {
  ...
  return CRISIS_PHRASES.some(function (p) {
    return t.indexOf(p) >= 0;
  });
}
function normalizeThemeLabel(label) {
  return String(label || "").trim().toLowerCase();
}
var THEME_COLORS = ["#FF6B9D", "#FFB86B", "#6BFFB8", "#6BB8FF", "#B86BFF", "#FFD700", "#E84393", "#7DB7AE"];
function getThemeColor(theme, index) {
  return theme && theme.color ? theme.color : THEME_COLORS[(index || 0) % THEME_COLORS.length];
}
var NC = THEME_COLORS;
var LIFE_DOMAINS = {
  work: ["work", "job", "career", "tasks", "project", "boss", "colleague", "email", "meeting", "deadline", "productivity", "business"],
  relationship: ["partner", "relationship", "love", "family", "friend", "parent", "child", "connection", "intimacy", "marriage"],
  self: ["self", "identity", "worth", "body", "health", "energy", "rest", "boundary", "voice", "permission"],
  creativity: ["create", "creative", "art", "write", "build", "make", "idea", "vision", "dream"],
  money: ["money", "financial", "income", "abundance", "scarcity", "worth", "value"]
};
var LIFE_DOMAIN_LABELS = {
  work: "Work / Business",
...
function inferLifeDomain(shortDesc, label) {
  ...
  for (var domain in LIFE_DOMAINS) {
    if (LIFE_DOMAINS[domain].some(function (w) {
...
function FloatingWords({
  ...
  const v = Array.from(new Set(words.filter(function (w) {
    return w.length > 4;
  }))).slice(-12);
  ...
  }, v.map((w, i) => /*#__PURE__*/React.createElement("span", {
    key: "" + w + "-" + i,
    style: {
      position: "absolute",
      left: `${10 + i / Math.max(v.length - 1, 1) * 80}%`,
      top: `${45 + (Math.sin(i * 0.8) * 15 + i % 3 * 10)}%`,
      fontSize: 13 + i % 3 * 2,
      color,
      opacity: 0.04 + i / v.length * 0.08,
      fontFamily: FD,
      fontStyle: "italic",
      animation: `floatWord ${18 + i % 4 * 3}s ease-in-out infinite`,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        borderRadius: "50%",
        background: color,
        opacity: 0.12 + s % 20 * 0.015,
        animation: `floatParticle ${5 + s % 6}s ease-in-out infinite`,
        animationDelay: `${-(s % 5)}s`
      }
    });
  }));
}
...
function BubbleAnalysisBackground({
  rawText,
  palette
}) {
  var colors = palette || ["#4EC9B8", "#6BB8FF", "#A78BFA", "#7FFFD4", "#38BDF8", "#E84393"];
  var words = useMemo(function () {
    var w = ((rawText || "").match(/\b[a-zA-Z]{4,}\b/g) || []).filter(function (x) {
      return !BUBBLE_STOPWORDS.includes(x.toLowerCase());
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "cy",
      values: b.y + ";" + Math.max(5, b.y - 5) + ";" + b.y,
      dur: (b.dur || 10) + "s",
      begin: (b.delay || 0) + "s",
      ...
      values: b.opacity + ";" + b.opacity * 1.4 + ";" + b.opacity,
      dur: (b.dur || 10) + "s",
      begin: (b.delay || 0) + "s",
      repeatCount: "indefinite"
    }));
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        position: "absolute",
        left: (b ? b.x : 20 + i % 5 * 15) + "%",
        top: (b ? b.y : 30 + Math.floor(i / 5) * 20) + "%",
        transform: "translate(-50%, -50%)",
        fontSize: b && b.r > 18 ? 13 : b && b.r > 10 ? 11 : 9,
        color: wordColor,
        fontFamily: FD,
        fontStyle: "italic",
        ...
        whiteSpace: "nowrap",
        textShadow: "0 0 20px rgba(0,0,0,0.7), 0 0 6px " + wordColor + "88"
      }
    }, w);
  }), /*#__PURE__*/React.createElement("div", {
    style: {
...
function TransparentFindingUI({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 80% 50% at 50% 50%, rgba(0,20,40,0.4) 0%, transparent 70%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
    ...
    style: {
      fontSize: 9,
      letterSpacing: "0.4em",
      color: "rgba(107,184,255,0.5)",
      fontFamily: FB,
      textTransform: "uppercase",
      marginBottom: 20
    }
  }, "Under the hood"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        alignItems: "center",
        justifyContent: "center",
        background: isPast ? "rgba(78,201,184,0.3)" : isActive ? accent + "40" : "rgba(255,255,255,0.06)",
        border: "1px solid " + (isPast ? "rgba(78,201,184,0.5)" : isActive ? accent : "rgba(255,255,255,0.1)")
      }
    ...
    }, findingDetail && !/sending|claude/i.test(findingDetail) ? findingDetail : phase === "sending" ? "Analyzing your words — finding patterns and connections" : findingDetail || "Starting...") : null));
  }))));
}
function ProgressiveLoadingOverlay({
  loading,
  label,
  sublabel,
  children
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "saycrd-loading-indicator",
    style: {
      width: 8,
      height: 8,
      borderRadius: "50%",
...
function MapSkeleton() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      cy: p.y,
      r: "20",
      fill: NC[i % NC.length] + "18",
      stroke: NC[i % NC.length] + "44",
      strokeWidth: "1",
      opacity: "0.8",
      style: {
        animation: "nodeBreathe 2.5s ease-in-out infinite",
...
function ProcessingScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, isFinding && /*#__PURE__*/React.createElement(TransparentFindingUI, {
    findingPhase: findingPhase,
    findingDetail: findingDetail,
    palette: colors
  }), !isFinding && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      pointerEvents: "none"
    ...
    style: {
      fontSize: 9,
      letterSpacing: "0.5em",
      color: "rgba(107,200,255,0.35)",
      fontFamily: FB,
      textTransform: "uppercase",
      marginBottom: 16
    }
  }, "SAYCRD"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 26,
      fontWeight: 700,
      ...
      letterSpacing: "0.04em",
      lineHeight: 1.2,
      textShadow: "0 0 50px rgba(107,184,255,0.2)",
    ...
    style: {
      ...
      fontStyle: "italic",
      lineHeight: 1.6,
      animation: "riseUp 0.7s ease 0.15s both"
    }
    ...
    style: {
      ...
      right: 0,
      maxHeight: "48%",
      overflowY: stepKey === 2 ? "hidden" : "auto",
      overflowX: "hidden",
      scrollbarWidth: stepKey === 2 ? "none" : undefined,
      zIndex: 2,
      display: "flex",
      justifyContent: "center",
...
function LoadingWaveBox(props) {
  var title = props.title,
    labels = props.labels,
    isDesktopWide = !!props.isDesktopWide;
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: isDesktopWide ? 16 : isMobile ? 10 : 12,
      padding: isDesktopWide ? "26px 24px" : isMobile ? "14px 12px" : "16px 12px",
      background: "rgba(0,0,0,0.2)",
      borderRadius: isDesktopWide ? 18 : 12,
      border: "1px solid rgba(255,255,255,0.06)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 13 : 9,
      letterSpacing: "0.3em",
      color: "rgba(255,255,255,0.35)",
      fontFamily: FB,
      marginBottom: isDesktopWide ? 8 : 4
    }
  }, title), bars.map(function (b, i) {
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: "flex",
        alignItems: "center",
        gap: isDesktopWide ? 16 : isMobile ? 8 : 12
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        width: isDesktopWide ? 96 : isMobile ? 58 : 72,
        minWidth: isDesktopWide ? 96 : isMobile ? 58 : 72,
        fontSize: isDesktopWide ? 13 : isMobile ? 9 : 10,
        color: "rgba(255,255,255,0.5)",
        fontFamily: FB,
        letterSpacing: "0.12em",
        flexShrink: 0
      }
    }, labels[i] || labels[0]), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        minWidth: 0,
        height: isDesktopWide ? 11 : 8,
        borderRadius: isDesktopWide ? 6 : 4,
      ...
      style: {
        ...
        width: "100%",
        borderRadius: isDesktopWide ? 6 : 4,
        background: "linear-gradient(90deg, " + palette[i] + "99, " + palette[i] + ")",
        transformOrigin: "left center",
        WebkitTransformOrigin: "left center",
        animation: "reportStreamBar " + b.dur + "s ease-in-out " + b.delay + "s infinite",
        WebkitAnimation: "reportStreamBar " + b.dur + "s ease-in-out " + b.delay + "s infinite"
      }
    })));
  }));
}
function ReportWritingScreen({
  label,
  sublabel
}) {
  var isMobile = typeof window !== "undefined" && window.innerWidth < 480;
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      inset: 0,
      overflow: "hidden",
      background: "linear-gradient(180deg, #0A0812 0%, #0E0C1A 15%, #0F0E1E 40%, #0C0A18 75%, #080610 100%)",
      zIndex: 10,
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 70% 40% at 50% 30%, rgba(184,107,255,0.06) 0%, transparent 60%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 50% 50% at 80% 70%, rgba(78,201,184,0.04) 0%, transparent 55%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
    ...
    style: {
      ...
      color: "rgba(184,107,255,0.5)",
      fontFamily: FB,
      textTransform: "uppercase",
      marginBottom: isMobile ? 12 : 16
    }
  }, "FIELD REPORT"), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      letterSpacing: "0.04em",
      lineHeight: 1.2,
      textShadow: "0 0 80px rgba(184,107,255,0.3)",
      animation: "riseUp 0.6s ease both"
    }
  }, label), sublabel && /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      position: "absolute",
      bottom: isMobile ? "calc(8% + env(safe-area-inset-bottom, 0px))" : "10%",
      left: "50%",
      transform: "translateX(-50%)",
  ...
  }, /*#__PURE__*/React.createElement(LoadingWaveBox, {
    title: "Weaving your year",
    labels: ["sessions", "patterns", "themes", "threads", "weaving"]
  })));
}
function MapRevealCinematic({
  themes,
  connections,
  mapTitle
}) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var fromIdx = themes.findIndex(function (t) {
      return t.label === conn.from;
    });
    var toIdx = themes.findIndex(function (t) {
      return t.label === conn.to;
    });
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      x2: p2.x,
      y2: p2.y,
      stroke: themes[fromIdx] && themes[fromIdx].color || "#6BB8FF",
      strokeWidth: "2",
      opacity: "0.65",
      fill: "none",
      strokeDasharray: "300",
      ...
      style: {
        animation: "connectionReveal 2.8s ease-in-out forwards",
        animationDelay: midDelay + "s"
      }
    }));
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      filter: "url(#nodeGlow)",
      style: {
        animation: "themeReveal 2.2s ease-in-out forwards",
    ...
    }, (t.label || "").slice(0, 14), (t.label || "").length > 14 ? "…" : ""));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: "0 12px",
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        animation: "mapTitleReveal 1.5s ease-in-out " + delay + "s forwards",
        opacity: 0,
        marginBottom: 10,
        padding: "10px 14px",
    ...
    }, t.label), t.why && String(t.why).trim() ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
    ...
    }, "\"", String(t.why).slice(0, 60), String(t.why).length > 60 ? "…" : "", "\"") : null);
  }), connections.slice(0, 4).map(function (conn, ci) {
    var delay = 11 + ci * 1.3;
    var col = (themes.find(function (t) {
      return t.label === conn.from;
    }) || {}).color || "#6BB8FF";
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        fontSize: 10,
        color: "rgba(107,184,255,0.8)",
        fontFamily: FB,
        marginBottom: 2
      }
    }, conn.from, " \u2194 ", conn.to), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
    ...
    }, String(insight).slice(0, 70), String(insight).length > 70 ? "…" : ""));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      marginTop: 16,
      animation: "mapTitleReveal 1.8s ease-in-out 15.5s forwards",
      opacity: 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      letterSpacing: "0.5em",
      color: "rgba(107,184,255,0.6)",
      fontFamily: FB,
      marginBottom: 4
    }
  }, "YOUR MAP"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, mapTitle && String(mapTitle).trim() ? mapTitle : themes.length ? themes.length + " themes from your words" : "Ready")));
}
function ImaginalCells({
  stage,
  velocity,
  color
}) {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    return /*#__PURE__*/React.createElement("ellipse", {
      ...
      fill: "none",
      stroke: color,
      strokeWidth: si === 0 ? 1.2 : 0.5,
      strokeOpacity: si === 0 ? 0.22 : 0.06
    }, /*#__PURE__*/React.createElement("animate", {
      attributeName: "rx",
      values: 72 * scale + ";" + 74 * scale + ";" + 72 * scale,
      dur: 4 + si + "s",
      repeatCount: "indefinite"
    }), /*#__PURE__*/React.createElement("animate", {
      attributeName: "ry",
      values: 58 * scale + ";" + 60 * scale + ";" + 58 * scale,
      dur: 4 + si + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 130 45 Q 133 32 131 20",
    stroke: color,
    strokeWidth: "1.4",
    fill: "none",
    strokeOpacity: "0.3",
    ...
    attributeName: "d",
    values: "M 130 45 Q 133 32 131 20;M 130 45 Q 127 32 132 20;M 130 45 Q 133 32 131 20",
    dur: "3.5s",
    repeatCount: "indefinite"
    ...
    if (!cell.isIm) {
      ...
      return /*#__PURE__*/React.createElement("polygon", {
        key: cell.id,
        points: pts,
        fill: "rgba(190,180,168,0.14)",
        stroke: "rgba(210,200,188,0.28)",
        strokeWidth: "0.5"
      }, /*#__PURE__*/React.createElement("animateTransform", {
        attributeName: "transform",
        type: "translate",
        values: "0,0;" + cell.dx + "," + cell.dy + ";0,0",
        dur: cell.dur + "s",
        begin: cell.del + "s",
        repeatCount: "indefinite"
      }), /*#__PURE__*/React.createElement("animate", {
        attributeName: "opacity",
        values: "0.7;0.3;0.7",
        dur: (parseFloat(cell.dur) * 1.4).toFixed(1) + "s",
        begin: cell.del + "s",
        repeatCount: "indefinite"
      }));
    }
    return /*#__PURE__*/React.createElement("g", {
      ...
      attributeName: "r",
      values: cell.sz + ";" + cell.sz * 1.35 + ";" + cell.sz,
      dur: cell.dur + "s",
      begin: cell.del + "s",
      repeatCount: "indefinite"
    }), /*#__PURE__*/React.createElement("animate", {
      ...
      type: "translate",
      values: "0,0;" + cell.dx + "," + cell.dy + ";0,0",
      dur: (parseFloat(cell.dur) * 0.9).toFixed(1) + "s",
      begin: cell.del + "s",
      repeatCount: "indefinite"
    })), /*#__PURE__*/React.createElement("circle", {
      cx: cell.cx,
      ...
      attributeName: "r",
      values: cell.sz * 0.42 + ";" + cell.sz * 0.56 + ";" + cell.sz * 0.42,
      dur: (parseFloat(cell.dur) * 0.7).toFixed(1) + "s",
      begin: cell.del + "s",
      repeatCount: "indefinite"
    }), /*#__PURE__*/React.createElement("animateTransform", {
      attributeName: "transform",
  ...
  }), showWings && /*#__PURE__*/React.createElement("g", {
    opacity: wingOpacity
  }, /*#__PURE__*/React.createElement("filter", {
    id: "wingBlur"
  }, /*#__PURE__*/React.createElement("feGaussianBlur", {
    ...
    d: "M 130 108 Q 94 82 76 100 Q 62 118 88 132 Q 112 140 130 120",
    fill: color,
    fillOpacity: "0.22",
    stroke: color,
    strokeWidth: "1",
    ...
    d: "M 130 108 Q 166 82 184 100 Q 198 118 172 132 Q 148 140 130 120",
    fill: color,
    fillOpacity: "0.22",
    stroke: color,
    strokeWidth: "1",
...
function SeasonTree({
  ...
  var branches = [{
    d: "M 130 130 Q 107 115 90 122",
    w: 2.8,
    side: -1,
    pivot: "90 130"
  }, {
    d: "M 130 115 Q 153 96 170 100",
    w: 2.4,
    side: 1,
    pivot: "170 130"
  }, {
    d: "M 130 100 Q 110 80 97 83",
    w: 2.0,
    side: -1,
    pivot: "97 130"
  }, {
    d: "M 130 88 Q 150 70 162 73",
    w: 1.7,
    side: 1,
    pivot: "162 130"
  }, {
    d: "M 130 78 Q 124 60 121 52",
    w: 1.4,
    side: -0.5,
    pivot: "121 130"
  }, {
    d: "M 130 78 Q 136 62 139 54",
    w: 1.2,
    side: 0.5,
    pivot: "139 130"
  }];
  return /*#__PURE__*/React.createElement("svg", {
    ...
    rx: isSummer ? 72 : 45,
    ry: isSummer ? 60 : 38,
    fill: "url(#st_crownGlow)"
  }, /*#__PURE__*/React.createElement("animate", {
    attributeName: "rx",
    values: isSummer ? "70;78;70" : "43;50;43",
    dur: "4.5s",
    repeatCount: "indefinite"
  }), /*#__PURE__*/React.createElement("animate", {
    attributeName: "ry",
    values: isSummer ? "58;66;58" : "36;44;36",
    dur: "4.5s",
    repeatCount: "indefinite"
    ...
    return /*#__PURE__*/React.createElement("path", {
      key: ri,
      d: "M 130 168 Q " + ctrlX + " " + ctrlY + " " + endX + " " + endY,
      stroke: color,
      strokeWidth: "1.2",
      fill: "none",
      strokeOpacity: "0.18",
    ...
    d: "M 126 168 Q 128 135 129 110 Q 130 82 130 60",
    stroke: "rgba(180,155,110,0.4)",
    strokeWidth: "6",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 134 168 Q 132 135 131 110 Q 130 82 130 60",
    stroke: "rgba(155,130,90,0.22)",
    strokeWidth: "3.5",
    fill: "none",
    strokeLinecap: "round"
    ...
    if (!isSummer) {
      return /*#__PURE__*/React.createElement("g", {
        ...
        attributeName: "r",
        values: leaf.lr + ";" + leaf.lr * 1.5 + ";" + leaf.lr,
        dur: leaf.ldur + "s",
        begin: leaf.ldel + "s",
        repeatCount: "indefinite"
      }), /*#__PURE__*/React.createElement("animate", {
  ...
  for (var li = 0; li < nodeData.length; li++) {
    for (var lj = li + 1; lj < nodeData.length; lj++) {
      lines.push({
        ...
        y2: nodeData[lj].cy,
        col: nodeData[li].col,
        dur: (3.5 + li * 0.8).toFixed(2),
        del: (li * 0.6).toFixed(2)
      });
    }
  }
  return /*#__PURE__*/React.createElement("svg", {
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "r",
      values: nd.r * 2.8 + ";" + nd.r * 3.4 + ";" + nd.r * 2.8,
      dur: nd.dur + "s",
      begin: nd.del + "s",
      repeatCount: "indefinite"
    }));
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      attributeName: "r",
      values: nd.r + 5 + ";" + (nd.r + 10) + ";" + (nd.r + 5),
      dur: (parseFloat(nd.dur) * 1.3).toFixed(1) + "s",
      begin: nd.del + "s",
      repeatCount: "indefinite"
    }), /*#__PURE__*/React.createElement("animateTransform", {
      attributeName: "transform",
      type: "translate",
      values: "0,0;" + nd.dx + "," + nd.dy + ";0,0",
      dur: nd.dur + "s",
      begin: nd.del + "s",
      repeatCount: "indefinite"
    })), /*#__PURE__*/React.createElement("circle", {
...
function BreathingOrb({
  ...
  }, [50, 40, 30, 20].map((r, i) => /*#__PURE__*/React.createElement("circle", {
    key: i,
    cx: "80",
    cy: "80",
    r: r,
...
function PhaseIndicator({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 3,
      borderRadius: 2,
      background: i < current ? "rgba(255,255,255,0.6)" : i === current ? "rgba(255,255,255,0.85)" : "rgba(255,255,255,0.1)"
    }
  })));
}
function PourPhase({
  ...
  useEffect(function () {
    setWords(text.split(/\s+/).filter(function (x) {
      return x.length > 3;
    }));
  }, [text]);
  useEffect(function () {
  ...
  useEffect(function () {
    if (!text.trim()) return;
    try {
      localStorage.setItem(_draftKey, text);
    } catch (e) {}
  }, [text]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, showFloating ? /*#__PURE__*/React.createElement(FloatingWords, {
    words: words,
    color: "#6BB8FF"
  }) : null, /*#__PURE__*/React.createElement(Particles, {
    color: "#6BB8FF",
    count: isMobile ? 8 : 15
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      padding: isMobile ? "20px 20px 32px" : "32px 24px 40px",
      paddingBottom: "calc(" + (isMobile ? "100px" : "40px") + " + env(safe-area-inset-bottom, 0px))",
  ...
  }, "SAYCRD"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "What's alive", /*#__PURE__*/React.createElement("br", null), "in you right now?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 14,
  ...
  }, "Don't think. Just pour.")), /*#__PURE__*/React.createElement("textarea", {
    className: "pour-input",
    value: text,
    onChange: function (e) {
      setText(e.target.value);
    },
    placeholder: "Let the words flow through you\u2026",
    autoCorrect: "on",
    ...
    style: {
      marginTop: 24,
      padding: "20px 0",
      borderTop: "1px solid rgba(107,184,255,0.15)"
    }
  }, /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      width: "100%",
      background: canContinue ? "linear-gradient(135deg, #6BB8FF, #3D8BFF)" : "rgba(107,184,255,0.15)",
      border: canContinue ? "none" : "1px solid rgba(107,184,255,0.3)",
      borderRadius: 24,
      padding: "18px 28px",
      minHeight: 56,
      color: canContinue ? "white" : "rgba(255,255,255,0.5)",
      fontSize: 17,
      fontFamily: FB,
      fontWeight: 600,
      ...
      boxShadow: canContinue ? "0 4px 20px rgba(107,184,255,0.35)" : "none"
    }
  }, canContinue ? "Synthesize →" : "20 words to continue"), onBack && /*#__PURE__*/React.createElement("button", {
    onClick: onBack,
    style: {
      marginTop: 12,
      width: "100%",
  ...
  }, "\u2190 Back"))) : /*#__PURE__*/React.createElement(React.Fragment, null, !isMobile && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      letterSpacing: "0.4em",
      fontWeight: 600,
  ...
  }, "POUR"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "Don't think. Just pour."), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "24px 16px",
    ...
    style: {
      width: "100%",
      maxWidth: 340,
      background: canContinue ? "linear-gradient(135deg, #6BB8FF, #3D8BFF)" : "rgba(107,184,255,0.12)",
      border: canContinue ? "none" : "1px solid rgba(107,184,255,0.25)",
      borderRadius: 24,
      padding: "18px 28px",
      minHeight: 56,
      color: canContinue ? "white" : "rgba(255,255,255,0.5)",
  ...
  useEffect(function runSynthesis() {
    ...
    if (prevSessions.length > 0) {
      ...
      prevSessions.slice(-6).forEach(function (s) {
        ...
        var themes = (s.themes || []).map(function (t) {
          return t.label;
        }).join(", ");
        ...
        if (s.mapResponses) {
          Object.keys(s.mapResponses).forEach(function (connKey) {
            ...
            if (mr.value === "no") {
              if (mr.comment && mr.comment.trim()) pastCorrections.push("[" + connLabel + "]: user said \"" + mr.comment.trim() + "\"");else pastRejections.push(connLabel);
            }
          });
        }
        if (s.reactions) {
      ...
      prevSessions.forEach(function (s) {
        (s.archetypes || []).forEach(function (a) {
          ...
          if (!archCounts[key]) archCounts[key] = {
            count: 0,
            names: [],
            lastResponse: ""
          };
      ...
      var recurring = Object.keys(archCounts).filter(function (k) {
        return archCounts[k].count >= 2;
      });
    ...
    if (fieldState && fieldState.sessionCount >= 2) {
      ...
      if (fieldState.rising && fieldState.rising.length > 0) temporalContext += "RISING themes (getting louder): " + fieldState.rising.map(function (r) {
        return r.label + " (+" + r.delta + ")";
      }).join(", ") + "\n";
      if (fieldState.fading && fieldState.fading.length > 0) temporalContext += "FADING themes (loosening grip): " + fieldState.fading.map(function (f) {
        return f.label + " (" + f.delta + ")";
      }).join(", ") + "\n";
      ...
      if (fieldState.constellations && fieldState.constellations.length > 0) temporalContext += "CONSTELLATIONS: " + fieldState.constellations.map(function (c) {
        return c.pair + " (" + c.count + "x)";
      }).join(", ") + "\n";
    }
    ...
    (async function () {
      try {
        ...
        if (parsed && parsed.themes && parsed.themes.length > 0) {
          ...
          parsed.themes = parsed.themes.map(function (t, i) {
            return Object.assign({}, t, {
              color: NC[i % NC.length]
            });
          });
          ...
          if (parsed.connections) parsed.connections = parsed.connections.map(function (c) {
            var ft = (parsed.themes || []).find(function (t) {
              return t.label === c.from;
            });
            return Object.assign({}, c, {
              color: ft ? ft.color : NC[0]
            });
          });
          setData(parsed);
          setStatus("ready");
          ...
          throw new Error("No themes parsed from AI response");
        }
      } catch (e) {
        ...
        if (_msg && (_msg.indexOf("empty response") >= 0 || _msg.indexOf("timed out") >= 0 || _msg.indexOf("json parse failed") >= 0 || _msg.indexOf("proxy 504") >= 0 || _msg.indexOf("proxy 502") >= 0 || _msg.indexOf("proxy 503") >= 0 || _msg.indexOf("gateway timeout") >= 0 || _msg.indexOf("failed to fetch") >= 0)) {
          ...
          try {
            ...
            if (retryData && retryData.themes && retryData.themes.length > 0) {
              retryData.themes = retryData.themes.map(function (t, i) {
                return Object.assign({}, t, {
                  color: NC[i % NC.length]
                });
              });
              if (Array.isArray(retryData.archetypes)) retryData.archetypes = retryData.archetypes.slice(0, 1);else if (retryData.archetype) retryData.archetypes = [retryData.archetype];
              retryData.connections = (retryData.connections || []).map(function (c) {
                var ft = (retryData.themes || []).find(function (t) {
                  return t.label === c.from;
                });
                return Object.assign({}, c, {
                  color: ft ? ft.color : NC[0]
            ...
            console.error("[SAYCRD] Retry also failed:", e2);
          }
        }
...
function SynthesizePhase({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, crisisState === "detected" && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 99999,
      ...
      animation: "riseUp 0.25s ease both"
    },
    onClick: function (e) {
  ...
  }, "We noticed some language that might suggest you're going through something difficult. If you're struggling, these resources are here for you:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 14,
  ...
  }, "If you're okay and want to continue, you can proceed."), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      synth.clearCrisis();
    },
    style: {
      ...
      borderRadius: 20,
      border: "none",
      background: "linear-gradient(135deg, rgba(107,184,255,0.35), rgba(107,184,255,0.2))",
      color: "#fff",
      fontFamily: FB,
      fontSize: 14,
      fontWeight: 600,
      cursor: "pointer",
      letterSpacing: "0.04em",
      boxShadow: "0 4px 20px rgba(107,184,255,0.2)"
    }
  }, "Continue"))), err ? /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      height: "100%",
      display: "flex",
  ...
  }, "Error: ", err.length > 90 ? err.slice(0, 90) + "…" : err), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
  ...
  }, "go back and retry")) : /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      overflow: "hidden",
      ...
      padding: "24px 20px",
      ...(revealFadeOut ? {
        animation: "revealFadeOut 1.8s ease-in-out forwards"
      } : {})
    }
  }, /*#__PURE__*/React.createElement(ProgressiveLoadingOverlay, {
  ...
  }, revealData && revealData.themes && revealData.themes.length > 0 ? /*#__PURE__*/React.createElement(MapRevealCinematic, {
    themes: revealData.themes,
    connections: revealData.connections || [],
    mapTitle: revealData.map_title || revealData.mapTitle
  }) : /*#__PURE__*/React.createElement(MapSkeleton, null)))));
}
function InsightDrawer({
  ...
  useEffect(function () {
    ...
    function m(e) {
      setDragPos({
        x: e.clientX - dragOff.x,
        y: e.clientY - dragOff.y
      });
    }
    function u() {
      setDragOff(null);
  ...
  var _drawerW = 320;
  var _drawerH = 420;
  var _clampedDrag = dragPos && isMobile ? {
    x: Math.max(_pad, Math.min(_vw - _drawerW - _pad, dragPos.x)),
    y: Math.max(_pad, Math.min(_vh - _drawerH - _pad, dragPos.y))
  } : null;
  const s = _clampedDrag ? {
    ...
    transform: "none",
    maxWidth: _drawerW,
    maxHeight: "calc(100vh - " + _pad * 2 + "px)"
  } : mobileSheet ? {
    width: "100%",
    maxWidth: "100%",
    minWidth: 0,
    ...
    width: 320,
    maxWidth: "min(320px, calc(100vw - " + _pad * 2 + "px))",
    maxHeight: "calc(100vh - " + _pad * 2 + "px)",
    overflow: "auto"
  };
  var _desktopWrap = !mobileSheet && !_clampedDrag;
  var _drawerEl = /*#__PURE__*/React.createElement("div", {
    ref: ref,
    ...
    style: {
      position: mobileSheet ? "relative" : _desktopWrap ? "relative" : "fixed",
      ...s,
      width: mobileSheet ? undefined : 320,
      maxWidth: mobileSheet ? undefined : "min(320px, calc(100vw - " + _pad * 2 + "px))",
      background: `linear-gradient(160deg, rgba(18,20,35,0.98), rgba(28,25,50,0.96))`,
      border: `1.5px solid ${accent}88`,
      borderRadius: mobileSheet ? "20px 20px 0 0" : 18,
      backdropFilter: "blur(20px)",
      zIndex: 30,
      cursor: dragOff ? "grabbing" : "grab",
      ...
      touchAction: "none",
      boxShadow: `0 0 50px ${accent}20, 0 20px 60px rgba(0,0,0,0.6)`
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
  ...
  }, connection.nodeA, " ", "\u2194", " ", connection.nodeB), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "ai read"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 17,
      color: "#fff",
      fontFamily: FD,
  ...
  }, connection.insight)), !done && /*#__PURE__*/React.createElement("div", {
    "data-slider": "true"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
  ...
  }, "how much does this feel like your life?"), /*#__PURE__*/React.createElement(SpectrumSlider, {
    color: accent,
    poleA: "not how it lives in me",
    poleB: "very alive in me",
    onSet: handleSet,
    value: value
  })), done && !showComment && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "8px 0",
      animation: "riseUp 0.5s ease"
    }
  }, value > 66 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontFamily: FB,
      color: accent,
  ...
  }, "very alive right now \u2713") : value > 33 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontFamily: FB,
      color: accent,
  ...
  }, "there's something real here \u2713") : /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      fontFamily: FB,
      color: "rgba(214,178,100,0.8)",
      fontWeight: 600
    }
  }, "not quite how it lives in you"), value >= 33 && /*#__PURE__*/React.createElement("button", {
    onClick: function (e) {
      e.stopPropagation();
      setShowComment(true);
    },
  ...
  }, "Enter to close")), done && showComment && /*#__PURE__*/React.createElement("div", {
    style: {
      animation: "riseUp 0.4s ease",
      marginTop: 8
    }
  }, value <= 33 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "rgba(214,178,100,0.7)",
      fontFamily: FB,
      letterSpacing: "0.1em",
      marginBottom: 10
    }
  }, "in your words, what\u2019s here between these?") : /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: accent + "88",
      fontFamily: FB,
  ...
  }, "anything you\u2019d add to this pull?"), /*#__PURE__*/React.createElement("textarea", {
    value: comment,
    onChange: function (e) {
    ...
    style: {
      fontSize: 10,
      color: "rgba(214,178,100,0.9)",
      fontFamily: FB
    }
  }, "your words are how this lives in you") : /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      fontSize: 11,
      color: "rgba(255,255,255,0.7)",
  ...
  }, "close without note"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      submitComment();
      onClose();
    },
  ...
  }, value <= 33 ? "this is how it lives" : "noted"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: "rgba(255,255,255,0.6)",
      fontFamily: FB,
  ...
  return _desktopWrap ? /*#__PURE__*/React.createElement("div", {
    onClick: onClose,
    style: {
      position: "fixed",
      inset: _pad,
  ...
  }, _drawerEl) : mobileSheet ? /*#__PURE__*/React.createElement("div", {
    onClick: onClose,
    style: {
      position: "fixed",
      inset: 0,
      ...
      overflow: "hidden",
      WebkitOverflowScrolling: "touch",
      paddingLeft: "max(" + _pad + "px, env(safe-area-inset-left, 0px))",
      paddingRight: "max(" + _pad + "px, env(safe-area-inset-right, 0px))",
      boxSizing: "border-box"
    }
  }, _drawerEl) : _drawerEl;
}
...
function MapLoadingOverlay() {
  ...
  useEffect(function () {
    var t = setInterval(function () {
      setIdx(function (i) {
        return (i + 1) % MAP_LOADING_PHRASES.length;
      });
    }, 2200);
    return function () {
      clearInterval(t);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      flexShrink: 0,
      padding: isDesktopWide ? "56px 20px 0" : "24px 20px 0",
      paddingLeft: "8%",
      width: "100%",
      boxSizing: "border-box"
    }
    ...
    style: {
      fontSize: isDesktopWide ? 26 : 17,
      letterSpacing: "0.5em",
      color: "rgba(107,184,255,0.6)",
      fontFamily: FB,
      marginBottom: isDesktopWide ? 16 : 8
    }
  }, "YOUR MAP"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 34 : 18,
      fontFamily: FD,
      fontStyle: "italic",
      color: "rgba(200,235,255,0.95)",
      lineHeight: 1.5,
      transition: "opacity 0.5s ease",
      minHeight: isDesktopWide ? 52 : 32,
      maxWidth: isDesktopWide ? 720 : undefined
    }
  }, phrase), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 16 : 13,
      color: "rgba(150,200,255,0.5)",
      fontFamily: FB,
      letterSpacing: "0.08em",
      marginTop: isDesktopWide ? 18 : 12
    }
  }, "Click connections to uncover relationships")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0
    }
    ...
    style: {
      flexShrink: 0,
      padding: isDesktopWide ? "0 20px calc(6% + env(safe-area-inset-bottom, 0px)) 20px" : "0 20px calc(10% + env(safe-area-inset-bottom, 0px)) 20px",
      width: "100%",
      maxWidth: isDesktopWide ? 480 : 340,
      margin: isDesktopWide ? "0 8% 0 auto" : "0 auto",
      boxSizing: "border-box"
    }
  }, /*#__PURE__*/React.createElement(LoadingWaveBox, {
    title: "Weaving your map",
    labels: ["themes", "connections", "patterns", "threads", "emerging"],
...
function MapPhase({
  ...
  function bestFallbackInsight(label) {
    try {
      if (!label) return "";
      var rel = conns.filter(function (c) {
        return c.from === label || c.to === label;
      });
  ...
  const selectedDetail = useMemo(() => {
    ...
    var related = conns.filter(function (c) {
      return c.from === selectedNode || c.to === selectedNode;
    });
    var notes = related.map(function (c) {
      ...
      return {
        k: k,
        other: c.from === selectedNode ? c.to : c.from,
        value: r.value,
        comment: String(r.comment).trim()
      };
    }).filter(Boolean);
    var theme = sd && sd.themes ? sd.themes.find(function (t) {
      return t.label === selectedNode;
    }) : null;
  ...
  const nodeWeightByKey = useMemo(() => {
    ...
    nodes.forEach(function (n) {
      m[n.key] = (sd && sd.themes ? (sd.themes.find(function (t) {
        return t.label === n.key;
      }) || {}).weight : null) || 1;
    });
    return m;
  }, [nodes, sd]);
  function strengthScore(c) {
    ...
    var bonus = 0;
    if (r) {
      if (r.value === "yes") bonus += 3;else if (r.value === "partly") bonus += 1.5;else if (r.value === "no") bonus += 0.5;
  ...
  useLayoutEffect(() => {
    ...
    var tryMeasure = function () {
      ...
      if (!el) {
        if (attempts++ < 20) rafId = requestAnimationFrame(tryMeasure);
        return;
      }
  ...
  useLayoutEffect(() => {
    ...
    var adj = {};
    displayNodes.forEach(function (_, i) {
      adj[i] = [];
    });
    var edges = [];
    ...
    var degree = displayNodes.map(function (_, i) {
      return adj[i].length;
    });
    ...
    var invOrder = order.map(function (_, i) {
  ...
  var hasConn = function (a, b) {
    return conns.some(function (c) {
      return c.from === a && c.to === b || c.from === b && c.to === a;
    });
  };
  var hasDiscovered = function (a, b) {
    return discoveredConns.some(function (c) {
      return c.from === a && c.to === b || c.from === b && c.to === a;
    });
  };
  var anyConn = function (a, b) {
    return hasConn(a, b) || hasDiscovered(a, b);
  };
  var getDiscovered = function (a, b) {
    return discoveredConns.find(function (c) {
      return c.from === a && c.to === b || c.from === b && c.to === a;
    });
  };
  const makeConn = async (a, b) => {
    var nodeB = nodes.find(function (n) {
      return n.key === b;
    });
    ...
    setDiscoveredConns(function (prev) {
    ...
    var fb = {
      ...
      to: b,
      label: "LINKED",
      insight: a + " and " + b + " — you see a relationship here. What does one reveal about the other?",
      color: col,
      discovered: true
    };
    setDiscoveredConns(function (prev) {
      return prev.map(function (c) {
        return c.from === a && c.to === b ? fb : c;
      });
    });
    setTimeout(function () {
      setActiveConn(fb);
  ...
  useEffect(function () {
    ...
    var m = function (e) {
      ...
      var pd = pointerDownPos.current;
      if (!pd) return;
      if (Math.hypot(x - pd.x, y - pd.y) > 10) {
        didDrag.current = true;
        snapRef.current = null;
        var r = fieldRef.current && fieldRef.current.getBoundingClientRect();
        if (!r) {
          setPointerDownKey(null);
          return;
        }
        var p = pos[pointerDownKey] || {
          x: 0,
          y: 0
        };
        setDragging({
  ...
  useEffect(() => {
    ...
    const m = e => {
      ...
      requestAnimationFrame(function () {
        ...
        var ev = lastMoveRef.current;
        if (!ev) return;
        lastMoveRef.current = null;
        const r = fieldRef.current ? fieldRef.current.getBoundingClientRect() : null;
        if (!r) return;
  ...
  if (needsSynthesis) {
    ...
    if (synth.status === "error") {
      ...
      }, "Error: ", synth.error && synth.error.length > 90 ? synth.error.slice(0, 90) + "…" : synth.error), /*#__PURE__*/React.createElement("button", {
        onClick: function () {
          window.location.reload();
        },
        style: {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 100% 80% at 50% 30%, rgba(80,60,140,0.06) 0%, transparent 55%)",
      pointerEvents: "none",
      zIndex: 0
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 70% 50% at 80% 70%, rgba(107,184,255,0.04) 0%, transparent 60%)",
      pointerEvents: "none",
      zIndex: 0
    }
  }), /*#__PURE__*/React.createElement(Particles, {
    color: "rgba(107,184,255,0.25)",
    count: isMobile ? 6 : 14
  }), /*#__PURE__*/React.createElement("div", {
    ref: fieldRef,
    onClick: function (e) {
      if (!e.target.closest || !e.target.closest("button") && !e.target.closest("[data-node]")) {
        setActiveConn(null);
        setSelectedNode(null);
      }
    },
    style: {
      ...
      minHeight: 0,
      overflow: "hidden",
      boxShadow: "inset 0 2px 8px rgba(0,0,0,0.15), inset 0 0 80px rgba(0,0,0,0.08)"
    }
  }, isLoading && /*#__PURE__*/React.createElement(MapLoadingOverlay, null), !isLoading && nodes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: isDesktopWide ? 32 : 12,
      left: "8%",
      right: 16,
      zIndex: 2,
      pointerEvents: "none"
    ...
    style: {
      fontSize: isDesktopWide ? 24 : 17,
      letterSpacing: "0.5em",
      color: "rgba(107,184,255,0.6)",
      fontFamily: FB,
      marginBottom: isDesktopWide ? 12 : 8
    }
  }, "YOUR MAP"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 22 : 17,
      color: "rgba(200,235,255,0.85)",
      fontFamily: FD,
      fontStyle: "italic"
    }
  }, "Click on connections to uncover relationships")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: 0,
      left: 0,
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 90% 70% at 50% 50%, rgba(40,50,90,0.08) 0%, transparent 70%)",
      pointerEvents: "none",
      zIndex: 0
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 80% 55% at 50% 50%, transparent 50%, rgba(0,0,0,0.35) 100%)",
      pointerEvents: "none",
      zIndex: 1
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    var k = K(c),
      resp = responses[k],
      ep = edgePt(c.from, c.to);
    var _sva = pos[c.from],
      _svb = pos[c.to];
    if (!_sva || !_svb) return null;
    {
      var _svdx = _svb.x + 60 - (_sva.x + 60),
        _svdy = _svb.y + 20 - (_sva.y + 20);
      if (Math.sqrt(_svdx * _svdx + _svdy * _svdy) < 90) return null;
    }
    const isAct = activeConn && K(activeConn) === k;
    let stroke = "rgba(255,255,255,0.32)",
      sw = 2,
      dash = "8 5",
      op = 1,
      glowStroke = "rgba(255,255,255,0.12)";
    if (resp?.value === "yes") {
      stroke = "rgba(107,211,198,0.88)";
      sw = 3;
      dash = "none";
      glowStroke = "rgba(107,211,198,0.25)";
    } else if (resp?.value === "partly") {
      stroke = "rgba(165,235,220,0.7)";
      sw = 2.5;
      dash = "none";
      glowStroke = "rgba(165,235,220,0.2)";
      ...
      sw = hasWord ? 2.5 : 1.5;
      dash = "5 4";
      glowStroke = "rgba(214,178,100,0.15)";
    }
    if (isAct) {
      stroke = `${c.color}cc`;
      sw = 3;
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      y2: ep.y2,
      stroke: flowStroke,
      strokeWidth: resp?.value === "yes" || resp?.value === "partly" ? 1.8 : 1,
      strokeLinecap: "round",
      strokeDasharray: "6 18",
      style: {
        animation: "flowLine " + (resp?.value === "yes" || resp?.value === "partly" ? "2.2" : "4") + "s linear infinite"
      }
    }));
  }), selectedNode && (() => {
    ...
    var isExp = !!resp;
    var accent = isUserDefined ? "#D6B264" : c.color;
    var _lpa = pos[c.from],
      _lpb = pos[c.to];
    if (!_lpa || !_lpb) return null;
    {
      var _ldx = _lpb.x + 60 - (_lpa.x + 60),
        _ldy = _lpb.y + 20 - (_lpa.y + 20);
      if (Math.sqrt(_ldx * _ldx + _ldy * _ldy) < 90) return null;
    }
    return /*#__PURE__*/React.createElement("div", {
      key: k,
      onClick: function (e) {
      ...
      style: {
        ...
        top: m.y,
        transform: "translate(-50%, -50%)",
        padding: isDesktopWide ? "8px 16px" : "6px 12px",
        borderRadius: isDesktopWide ? 10 : 8,
        fontSize: isDesktopWide ? 12 : 10,
        fontWeight: 700,
        fontFamily: FB,
        letterSpacing: "0.06em",
        textTransform: "uppercase",
        ...
        cursor: "pointer",
        whiteSpace: "normal",
        maxWidth: isDesktopWide ? 200 : 160,
        textAlign: "center",
        lineHeight: 1.25,
        zIndex: isAct ? 15 : 5,
    ...
    }), isUserDefined ? /*#__PURE__*/React.createElement("span", {
      title: "you: " + resp.comment
    }, resp.comment.trim()) : c.label);
  }), allConns.map(c => {
    const m = mid(c),
      k = K(c),
      resp = responses[k];
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontFamily: FD,
        fontStyle: "italic",
        color: "rgba(165,235,220,0.95)",
        maxWidth: 140,
        textAlign: "center",
        lineHeight: 1.3,
        animation: "riseUp 0.5s ease"
      }
    }, "\"", resp.correction.length > 45 ? resp.correction.slice(0, 43) + "…" : resp.correction, "\"");
  }), displayNodes.map((n, ni) => {
    var _pi = displayNodes.indexOf(n);
    var _fbc = displayNodes.length;
    var _fbr = 90;
    var p = pos[n.key] || {
      x: fieldSize ? fieldSize.w / 2 - 55 + Math.cos(2 * Math.PI * _pi / _fbc) * _fbr : 100,
      y: fieldSize ? fieldSize.h / 2 - 18 + Math.sin(2 * Math.PI * _pi / _fbc) * _fbr : 100
    };
    const isDrag = dragging && dragging.key === n.key;
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        letterSpacing: "0.06em",
        whiteSpace: "nowrap",
        maxWidth: isDesktopWide ? 200 : 140,
        background: isSnap ? "rgba(125,183,174,0.28)" : n.w > 0.7 ? `rgba(214,178,109,0.35)` : n.color + "25",
        border: isSnap ? "1.5px solid rgba(125,183,174,0.85)" : isSel ? "1.5px solid #6BFFB8" : canLink ? `1.5px solid ${n.color}dd` : n.w > 0.7 ? "1.5px solid rgba(214,178,109,0.6)" : `1.5px solid ${n.color}88`,
        backdropFilter: "blur(12px)",
        WebkitBackdropFilter: "blur(12px)",
        cursor: isDrag ? "grabbing" : "pointer",
        zIndex: isDrag ? 20 : isSel || isSnap ? 10 : 3,
        ...
        boxShadow: isSnap ? "inset 0 1px 0 rgba(255,255,255,0.12), 0 6px 24px rgba(0,0,0,0.4), 0 0 28px rgba(125,183,174,0.5), 0 0 12px rgba(125,183,174,0.25)" : isSel ? "inset 0 1px 0 rgba(255,255,255,0.12), 0 6px 24px rgba(0,0,0,0.4), 0 0 28px rgba(107,255,184,0.35), 0 0 10px rgba(107,255,184,0.2)" : `inset 0 1px 0 rgba(255,255,255,0.12), 0 6px 20px rgba(0,0,0,0.35), 0 0 ${isDrag ? 32 : 20}px ${n.color}${isDrag ? "88" : "55"}, 0 0 10px ${n.color}44`,
        touchAction: "none",
        userSelect: "none",
    ...
    }, n.display || n.key, n.domain && n.domain !== "life" && /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        bottom: 2,
        right: 2,
        ...
        height: 5,
        borderRadius: 3,
        background: domainColors[n.domain] || domainColors.life,
        opacity: 0.85
      },
      title: n.domain
    })));
  }), selectedDetail && !activeConn && /*#__PURE__*/React.createElement("div", {
    onClick: function (e) {
      e.stopPropagation();
    },
    style: {
      position: "absolute",
      left: isMobile ? "max(20px, env(safe-area-inset-left, 0px))" : 16,
      right: isMobile ? "max(20px, env(safe-area-inset-right, 0px))" : 16,
      bottom: isMobile ? "calc(100px + env(safe-area-inset-bottom, 0px))" : "calc(90px + env(safe-area-inset-bottom, 0px))",
  ...
  }, selectedDetail.label)), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      setSelectedNode(null);
    },
    style: {
  ...
  }, "close")), selectedDetail.whyNode && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      paddingTop: 10,
  ...
  }, "Where this came from"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "#fff",
      fontFamily: FD,
  ...
  }, selectedDetail.whyNode)), selectedDetail.notes && selectedDetail.notes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      paddingTop: 10,
      borderTop: "1px solid rgba(255,255,255,0.08)"
  ...
  }, "Your notes"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 6,
    ...
    }, n.other), /*#__PURE__*/React.createElement("span", {
      style: {
        color: "rgba(255,255,255,0.7)"
      }
    }, " \u2014 "), n.comment);
  }))), selectedDetail.related && selectedDetail.related.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      paddingTop: 10,
      borderTop: "1px solid rgba(255,255,255,0.08)"
  ...
  })))), activeConn && ReactDOM.createPortal(/*#__PURE__*/React.createElement(InsightDrawer, {
    connection: {
      nodeA: activeConn.from,
      nodeB: activeConn.to,
      label: activeConn.label,
      insight: activeConn.insight,
      color: activeConn.color,
      evidence_quote: activeConn.evidence_quote,
      whyFromShare: activeConn.whyFromShare,
      mechanism: activeConn.mechanism
    },
      ...
      if (slider < 50 && cmt && cmt.trim() && onPatchSynthesis && activeConn) {
        ...
        (async function () {
          try {
            ...
            var dw = parseJSON(rw);
            if (dw && dw.insight) onPatchSynthesis({
              connections: [{
                from: fn,
                to: tn,
                insight: dw.insight,
    ...
    style: {
      ...
      background: "linear-gradient(0deg, transparent 0%, rgba(6,9,16,0.4) 40%, rgba(6,9,16,0.6) 100%)",
      zIndex: 30,
      display: "flex",
      flexDirection: "column",
      gap: 8,
  ...
  }, "\u2190 Back"), nodes.length > 0 && onComplete && /*#__PURE__*/React.createElement("button", {
    onClick: function () {
    ...
    style: {
      width: "100%",
      maxWidth: 340,
      background: "linear-gradient(135deg, #6BFFB8, #3DFFAA)",
      border: "none",
      color: "#0A2E1A",
      fontSize: 17,
      fontFamily: FB,
...
const GUIDE_ITEMS = [{
  type: "act",
  text: "Write down the one thing you'd build if money were irrelevant. Put it somewhere you'll see it tomorrow."
}, {
  type: "sit",
  text: "Sit with the question: when you say 'proof,' who are you proving it to? Don't answer. Just hold it."
}, {
  type: "deepen",
  text: "The word 'control' appeared 12 times. Ask yourself — what am I actually afraid of losing?"
}, {
  type: "release",
  text: "Name one expectation about SAYCRD you're ready to set down. You don't have to drop it — just set it down."
}, {
  type: "notice",
  text: "This week, notice when you use the word 'should.' Write down what you actually feel instead."
}];
function SpectrumSlider({
  ...
  function hd(e) {
    ...
    setD(true);
    upd(e);
    if (tr.current && e.pointerId != null) tr.current.setPointerCapture(e.pointerId);
  }
  useEffect(function () {
    if (!d) return;
    function m(e) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 13,
      color: p < 40 ? PICKER_ACCENT : "rgba(255,255,255,0.75)",
      fontFamily: FB,
      fontWeight: 500,
      transition: "color 0.3s"
    }
  }, poleA), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: p > 60 ? PICKER_ACCENT : "rgba(255,255,255,0.75)",
      fontFamily: FB,
      fontWeight: 500,
      transition: "color 0.3s"
    }
  }, poleB)), /*#__PURE__*/React.createElement("div", {
    ref: tr,
    onPointerDown: hd,
    style: {
      position: "relative",
    ...
    style: {
      ...
      right: 0,
      height: 3,
      background: PICKER_TRACK_INACTIVE,
      borderRadius: 2
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      height: 3,
      width: p + "%",
      background: "linear-gradient(90deg," + PICKER_ACCENT + "99," + PICKER_ACCENT + ")",
      borderRadius: 2,
      transition: d ? "none" : "width 0.1s"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: p + "%",
      transform: "translateX(-50%)",
      width: confirmed ? 30 : 26,
      height: confirmed ? 30 : 26,
      borderRadius: "50%",
    ...
    style: {
      ...
      fontFamily: FB,
      fontWeight: 600,
      background: PICKER_ACCENT + "22",
      border: "1px solid " + PICKER_ACCENT + "66",
      borderRadius: 20,
      padding: "8px 28px",
      cursor: "pointer",
      letterSpacing: "0.08em",
    ...
    style: {
      ...
      marginTop: 10,
      fontSize: 11,
      color: PICKER_ACCENT + "cc",
      fontFamily: FB,
      letterSpacing: "0.1em"
    }
  }, "\u2713 set \u2014 drag to adjust"));
}
function GuideHoldSave({
  color,
  onSave,
  isMobile
}) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 5,
      background: color,
      boxShadow: holding ? "0 0 10px " + color : "none",
      transition: holding ? "none" : "width 0.2s, opacity 0.2s",
      opacity: holding ? 1 : 0
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
...
function GuideItem({
  ...
  return /*#__PURE__*/React.createElement("div", {
    onClick: function () {
      if (!expanded && !saved) setExpanded(true);
    },
    style: {
      padding: "16px 18px",
      borderRadius: 14,
      ...
      cursor: expanded || saved ? "default" : "pointer",
      transition: "all 0.3s",
  ...
  }, gt.icon), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
  ...
  }, item.type), saved && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      fontWeight: 700,
      color: gt.color,
  ...
  }, item.text), expanded && !saved && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      animation: "riseUp 0.3s ease"
    }
  ...
  }, "hold to save"), response.trim() && /*#__PURE__*/React.createElement(GuideHoldSave, {
    color: gt.color,
    onSave: submit,
    isMobile: isMobile
    ...
    style: {
      padding: "12px 14px",
      borderRadius: 10,
      background: gt.color + "0a",
      border: "1px solid " + gt.color + "25",
      animation: "riseUp 0.4s ease"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "you said"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
  ...
  }, response)), echo && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      paddingLeft: 4,
...
function TappableSentence({
  ...
  function onMove(clientX, clientY) {
    ...
    if (swipeIntent.current === null && (Math.abs(dx) > swipeThreshold || Math.abs(dy) > swipeThreshold)) {
      ...
      if (swipeIntent.current === "scroll" && holdTimer.current) {
        clearInterval(holdTimer.current);
        setHoldProg(0);
      }
    }
    if (swipeIntent.current === "swipe") {
      setSwipeX(dx);
      if (Math.abs(dx) > 10 && holdTimer.current) {
        clearInterval(holdTimer.current);
        setHoldProg(0);
      }
    }
  ...
  function onEnd() {
    ...
    if (swipeX < -threshold) {
      setState("landed");
      if (onReact) onReact(text, "landed");
    } else if (swipeX > threshold) {
      setState("resisted");
      if (onReact) onReact(text, "resisted");
    } else if (Math.abs(swipeX) < 15) {
      setState("landed");
      if (onReact) onReact(text, "landed");
    } else {
      setState("idle");
  ...
  if (state === "idle") {
    return /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        cursor: "pointer",
        color: "inherit",
        borderBottom: "1px dotted rgba(214,178,109,0.15)",
        paddingBottom: 1,
  ...
  if (state === "active") {
    ...
    }, text, " ", holdProg > 0.3 && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        color: "#D6B26D88",
        fontFamily: FB
  ...
  var stateColor = state === "landed" ? "#6BFFB8" : state === "held" ? "#D6B26D" : state === "resisted" ? "rgba(255,96,144,0.55)" : "inherit";
  ...
  var notePrompt = state === "landed" ? "Add signal" : state === "held" ? "Add signal" : "Add signal — what's different?";
  ...
  }, stateMark), " "), !noteSaved && !noteOpen && /*#__PURE__*/React.createElement("span", {
    onClick: function (e) {
      e.stopPropagation();
      setNoteOpen(true);
    },
  ...
  }, "+ note"), noteSaved && /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-block",
      marginLeft: 6,
      fontSize: 10,
  ...
  }, "incorporated"), noteOpen && /*#__PURE__*/React.createElement("span", {
    onClick: function (e) {
      e.stopPropagation();
    },
    style: {
  ...
  }, notePrompt), /*#__PURE__*/React.createElement("textarea", {
    value: noteDraft,
    onChange: function (e) {
...
function HighlightableReading({
  text,
  feedbackMap,
  onFeedback,
  dark
}) {
  if (!text || text.trim().length === 0) return /*#__PURE__*/React.createElement("span", null, text);
  ...
  if (sentences.length === 0) {
    ...
    return /*#__PURE__*/React.createElement(HighlightableText, {
      text: t,
      feedback: feedbackMap ? feedbackMap[key] : null,
      onFeedback: onFeedback,
      dark: dark
    });
  }
  return /*#__PURE__*/React.createElement("span", null, sentences.map(function (t, i) {
    var key = normalizeSentKey(t);
    return /*#__PURE__*/React.createElement(HighlightableText, {
      key: i,
      text: t,
...
function ClarityHoldInput({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("input", {
    ...
    style: {
      ...
      background: "transparent",
      border: "none",
      borderBottom: "1px solid rgba(214,178,109,0.15)",
      borderRadius: 0,
      color: "rgba(255,255,255,0.9)",
      padding: "12px 0",
      fontFamily: FB,
  ...
  }, holding ? "locking in\u2026" : isMobile ? "hold 1 sec to keep this" : "hold to keep this"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 0,
      left: 0,
...
function SessionPhase({
  ...
  const [isMobile, setIsMobile] = useState(typeof window !== "undefined" && window.innerWidth < 480);
  const [isDesktopWide, setIsDesktopWide] = useState(typeof window !== "undefined" && window.innerWidth >= 1024);
  const [showSwipeHint, setShowSwipeHint] = useState(function () {
    try {
      return !localStorage.getItem("saycrd-" + getCurrentUid() + "-session-swipe-hint-seen");
    } catch (e) {
      return true;
    }
  });
  ...
  function extractTopics(note) {
    ...
    return note.toLowerCase().replace(/[^a-z\s]/g, "").split(/\s+/).filter(function (w) {
      return w.length >= 4 && !stop.has(w);
    }).slice(0, 4);
  }
  function handleSentenceFeedback(text, optionId, optionalComment) {
    var key = normalizeSentKey(text);
    setSentenceFeedback(function (prev) {
  ...
  var sessions = [];
  try {
    sessions = JSON.parse(localStorage.getItem(_sessionKey()) || "[]");
  } catch (e) {}
  var sessionNum = sessions.length + 1;
  const THEMES = (sd.themes || []).map(function (t, i) {
    return {
      name: t.label,
      color: t.color || NC[i % NC.length],
      weight: Math.min((t.weight || 1) / 5, 1)
    };
  });
  const GUIDE_ITEMS = (sd.guide || []).map(function (g) {
    return {
      type: g.type || "notice",
      text: g.text || ""
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    color: "rgba(214,178,109,0.15)",
    count: isMobile ? 4 : 8
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: isDesktopWide ? 720 : 380,
      margin: "0 auto",
      padding: (isDesktopWide ? "88px" : isMobile ? "40px" : "60px") + " 20px calc(40px + env(safe-area-inset-bottom, 0px))",
      position: "relative",
      zIndex: 1,
      userSelect: "text",
      WebkitUserSelect: "text"
    ...
    style: {
      marginBottom: archData ? 18 : 28,
      animation: "riseUp 0.5s ease"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 19 : 16,
  ...
  }, "SESSION ", sessionNum, " \xB7 ", new Date().toLocaleDateString("en-US", {
    month: "long",
    day: "numeric"
  }).toUpperCase())), archData && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: isMobile ? 24 : isDesktopWide ? 44 : 36,
      animation: "riseUp 0.7s ease 0.05s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 14 : 11,
      letterSpacing: "0.5em",
      color: "#E84393",
      fontFamily: FB,
      marginBottom: isMobile ? 8 : isDesktopWide ? 16 : 12,
      textTransform: "uppercase",
      fontWeight: 700
    }
  }, "YOUR PATTERN"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 30 : isDesktopWide ? 58 : 40,
      color: "white",
      fontFamily: FB,
      fontWeight: 900,
      letterSpacing: "0.01em",
      lineHeight: 1.1,
      marginBottom: isMobile ? 8 : isDesktopWide ? 14 : 10
    }
  }, archData.name), archData.line && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 17 : isDesktopWide ? 24 : 19,
      color: "rgba(255,255,255,0.85)",
      fontFamily: FD,
      lineHeight: 1.6
    }
  }, archData.line)), THEMES.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: isDesktopWide ? 44 : 32,
      animation: "riseUp 0.5s ease 0.08s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 16 : 13,
      ...
      fontWeight: 600,
      color: "#E84393",
      marginBottom: isDesktopWide ? 18 : 14,
      fontFamily: FB,
      textTransform: "uppercase",
      opacity: 0.9
    }
  }, THEMES.length, " forces"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: isDesktopWide ? 12 : 9
    }
  }, THEMES.map(function (t, i) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontWeight: 700,
        letterSpacing: "0.04em",
        animation: "riseUp 0.5s ease " + i * 0.07 + "s both",
        lineHeight: 1
      }
    }, t.name);
  }))), synthesis && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: isDesktopWide ? 44 : 32,
      animation: "riseUp 0.6s ease 0.12s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "the reading"), isRevising && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(214,178,109,0.6)",
      fontFamily: FB,
      letterSpacing: "0.14em",
      animation: "pulse 1.5s ease infinite"
    }
  }, "recomputing..."), !isRevising && signalStatus === "new_connection" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, "new connection found \u2193"), !isRevising && signals.resisted_count > 0 && signalStatus !== "new_connection" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(255,255,255,0.25)",
      fontFamily: FB,
  ...
  }, mapTitle), revisedSynthesis ? /*#__PURE__*/React.createElement("div", {
    style: {
      animation: "riseUp 0.6s ease"
    }
  }, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: isDesktopWide ? 26 : 20,
      color: "rgba(255,255,255,0.9)",
      fontFamily: FD,
      lineHeight: 1.75,
      margin: 0
    }
  }, /*#__PURE__*/React.createElement(HighlightableReading, {
    text: revisedSynthesis.synthesis,
    feedbackMap: sentenceFeedback,
    onFeedback: handleSentenceFeedback,
    dark: true
  })), revisedSynthesis.new_connection && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: isDesktopWide ? "16px 20px" : "12px 16px",
      borderRadius: 10,
  ...
  }, revisedSynthesis.new_connection))) : /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: isDesktopWide ? 26 : 20,
      color: "rgba(255,255,255,0.88)",
      fontFamily: FD,
    ...
    onFeedback: handleSentenceFeedback,
    dark: true
  }))), underneath.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      paddingTop: 20,
  ...
  }, "what", "'", "s underneath")), underneath.map(function (t, i) {
    var uKey = normalizeSentKey(t);
    var uFb = sentenceFeedback[uKey];
    var opt = uFb ? SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
      return o.id === uFb;
    }) : null;
    var optC = opt && (opt.color || PICKER_ACCENT);
    var bg = optC ? optC + "22" : "rgba(183,107,255,0.04)";
    var bord = optC ? "1px solid " + optC + "44" : "1px solid rgba(183,107,255,0.08)";
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        ...
        marginBottom: 8,
        position: "relative",
        animation: "riseUp 0.5s ease " + (0.3 + i * 0.1) + "s both",
        transition: "all 0.3s"
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        height: 3,
        borderRadius: "50%",
        background: optC || "#B86BFF",
        opacity: 0.5
      }
    }), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 17,
        color: opt ? "rgba(255,255,255,0.88)" : "rgba(255,255,255,0.82)",
        fontFamily: FD,
        lineHeight: 1.65,
        margin: "0 0 6px"
      }
    }, /*#__PURE__*/React.createElement(HighlightableText, {
      text: t,
      feedback: uFb,
      onFeedback: handleSentenceFeedback,
      dark: true
    })));
  })), tension && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      paddingTop: 20,
      borderTop: "1px solid rgba(255,255,255,0.04)",
  ...
  }, "the tension"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr auto 1fr",
      gap: 12,
      alignItems: "center",
      marginBottom: tension.text ? 12 : 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18,
  ...
  }, tension.a), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(255,255,255,0.25)",
      fontFamily: FB
  ...
  }, tension.b)), revisedSynthesis && revisedSynthesis.tension_text ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
    ...
    text: revisedSynthesis.tension_text,
    feedback: sentenceFeedback[normalizeSentKey(revisedSynthesis.tension_text || "")],
    onFeedback: handleSentenceFeedback,
    dark: true
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      color: "rgba(255,96,144,0.4)",
      fontFamily: FB,
      letterSpacing: "0.2em",
      marginLeft: 8
    }
  }, "revised")) : tension.text && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
    ...
    text: tension.text,
    feedback: sentenceFeedback[normalizeSentKey(tension.text || "")],
    onFeedback: handleSentenceFeedback,
    dark: true
  })), !reactions["tension"] && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8
    }
    ...
    onClick: function () {
      handleReact("tension", "landed");
    },
    style: {
      flex: 1,
      fontSize: 15,
      color: "rgba(107,255,184,0.45)",
      fontFamily: FB,
  ...
  }, "this lands \u2190"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      handleReact("tension", "resisted");
    },
    style: {
      flex: 1,
      fontSize: 15,
      color: "rgba(255,96,144,0.45)",
      fontFamily: FB,
  ...
  }, "\u2192 not right")), reactions["tension"] === "landed" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, "\u2190 noted"), reactions["tension"] === "resisted" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, "signal incorporated")), opening && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      paddingTop: 20,
      borderTop: "1px solid rgba(255,255,255,0.04)",
  ...
  }, "what", "'", "s opening"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 19,
      color: "rgba(107,255,184,0.88)",
      fontFamily: FD,
      lineHeight: 1.65,
      margin: 0
    }
  }, opening)), GUIDE_ITEMS.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      paddingTop: 20,
      borderTop: "1px solid rgba(255,255,255,0.04)",
  ...
  }, GUIDE_ITEMS.map(function (item, i) {
    return /*#__PURE__*/React.createElement(GuideItem, {
      key: i,
      item: item,
      index: i,
      onPatchSynthesis: onPatchSynthesis,
      allGuide: sd.guide || [],
      isMobile: isMobile
    });
  }))), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      onComplete({
        clarity: clarity,
        claritySaved: claritySaved,
        reactions: reactions,
        corrections: corrections,
        signals: signals,
        revisedSynthesis: revisedSynthesis,
...
function ChrysalisButterfly({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    offset: "0%",
    stopColor: isClustering ? "#7B5BE0" : isDissolved ? "#6B5B4B" : "#8B7B5B"
  }), /*#__PURE__*/React.createElement("stop", {
    offset: "100%",
    stopColor: isClustering ? "#3B1A7A" : isDissolved ? "#3B2B25" : "#5B4B35"
  })), /*#__PURE__*/React.createElement("radialGradient", {
    id: "cGlow",
    cx: "50%",
    cy: "50%",
    ...
    offset: "100%",
    stopColor: "#7744CC"
  }))), !isEmerged ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("ellipse", {
    cx: "140",
    cy: "120",
    rx: 60,
    ry: 70,
    ...
    attributeName: "ry",
    values: cocoonRy + ";" + (cocoonRy + 4) + ";" + cocoonRy,
    dur: "4s",
    repeatCount: "indefinite"
    ...
    return /*#__PURE__*/React.createElement("path", {
      key: i,
      d: "M " + (138 - cocoonRx * 0.7) + " " + cy + " Q 138 " + (cy - 5) + " " + (138 + cocoonRx * 0.7) + " " + cy,
      stroke: isClustering ? "rgba(180,120,255,0.25)" : "rgba(200,180,140,0.18)",
      strokeWidth: "1",
      fill: "none"
    });
  }), /*#__PURE__*/React.createElement("ellipse", {
    ...
    d: "M 140 118 Q 68 62 50 100 Q 30 138 66 168 Q 96 188 140 144",
    fill: "url(#wL2)",
    opacity: "0.88"
  }, /*#__PURE__*/React.createElement("animateTransform", {
    attributeName: "transform",
    type: "rotate",
    values: "-3 140 120;3 140 120;-3 140 120",
    dur: "2.4s",
    repeatCount: "indefinite"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M 140 118 Q 212 62 230 100 Q 250 138 214 168 Q 184 188 140 144",
    fill: "url(#wR2)",
    opacity: "0.88"
  }, /*#__PURE__*/React.createElement("animateTransform", {
    attributeName: "transform",
    ...
    d: "M 138 114 Q 124 94 118 88",
    stroke: "#1A0A2A",
    strokeWidth: "1.5",
    fill: "none"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 142 114 Q 156 94 162 88",
    stroke: "#1A0A2A",
    strokeWidth: "1.5",
    fill: "none"
  }), /*#__PURE__*/React.createElement("circle", {
...
function TensionPull({
  ...
  return /*#__PURE__*/React.createElement("svg", {
  ...
  }, [80, 60, 40].map((r, i) => /*#__PURE__*/React.createElement("ellipse", {
    key: i,
    cx: "160",
    cy: "90",
    rx: clicked ? r + 60 : r,
    ry: clicked ? r * 0.45 + 10 : r * 0.45,
    fill: "none",
    stroke: "url(#tf)",
    strokeWidth: "0.8",
    opacity: 0.15 - i * 0.04,
    ...
    style: {
      transform: `translateX(${clicked ? -35 : 0}px)`,
    ...
    dur: "2.3s",
    repeatCount: "indefinite"
  }))), clicked && /*#__PURE__*/React.createElement("g", {
    style: {
      animation: "riseUp 0.6s ease"
    }
  }, /*#__PURE__*/React.createElement("circle", {
    ...
    fill: "#FFD700",
    fontFamily: "serif"
  }, "\u2726")), clicked && [0, 1, 2].map(i => /*#__PURE__*/React.createElement("line", {
    key: i,
    x1: 120 + i * 20,
    y1: 75 + i * 5,
    x2: 135 + i * 18,
    ...
    offset: "0%",
    stopColor: "rgba(255,215,0,0.4)"
  }), /*#__PURE__*/React.createElement("stop", {
    offset: "100%",
    stopColor: "rgba(255,215,0,0)"
  }))));
}
function SessionPortrait() {
  ...
  }, rings.map((ring, i) => /*#__PURE__*/React.createElement("circle", {
    key: i,
    cx: "130",
    cy: "130",
    r: ring.r,
...
function ThreadTimeline() {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fill: "#FFB86B",
    fontFamily: FB
  }, "32"), /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("linearGradient", {
    id: "threadG",
    x1: "0",
    y1: "0",
    x2: "1",
    ...
    offset: "0%",
    stopColor: "rgba(255,184,107,0.3)"
  }), /*#__PURE__*/React.createElement("stop", {
    offset: "100%",
    stopColor: "#FFB86B"
  }))));
...
function SeedToTree({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    rx: morphed ? 100 : 40,
    ry: "8",
    fill: "rgba(107,255,184,0.1)",
    style: {
      transition: "all 1.2s ease"
    }
  }), !morphed ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("ellipse", {
    cx: "140",
    cy: "240",
    rx: "14",
    ry: "10",
    ...
    d: "M 140 258 Q 138 200 140 140",
    stroke: "#6B8B5B",
    strokeWidth: "5",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 180 Q 110 160 90 150",
    stroke: "#6B8B5B",
    strokeWidth: "3",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 180 Q 170 155 195 148",
    stroke: "#6B8B5B",
    strokeWidth: "3",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 155 Q 120 135 100 128",
    stroke: "#6B8B5B",
    strokeWidth: "2.5",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 155 Q 165 130 180 125",
    stroke: "#6B8B5B",
    strokeWidth: "2.5",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 140 Q 130 120 125 108",
    stroke: "#6B8B5B",
    strokeWidth: "2",
    fill: "none",
    strokeLinecap: "round"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 140 140 Q 155 118 162 108",
    stroke: "#6B8B5B",
    strokeWidth: "2",
    fill: "none",
    strokeLinecap: "round"
  }), [[90, 145, 22], [195, 143, 20], [100, 122, 18], [180, 120, 18], [125, 102, 16], [162, 102, 16], [140, 90, 20]].map(([cx, cy, r], i) => /*#__PURE__*/React.createElement("circle", {
    key: i,
    cx: cx,
    cy: cy,
    r: r,
    fill: `rgba(107,255,184,${0.12 + i * 0.02})`
  }, /*#__PURE__*/React.createElement("animate", {
    attributeName: "r",
    values: `${r};${r + 2};${r}`,
    dur: `${2.5 + i * 0.3}s`,
    repeatCount: "indefinite"
  }))), [[95, 140], [188, 138], [105, 118], [175, 116], [130, 98], [155, 98], [140, 85]].map(([x, y], i) => /*#__PURE__*/React.createElement("circle", {
    key: i,
    cx: x,
    cy: y,
    r: "2",
    ...
    d: "M 136 258 Q 120 268 105 272",
    stroke: "#5B7B4B",
    strokeWidth: "2",
    fill: "none",
    opacity: "0.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 144 258 Q 160 268 175 272",
    stroke: "#5B7B4B",
    strokeWidth: "2",
    fill: "none",
    opacity: "0.5"
...
function SunriseViz() {
  return /*#__PURE__*/React.createElement("svg", {
    ...
    const x1 = 160 + 42 * Math.cos(rad),
      y1 = 105 + 42 * Math.sin(rad);
    const x2 = 160 + (55 + i % 3 * 8) * Math.cos(rad),
      y2 = 105 + (55 + i % 3 * 8) * Math.sin(rad);
    return /*#__PURE__*/React.createElement("line", {
      key: i,
      x1: x1,
      y1: y1,
    ...
    offset: "0%",
    stopColor: "rgba(30,20,60,0.8)"
  }), /*#__PURE__*/React.createElement("stop", {
    offset: "50%",
    stopColor: "rgba(80,40,20,0.4)"
  }), /*#__PURE__*/React.createElement("stop", {
    offset: "100%",
    stopColor: "rgba(255,180,80,0.15)"
  })), /*#__PURE__*/React.createElement("radialGradient", {
    id: "sun"
  }, /*#__PURE__*/React.createElement("stop", {
    offset: "0%",
...
function ArchSisyphus({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M 20 240 Q 140 60 260 240",
    fill: "url(#hill)",
    stroke: c,
    strokeWidth: "1",
    opacity: "0.3"
  }), !morphed ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("circle", {
    cx: "100",
    cy: "195",
    r: "30",
    fill: "url(#bld)",
    ...
    var x = 140 + Math.cos(a) * 45;
    var y = 80 + Math.sin(a) * 45;
    return /*#__PURE__*/React.createElement("circle", {
      key: i,
      cx: x,
      cy: y,
...
function ArchMagician({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    var x = 140 + Math.cos(rad) * 55;
    var y = 140 + Math.sin(rad) * 55;
    return /*#__PURE__*/React.createElement("circle", {
      key: i,
      cx: x,
      cy: y,
    ...
    var rad = a * Math.PI / 180;
    var x = 140 + Math.cos(rad) * 50;
    var y = 130 + Math.sin(rad) * 50;
    return /*#__PURE__*/React.createElement("circle", {
      key: "o" + i,
      cx: x,
      cy: y,
...
function ArchThreshold({
  ...
  return /*#__PURE__*/React.createElement("svg", {
  ...
  }, !morphed ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("rect", {
    x: "90",
    y: "40",
    width: "12",
    height: "190",
    ...
    return /*#__PURE__*/React.createElement("line", {
      ...
      attributeName: "opacity",
      values: 0.1 + i * 0.05 + ";" + (0.4 + i * 0.05) + ";" + (0.1 + i * 0.05),
      dur: 1 + i * 0.3 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("circle", {
...
function ArchTower({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    var x = 110 + Math.random() * 60;
    var y = 50 + i * 22;
    var rot = -30 + Math.random() * 60;
    ...
    return /*#__PURE__*/React.createElement("rect", {
      ...
      attributeName: "x",
      values: x + ";" + String(x + dx) + ";" + (x + dx * 1.5),
      dur: 2 + i * 0.3 + "s",
      fill: "freeze"
    }), /*#__PURE__*/React.createElement("animate", {
      attributeName: "opacity",
      values: "0.3;0.15;0.05",
      dur: 2 + i * 0.3 + "s",
      fill: "freeze"
    }));
  }), [0, 1, 2].map(function (i) {
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "cy",
      values: 230 - i * 10 + ";" + (240 - i * 10) + ";" + (230 - i * 10),
      dur: 2 + i * 0.5 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("line", {
...
function ArchDescent({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M 60 80 Q 70 180 140 230 Q 210 180 220 80",
    fill: "url(#cave)",
    stroke: c,
    strokeWidth: "1",
    opacity: "0.15"
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "opacity",
      values: 0.15 - i * 0.04 + ";" + (0.35 - i * 0.04) + ";" + (0.15 - i * 0.04),
      dur: 2 + i * 0.5 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("text", {
    ...
    opacity: "0.25",
    letterSpacing: "0.15em"
  }, "GOING DOWN")) : /*#__PURE__*/React.createElement("g", {
    style: {
      animation: "riseUp 1s ease"
    }
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "opacity",
      values: 0.05 + i * 0.03 + ";" + (0.2 + i * 0.05) + ";" + (0.05 + i * 0.03),
      dur: 1.5 + i * 0.3 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("circle", {
    ...
    return /*#__PURE__*/React.createElement("line", {
      key: "r" + i,
      x1: 140 + Math.cos(a) * 15,
      y1: 210 + Math.sin(a) * 15,
      x2: 140 + Math.cos(a) * 35,
      y2: 210 + Math.sin(a) * 35,
      stroke: c,
      strokeWidth: "1",
      opacity: "0.2",
      strokeLinecap: "round"
...
function ArchWeaver({
  ...
  return /*#__PURE__*/React.createElement("svg", {
  ...
  }, !morphed ? /*#__PURE__*/React.createElement("g", null, [0, 1, 2, 3, 4, 5].map(function (i) {
    var y = 50 + i * 35;
    return /*#__PURE__*/React.createElement("path", {
      key: i,
      d: "M 50 " + y + " Q " + (100 + (i % 2 === 0 ? -20 : 20)) + " " + (y + 15) + " 140 " + y + " Q " + (180 + (i % 2 === 0 ? 20 : -20)) + " " + (y + 15) + " 230 " + y,
      fill: "none",
      stroke: c,
      strokeWidth: "1",
      opacity: "0.15",
    ...
    return /*#__PURE__*/React.createElement("path", {
      key: i,
      d: "M 50 " + y + " Q " + (95 + (i % 2 === 0 ? -15 : 15)) + " " + (y + (i % 2 === 0 ? -12 : 12)) + " 140 " + y + " Q " + (185 + (i % 2 === 0 ? 15 : -15)) + " " + (y + (i % 2 === 0 ? 12 : -12)) + " 230 " + y,
      fill: "none",
      stroke: c,
      ...
      attributeName: "d",
      values: "M 50 " + y + " Q " + (95 + (i % 2 === 0 ? -15 : 15)) + " " + (y + (i % 2 === 0 ? -12 : 12)) + " 140 " + y + " Q " + (185 + (i % 2 === 0 ? 15 : -15)) + " " + (y + (i % 2 === 0 ? 12 : -12)) + " 230 " + y + ";" + "M 50 " + y + " Q " + (95 + (i % 2 === 0 ? -20 : 20)) + " " + (y + (i % 2 === 0 ? -16 : 16)) + " 140 " + (y + 2) + " Q " + (185 + (i % 2 === 0 ? 20 : -20)) + " " + (y + (i % 2 === 0 ? 16 : -16)) + " 230 " + y + ";" + "M 50 " + y + " Q " + (95 + (i % 2 === 0 ? -15 : 15)) + " " + (y + (i % 2 === 0 ? -12 : 12)) + " 140 " + y + " Q " + (185 + (i % 2 === 0 ? 15 : -15)) + " " + (y + (i % 2 === 0 ? 12 : -12)) + " 230 " + y,
      dur: 4 + i * 0.5 + "s",
      repeatCount: "indefinite"
    }));
  }), [0, 1, 2, 3, 4].map(function (i) {
    return /*#__PURE__*/React.createElement("circle", {
      key: "kn" + i,
      cx: 70 + i * 40,
      cy: 60 + i * 35 + (i % 2 === 0 ? 0 : 15),
      r: 3 + i * 0.5,
      fill: c,
      opacity: 0.3 + i * 0.08
    }, /*#__PURE__*/React.createElement("animate", {
      attributeName: "opacity",
      values: 0.2 + i * 0.05 + ";" + (0.6 + i * 0.05) + ";" + (0.2 + i * 0.05),
      dur: 1.5 + i * 0.4 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("text", {
...
function ArchPlanets({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      attributeName: "r",
      values: o.s + ";" + (o.s + 2) + ";" + o.s,
      dur: "2s",
      repeatCount: "indefinite"
    })));
  })));
}
function ArchPhoenix({
  morphed,
  color
}) {
  var c = color || "#E84393";
  return /*#__PURE__*/React.createElement("svg", {
    ...
    return /*#__PURE__*/React.createElement("line", {
      ...
      attributeName: "y2",
      values: 200 - i * 2 + ";" + (195 - i * 3) + ";" + (200 - i * 2),
      dur: 1.5 + i * 0.3 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("circle", {
    ...
    attributeName: "d",
    values: "M 140 170 Q 80 120 60 80;M 140 160 Q 75 105 50 60;M 140 170 Q 80 120 60 80",
    dur: "2.5s",
    repeatCount: "indefinite"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M 140 170 Q 200 120 220 80",
    fill: "none",
    stroke: c,
    strokeWidth: "2.5",
    opacity: "0.6",
    ...
    attributeName: "d",
    values: "M 140 170 Q 200 120 220 80;M 140 160 Q 205 105 230 60;M 140 170 Q 200 120 220 80",
    dur: "2.5s",
    repeatCount: "indefinite"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M 110 130 Q 125 80 140 50 Q 155 80 170 130",
    fill: "url(#pfeath)",
    stroke: c,
    strokeWidth: "1.5",
    opacity: "0.7"
    ...
    attributeName: "d",
    values: "M 110 130 Q 125 80 140 50 Q 155 80 170 130;M 105 125 Q 122 70 140 40 Q 158 70 175 125;M 110 130 Q 125 80 140 50 Q 155 80 170 130",
    dur: "2.5s",
    repeatCount: "indefinite"
  })), [0, 1, 2, 3].map(function (i) {
    var x = 125 + i * 10;
    return /*#__PURE__*/React.createElement("circle", {
      ...
      attributeName: "opacity",
      values: 0.2 + i * 0.1 + ";" + (0.6 + i * 0.1) + ";" + (0.2 + i * 0.1),
      dur: 1 + i * 0.3 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("circle", {
...
function ArchetypeGlyph({
  ...
  for (var i = 0; i < nm.length; i++) {
    hash = (hash << 5) - hash + nm.charCodeAt(i);
    hash = hash & hash;
  }
  hash = Math.abs(hash);
  var sides = 3 + hash % 5;
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    attributeName: "r",
    values: morphed ? "85;95;85" : "60;70;60",
    dur: animSpeed + "s",
    repeatCount: "indefinite"
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      fill: "none",
      stroke: ring.color,
      strokeWidth: ri === 0 ? "1.5" : "0.5",
      opacity: morphed ? 0.25 : 0.1,
      strokeDasharray: ri > 0 ? "3 6" : "none"
    }, /*#__PURE__*/React.createElement("animate", {
      attributeName: "r",
      values: ring.r - 2 + ";" + (ring.r + 2) + ";" + (ring.r - 2),
      dur: animSpeed + ri + "s",
      repeatCount: "indefinite"
      ...
      return /*#__PURE__*/React.createElement("circle", {
        ...
        r: dotSize,
        fill: ring.color,
        opacity: morphed ? 0.7 : 0.35
      }, /*#__PURE__*/React.createElement("animate", {
        attributeName: "opacity",
        values: morphed ? "0.5;0.9;0.5" : "0.2;0.5;0.2",
        dur: animSpeed * 0.7 + pi * 0.3 + "s",
        repeatCount: "indefinite"
      }), /*#__PURE__*/React.createElement("animate", {
        attributeName: "r",
        values: dotSize - 0.5 + ";" + (dotSize + 1) + ";" + (dotSize - 0.5),
        dur: animSpeed + pi * 0.2 + "s",
        repeatCount: "indefinite"
      }));
    }), ring.points.map(function (pt, pi) {
      ...
      return /*#__PURE__*/React.createElement("line", {
        ...
        stroke: ring.color,
        strokeWidth: "0.8",
        opacity: morphed ? 0.2 : 0.08
      }, /*#__PURE__*/React.createElement("animate", {
        attributeName: "opacity",
        values: morphed ? "0.1;0.3;0.1" : "0.04;0.12;0.04",
        dur: animSpeed + 1 + "s",
        repeatCount: "indefinite"
      }));
    }));
    ...
    return /*#__PURE__*/React.createElement("line", {
      ...
      stroke: c1,
      strokeWidth: "0.5",
      opacity: morphed ? 0.12 : 0.04,
      strokeDasharray: "2 4"
    }, /*#__PURE__*/React.createElement("animate", {
      attributeName: "opacity",
      values: morphed ? "0.06;0.18;0.06" : "0.02;0.08;0.02",
      dur: animSpeed + 2 + "s",
      repeatCount: "indefinite"
    }));
  }), /*#__PURE__*/React.createElement("circle", {
    ...
    r: morphed ? 8 : 5,
    fill: c1,
    opacity: morphed ? 0.6 : 0.3
  }, /*#__PURE__*/React.createElement("animate", {
    attributeName: "r",
    values: morphed ? "6;10;6" : "4;7;4",
    dur: animSpeed + "s",
    repeatCount: "indefinite"
  }), /*#__PURE__*/React.createElement("animate", {
    attributeName: "opacity",
    values: morphed ? "0.4;0.8;0.4" : "0.2;0.4;0.2",
    dur: animSpeed + "s",
    repeatCount: "indefinite"
  })), /*#__PURE__*/React.createElement("circle", {
    cx: cx,
...
var ARCH_REGISTRY = {
  chrysalis: {
    ...
    icon: "??",
    color: "#4ae88a",
    bg: "linear-gradient(160deg, #0D1A12 0%, #1a3a2a 40%, #4ae88a44 100%)",
    phases: {
      consuming: "Still building mass. The hunger is the work.",
      dissolving: "The old form can't hold. Dissolution IS the work.",
      clustering: "Imaginal cells found each other. Something coherent forming.",
      emergence: "Wings taking shape. The caterpillar wouldn't recognize what's coming."
    },
  ...
  tower: {
    ...
    icon: "??",
    color: "#ff8a3a",
    bg: "linear-gradient(160deg, #1A0D06 0%, #3a1a08 40%, #ff8a3a44 100%)",
    phases: {
      trembling: "Cracks showing. Something isn't as solid as you believed.",
      falling: "Coming down. Let it fall. Can't hold what wasn't real.",
      rubble: "Standing in the aftermath. Clearest view you've had.",
      clearing: "Ground is bare. Now you can build on what's real."
    },
    Viz: ArchTower
  },
  kintsugi: {
    ...
    icon: "✦",
    color: "#e8b830",
    bg: "linear-gradient(160deg, #1A1408 0%, #2a2010 40%, #e8b83044 100%)",
    phases: {
      breaking: "Something broke. The instinct is to hide the crack. Don't.",
      holding: "Looking at the pieces. Not fixing yet — just seeing.",
      filling: "Gold poured into the break. The repair is the art.",
      whole: "More beautiful than before it shattered. The scar shines."
    },
    Viz: ArchMagician
  },
  dark_night: {
    ...
    icon: "??",
    color: "#9070d0",
    bg: "linear-gradient(160deg, #0D0A18 0%, #14102a 40%, #9070d044 100%)",
    phases: {
      trigger: "Old framework shattered. What made sense doesn't anymore.",
      crisis: "Everything questioned. Who are you if not what you believed?",
      transformation: "In the wreckage, a different way of seeing emerges.",
      emergence: "Old meaning gone. Something deeper replaced it."
    },
    Viz: ArchMagician
  },
  persephone: {
    ...
    icon: "??",
    color: "#c070f0",
    bg: "linear-gradient(160deg, #0D0618 0%, #2a1040 40%, #c070f044 100%)",
    phases: {
      descending: "Something pulled you under. Not punishment — initiation.",
      underworld: "Learning the rules of a realm you didn't choose.",
      pomegranate: "Ate the seeds. Can't unknow it. The wound became wisdom.",
      returning: "Not the maiden anymore. The queen."
    },
    Viz: ArchThreshold
  },
  phoenix: {
    ...
    icon: "??",
    color: "#ff5030",
    bg: "linear-gradient(160deg, #1A0606 0%, #3a0a08 40%, #ff503044 100%)",
    phases: {
      burning: "Let it burn. Not everything survives this version of you.",
      ash: "What's left is what was always real.",
      stirring: "Movement in the ash. Not repetition — reinvention.",
      rising: "Airborne again. Same matter, utterly reconfigured."
    },
    Viz: ArchTower
  },
  hermit: {
    ...
    icon: "??",
    color: "#f0c860",
    bg: "linear-gradient(160deg, #0D0C10 0%, #1a1820 40%, #f0c86044 100%)",
    phases: {
      withdrawing: "Stepped away. Something needs quiet.",
      listening: "A signal getting clearer.",
      seeing: "The lamp illuminates what was always there.",
      returning: "Carrying the light back."
    },
    Viz: SeedToTree
  },
  sisyphus: {
    ...
    icon: "??",
    color: "#c0a078",
    bg: "linear-gradient(160deg, #0D0B08 0%, #201c18 40%, #c0a07844 100%)",
    phases: {
      pushing: "Same weight. Same hill. Something in your grip changed.",
      rolling_back: "Came down again. What do you notice on the walk back?",
      pausing: "Stopped mid-slope. Choosing to feel it.",
      meaning: "Boulder didn't get lighter. You got stronger."
    },
    Viz: ArchSisyphus
  },
  magician: {
    ...
    icon: "✧",
    color: "#a060ff",
    bg: "linear-gradient(160deg, #0D0818 0%, #1c1030 40%, #a060ff44 100%)",
    phases: {
      awakening: "Realizing you have the tools. Always there.",
      practicing: "Testing what transforms.",
      transforming: "The transmutation is happening.",
      mastery: "Seeing what's possible in what already exists."
    },
    Viz: ArchMagician
  },
  lover: {
    ...
    icon: "??",
    color: "#ff6090",
    bg: "linear-gradient(160deg, #1A0810 0%, #2a1020 40%, #ff609044 100%)",
    phases: {
      guarding: "Walls keeping out more than danger.",
      opening: "A crack in the armor. The bravest thing.",
      feeling: "Letting it all in.",
      merging: "Connection isn't losing yourself."
    },
    Viz: ChrysalisButterfly
  },
  star: {
    ...
    icon: "⭐",
    color: "#50c0ff",
    bg: "linear-gradient(160deg, #060C18 0%, #0c1830 40%, #50c0ff44 100%)",
    phases: {
      darkness: "Dark. But a point of light you haven't noticed.",
      glimmer: "Hope isn't optimism. It's stubbornness.",
      pouring: "Quietly tending what's left.",
      shining: "Effortless, steady, real."
    },
    Viz: SeedToTree
  },
  threshold: {
    ...
    icon: "??",
    color: "#b8a880",
    bg: "linear-gradient(160deg, #0D0D0A 0%, #181814 40%, #b8a88044 100%)",
    phases: {
      approaching: "Edge of something. The old room shrinking.",
      standing: "At the door. Not through yet.",
      crossing: "One foot on each side.",
      arrived: "Other side. The room is bigger."
    },
    Viz: ArchThreshold
  },
  weaver: {
    ...
    icon: "??",
    color: "#a080c0",
    bg: "linear-gradient(160deg, #0D0A10 0%, #1a1420 40%, #a080c044 100%)",
    phases: {
      gathering: "Threads from different parts collecting.",
      seeing: "A pattern emerging.",
      weaving: "Actively connecting them.",
      wearing: "The pattern is complete enough to wear."
    },
    Viz: ArchMagician
  },
  tree: {
    ...
    icon: "??",
    color: "#6BFFB8",
    bg: "linear-gradient(160deg, #0A1A12 0%, #0D2E1A 40%, #6BFFB844 100%)",
    phases: {
      seed: "Something planted.",
      roots: "Going deep before going up.",
      growing: "Slow, steady expansion.",
      canopy: "The patience paid off."
    },
    Viz: SeedToTree
  },
  descent: {
    ...
    icon: "⬇",
    color: "#6BB8FF",
    bg: "linear-gradient(160deg, #060C1A 0%, #0D1A2E 40%, #6BB8FF44 100%)",
    phases: {
      approaching: "Edge of the underworld.",
      entering: "Going under.",
      depths: "In the deepest place.",
      returning: "Rising with what you found."
    },
    Viz: ArchThreshold
  },
  planets: {
    name: "Forces in Orbit",
    icon: "??",
    color: "#FFB86B",
    bg: "linear-gradient(160deg, #1A120A 0%, #2E1A0D 40%, #FFB86B44 100%)",
    phases: {
      approaching: "Forces circling.",
      conjunction: "Aligned.",
      opposition: "Pulling apart.",
      integration: "New orbit."
    },
    Viz: ArchSisyphus
  }
};
function CrossSessionCard({
  ...
  var allSessions = pastSessions.slice(-4).concat([{
    themes: (sd.themes || []).map(function (t) {
      return {
        label: t.label,
        weight: t.weight || 1
      };
  ...
  Object.keys(themeMap).forEach(function (label) {
    ...
    var inCurrent = entries.some(function (e) {
      return e.si === N - 1;
    });
    var cnt = entries.length;
    var firstW = entries[0].w,
      lastW = entries[entries.length - 1].w;
    if (cnt >= 3 && inCurrent) persistent.push({
      label: label,
      entries: entries
    });else if (cnt >= 2 && inCurrent && lastW > firstW + 0.3) growing.push({
      label: label,
      entries: entries
    });else if (cnt >= 2 && !inCurrent) chrysalis.push({
      label: label
    });else if (cnt === 1 && inCurrent && lastW > 0.6) arriving.push({
      label: label,
      w: lastW
    });
  });
  ...
  var diamondKey = Object.keys(connFreq).sort(function (a, b) {
    return connFreq[b] - connFreq[a];
  })[0];
  ...
  var alchArc = allSessions.map(function (s) {
    return s.alchemy ? s.alchemy.stage : null;
  });
  ...
  React.useEffect(function () {
    ...
    var sumLines = allSessions.map(function (s, i) {
      var th = (s.themes || []).map(function (t) {
        return t.label + (t.w > 3 || t.weight > 3 ? "*" : "");
      }).join(", ");
    ...
    var analysisBits = [];
    if (persistent.length) analysisBits.push("Persistent: " + persistent.map(function (t) {
      return t.label;
    }).join(", "));
    if (growing.length) analysisBits.push("Growing: " + growing.map(function (t) {
      return t.label;
    }).join(", "));
    if (chrysalis.length) analysisBits.push("In chrysalis: " + chrysalis.map(function (t) {
      return t.label;
    }).join(", "));
    ...
    callClaudeClient(prompt, "", 400).then(function (res) {
      var d = parseJSON(res);
      if (d && d.has_insight && d.insight) {
        setInsight(d);
        setView("poster");
      } else setView("stats");
    }).catch(function () {
  ...
  if (view === "loading") return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
    color: "#B86BFF",
    count: 14
  }), /*#__PURE__*/React.createElement(BreathingOrb, {
    color: "#B86BFF",
    size: 64
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      textTransform: "uppercase",
      color: "rgba(184,107,255,0.45)",
      fontFamily: FB,
      animation: "pulse 2s ease infinite"
    }
  }, "reading the arc"));
  if (view === "poster") return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      display: "flex",
  ...
  }, /*#__PURE__*/React.createElement(FieldParticles, {
    color: accent,
    count: 22
  }), /*#__PURE__*/React.createElement("svg", {
    style: {
    ...
    return /*#__PURE__*/React.createElement("polygon", {
      key: i,
      points: "200,70 330,300 200,530 70,300",
      fill: "none",
      stroke: accent,
      strokeWidth: "1.2",
      transform: "rotate(" + rot + " 200 300)",
      opacity: 0.55 - i * 0.1
    });
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "200",
    ...
    points: "60,6 102,54 60,46 18,54",
    fill: "url(#dia1)"
  }), /*#__PURE__*/React.createElement("polygon", {
    points: "60,6 102,54 60,46",
    fill: "white",
    opacity: "0.08"
  }), /*#__PURE__*/React.createElement("polygon", {
    points: "60,6 18,54 60,46",
    fill: accent,
    opacity: "0.55"
  }), /*#__PURE__*/React.createElement("polygon", {
    points: "18,54 60,46 102,54 60,138",
    fill: "url(#dia2)"
  }), /*#__PURE__*/React.createElement("polygon", {
    points: "18,54 60,46 60,138",
    fill: accent,
    opacity: "0.4"
  }), /*#__PURE__*/React.createElement("polygon", {
    points: "102,54 60,46 60,138",
    fill: "white",
    opacity: "0.04"
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "60",
  ...
  }, insight.pattern_name || "THE PATTERN"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18,
  ...
  }, insight.insight), !sliderDone ? /*#__PURE__*/React.createElement("div", {
    "data-noadvance": "true",
    style: {
      width: "100%",
      maxWidth: 290,
  ...
  }, "does this land?"), /*#__PURE__*/React.createElement(SpectrumSlider, {
    color: accent,
    value: sliderVal,
    poleA: "not quite",
    poleB: "that\\u2019s it",
  ...
  }, sliderVal >= 70 ? "marked \u2713" : sliderVal <= 30 ? "noted \u2014 not quite" : "partially"), /*#__PURE__*/React.createElement("button", {
    "data-noadvance": "true",
    onClick: function (e) {
      e.stopPropagation();
      setView("stats");
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        animation: "riseUp 0.5s ease " + si * 0.09 + "s both"
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 9,
  ...
  })), currentAlch && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      fontSize: 11,
      color: ALCH_COLORS[currentAlch] || topColor,
      fontFamily: FB,
      letterSpacing: "0.2em"
    }
  }, "now: ", ALCH_LABELS[currentAlch] || currentAlch)), (persistent.length > 0 || growing.length > 0) && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28,
      animation: "riseUp 0.6s ease 0.05s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
  ...
  }, "\\u2191 pulling forward"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8
    ...
    var tc = (sd.themes || []).find(function (th) {
      return th.label === t.label;
    });
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontWeight: 600,
        letterSpacing: "0.06em",
        animation: "riseUp 0.5s ease " + i * 0.08 + "s both"
      }
    }, t.label);
  }))), diamondParts && (connFreq[diamondKey] || 0) >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28,
  ...
  }, "\\u25c6 diamond forming"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "14px 18px",
      borderRadius: 12,
  ...
  }, diamondParts[0], " \\u2194 ", diamondParts[1]), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 5,
      fontSize: 10,
  ...
  }, "confirmed ", connFreq[diamondKey], "\\u00d7"))), chrysalis.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28,
  ...
  }, "\\u25ce in chrysalis"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(184,107,255,0.72)",
      fontFamily: FD,
      fontStyle: "italic",
      lineHeight: 1.6
    }
  }, chrysalis.slice(0, 3).map(function (t) {
    return t.label;
  }).join(", ")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 5,
      fontSize: 11,
      color: "rgba(184,107,255,0.38)",
      fontFamily: FB
    }
  }, "appeared. then went quiet. not gone.")), silverLining && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28,
      animation: "riseUp 0.6s ease 0.2s both"
    }
  ...
  }, "\\u2736 silver lining"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "12px 16px",
      borderRadius: 12,
      background: "rgba(200,230,200,0.04)",
      border: "1px solid rgba(200,230,200,0.15)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "rgba(200,230,200,0.82)",
      fontFamily: FD,
      fontStyle: "italic"
    }
  }, silverLining.label), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4,
      fontSize: 10,
  ...
  }, "new this session"))), stagnant.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28,
  ...
  }, "\\u2014 holding still"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
  ...
  }, stagnant.join(", ")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4,
      fontSize: 11,
  ...
  }, "consistent. not shifting. worth noticing.")), insight && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      textAlign: "center"
    }
...
function DataPortrait({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("circle", {
      ...
      fill: "none",
      stroke: ring.color,
      strokeWidth: isActive ? ring.width + 2 : ring.width,
      strokeDasharray: ring.dash,
      strokeLinecap: "round",
    ...
    dur: "3s",
    repeatCount: "indefinite"
  }))), activeRing ? /*#__PURE__*/React.createElement("div", {
    onClick: function (e) {
      e.stopPropagation();
      setActive(null);
    },
  ...
  }, activeRing.label), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 4,
      borderRadius: 2,
    ...
    style: {
      height: "100%",
      width: Math.min(100, activeRing.weight / 5 * 100) + "%",
      background: activeRing.color,
      borderRadius: 2,
  ...
  }, "weight ", activeRing.weight.toFixed(1)))) : /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      marginTop: 8,
      fontSize: 11,
  ...
  try {
    ...
    var themes = (data.themes || []).slice(0, 5).map(function (t) {
      ...
      return {
        label: lbl,
        weight: t.weight || 1,
        short_desc: sd || undefined
      };
    });
    var avgWeight = themes.length > 0 ? themes.reduce(function (s, t) {
      return s + t.weight;
    }, 0) / themes.length : 0;
    sessions.push({
      date: new Date().toISOString(),
      ...
      tension: data.tension ? {
        a: data.tension.a,
        b: data.tension.b,
        text: (data.tension.text || "").slice(0, 500)
      } : null,
      intensity: Math.round(avgWeight * 20) / 10,
      arrival: data.arrival || null,
      alchemy: data.alchemy ? {
        stage: data.alchemy.stage,
        evidence: (data.alchemy.evidence || "").slice(0, 400)
      } : null,
      underneath: (data.underneath || []).slice(0, 2).map(function (u) {
        return (typeof u === "string" ? u : u.observation || "").slice(0, 400);
      }),
    ...
    if (sessions.length >= 2) try {
      computePatternEngine();
    } catch (pe) {}
    if (sessions.length >= 3) try {
      computeNarrativeArc();
    } catch (na) {}
    ...
    (function generateSummaryAsync() {
      var d = data;
      var themesStr = (d.themes || []).slice(0, 4).map(function (t) {
        return t.label;
      }).join(", ");
      ...
      try {
        callClaudeClient(sysMsg, userMsg, 80).then(function (res) {
          try {
            ...
            console.warn("[SAYCRD] Summary update failed:", e);
          }
        }).catch(function () {});
      } catch (e) {}
    })();
  } catch (e) {
    console.error("[SAYCRD] Save error:", e);
  }
}
...
function saveFieldReportToSession(idx1based, reportObj) {
  try {
    ...
    console.warn("[SAYCRD] Failed to save field report:", e);
  }
}
function _sessionKey() {
  return "saycrd-" + getCurrentUid() + "-sessions";
}
...
function updateLastSession(partial) {
  try {
    ...
    console.warn("[SAYCRD] updateLastSession:", e);
  }
}
function exportUserData() {
  try {
    ...
    var pe = null;
    try {
      pe = loadPatternEngine();
    } catch (e) {}
    var nar = null;
    try {
      nar = loadNarrativeArc();
    } catch (e) {}
    var reportHistory = [];
    try {
      reportHistory = JSON.parse(localStorage.getItem("saycrd-report-history-" + uid) || "[]");
    } catch (e) {}
    var payload = {
    ...
    console.error("[SAYCRD] Export failed:", e);
  }
}
...
function computeFieldState() {
  ...
  var avgGap = gaps.length > 0 ? Math.round(gaps.reduce(function (a, b) {
    return a + b;
  }, 0) / gaps.length * 10) / 10 : 0;
  var themeTrack = {};
  sessions.forEach(function (s, si) {
    (s.themes || []).forEach(function (t) {
      var k = normalizeThemeLabel(t.label);
      if (!k) return;
      if (!themeTrack[k]) themeTrack[k] = {
        label: t.label,
        weights: [],
        sessions: []
      };
  ...
  Object.keys(themeTrack).forEach(function (k) {
    ...
    if (w.length >= 2) {
      ...
      if (delta >= 1.5) rising.push({
        label: t.label,
        delta: delta
      });
      if (delta <= -1.5) fading.push({
        label: t.label,
        delta: delta
      });
  ...
  sessions.forEach(function (s, si) {
    (s.archetypes || []).forEach(function (a) {
      ...
      var phase = a.phase || "";
      var resp = s.archetypeResponse && s.archetypeResponse.key === key ? s.archetypeResponse.response : "";
      if (!archTrack[key]) archTrack[key] = {
        appearances: [],
        phases: [],
        responses: []
      };
  ...
  Object.keys(archTrack).forEach(function (key) {
    var a = archTrack[key];
    if (a.appearances.length > anchorCount) {
      anchor = key;
      anchorCount = a.appearances.length;
    }
    var order = PHASE_ORDER[key] || [];
    var indices = a.phases.map(function (p) {
    ...
    if (indices.length >= 2) {
      ...
      if (last2[1] > last2[0]) velocity = "advancing";else if (last2[1] < last2[0]) velocity = "regressing";else if (indices.length >= 3 && indices[indices.length - 1] === indices[indices.length - 2] && indices[indices.length - 2] === indices[indices.length - 3]) velocity = "stuck";
    }
    archSignals[key] = {
  ...
  var tensions = sessions.map(function (s) {
    return s.tension;
  }).filter(Boolean);
  var tensionAge = 0;
  ...
  if (tensions.length >= 2) {
    ...
    for (var ti = tensions.length - 1; ti >= 0; ti--) {
      var t = tensions[ti];
      if (t.a === last.a || t.b === last.b || t.a === last.b || t.b === last.a) tensionAge++;else break;
    }
  }
  var energies = sessions.map(function (s) {
    return s.arrival ? s.arrival.energy : null;
  }).filter(Boolean);
  ...
  if (energies.length >= 2) {
    ...
    if (last === prev) {
      ...
      var lastH = heavy.indexOf(last) >= 0,
        prevH = heavy.indexOf(prev) >= 0;
      var lastL = light.indexOf(last) >= 0,
        prevL = light.indexOf(prev) >= 0;
      if (prevH && lastL) energyTrend = "softening";else if (prevL && lastH) energyTrend = "intensifying";else energyTrend = "shifting";
    }
  }
  var alchemies = sessions.map(function (s) {
    return s.alchemy ? s.alchemy.stage : null;
  }).filter(Boolean);
  ...
  if (alchemies.length >= 2) {
    ...
    if (ai2 > ai1) alchemyVelocity = "advancing";else if (ai2 < ai1) alchemyVelocity = "regressing";
  }
  var blindSpots = sessions.map(function (s) {
    return s.blind_spot || "";
  }).filter(Boolean);
  ...
  var constellations = Object.keys(pairCounts).filter(function (k) {
    return pairCounts[k] >= 2;
  }).map(function (k) {
    return {
      pair: k,
      count: pairCounts[k]
  ...
  try {
    localStorage.setItem("saycrd-" + getCurrentUid() + "-field-state", JSON.stringify(state));
  } catch (e) {}
  return state;
}
...
function computeConnectionArcs(sessions) {
  ...
  Object.keys(arcs).forEach(function (k) {
    ...
    var vals = seq.map(function (x) {
      return x.numeric;
    });
    var trend = "stable";
    var last3 = vals.slice(-3);
    if (last3.length >= 2 && last3[last3.length - 1] > last3[0]) trend = "improving";else if (last3.length >= 2 && last3[last3.length - 1] < last3[0]) trend = "regressing";
    var summary = seq.map(function (x) {
      return "S" + (x.sessionIndex + 1) + ":" + x.value;
    }).join(" ");
    result.push({
      connectionKey: k,
      values: seq,
...
function computePatternMorphology(sessions) {
  ...
  if (blindSpotHistory.length >= 2) {
    for (var i = 1; i < blindSpotHistory.length; i++) {
      ...
      if (curr && prev && curr !== prev && (curr.indexOf(prev.slice(0, 20)) >= 0 || prev.indexOf(curr.slice(0, 20)) >= 0)) {
        evolved.push({
          type: "blind_spot",
          before: blindSpotHistory[i - 1].text.slice(0, 60),
          after: blindSpotHistory[i].text.slice(0, 60),
          sessionIndex: i
        });
      }
    }
  ...
  Object.keys(correctionHistory).forEach(function (key) {
    if (correctionHistory[key].length >= 2) {
      evolved.push({
        type: "correction_refinement",
        key: key,
        count: correctionHistory[key].length,
        sessions: correctionHistory[key].map(function (x) {
          return x.sessionIndex + 1;
        })
      });
    }
  });
    ...
    for (var i = 1; i < arr.length; i++) {
      if (arr[i].w < arr[i - 1].w - 1) {
        ...
        regressions.push({
          type: "theme",
          key: k,
          sessionIndex: arr[i].si,
          priorWeight: arr[i - 1].w,
          newWeight: arr[i].w,
          priorContext: ctx
        });
      }
    ...
    for (var i = 1; i < seq.length; i++) {
      if (seq[i].numeric < seq[i - 1].numeric) {
        ...
        regressions.push({
          ...
          sessionIndex: seq[i].sessionIndex,
          priorValue: seq[i - 1].value,
          newValue: seq[i].value,
          priorContext: ctx
        });
      }
    }
...
function computeLifeDomainSignals(sessions) {
  ...
  Object.keys(byDomain).forEach(function (d) {
    ...
    result.push({
      domain: d,
      topThemes: top,
      totalWeight: byDomain[d].totalWeight
    });
  });
...
function computeFocusOverTime(sessions) {
  ...
  domains.forEach(function (d) {
    ...
    var recentAvg = recent.length ? recent.reduce(function (s, x) {
      return s + x.val;
    }, 0) / recent.length : 0;
    var early = arr.perSession.slice(0, Math.min(3, n));
    var earlyAvg = early.length ? early.reduce(function (s, x) {
      return s + x.val;
    }, 0) / early.length : 0;
  ...
  var totalAvg = result.reduce(function (s, r) {
    return s + r.avgFocus;
  }, 0);
  var maxD = result.reduce(function (m, r) {
    return r.avgFocus > (m.avgFocus || 0) ? r : m;
  }, {});
  var imbalance = maxD.avgFocus > 0.5 ? {
    domain: maxD.domain,
    pct: Math.round(maxD.avgFocus * 100)
  } : null;
  return {
    byDomain: result,
    imbalance: imbalance,
...
function computeLifeFieldGap(sessions, fot) {
  ...
  sessions.forEach(function (s, si) {
    ...
    domains.forEach(function (d) {
      ...
      var fromRaw = LIFE_DOMAINS[d] && LIFE_DOMAINS[d].some(function (w) {
        return raw.indexOf(w) >= 0;
      });
  ...
  return {
    dominant: dominant,
    dominantLabel: LIFE_DOMAIN_LABELS[dominant] || dominant,
    pct: fot.imbalance.pct,
...
function computePatternEngine() {
  ...
  engine.recurring_obstacles = Object.entries(rejected).filter(function (e) {
    return e[1] >= recurThresh;
  }).map(function (e) {
    return {
      key: e[0],
      count: e[1],
      confidence: e[1] >= recurThresh + 1 ? "high" : "medium"
    };
  }).slice(0, 8);
  var archs = sessions.map(function (s) {
    return s.archetypes && s.archetypes[0] ? s.archetypes[0].name || s.archetypes[0].key : "";
  });
  engine.identity_shifts = [];
  for (var i = 1; i < archs.length; i++) {
    if (archs[i] && archs[i] !== archs[i - 1]) {
      engine.identity_shifts.push({
        from: archs[i - 1],
        to: archs[i],
        sessionIndex: i,
        confidence: "high"
  ...
  if (fs && fs.rising && fs.rising.length > 0) {
    engine.emerging_strengths = fs.rising.filter(function (r) {
      return r.delta >= emergingThresh;
    }).map(function (r) {
      return {
        label: r.label,
        delta: r.delta,
        confidence: r.delta >= emergingThresh + 1 ? "high" : "medium"
      };
    });
  }
  var energies = sessions.map(function (s) {
  ...
  var seq = energies.map(function (x) {
    return x.energy;
  }).filter(Boolean);
  if (seq.length >= 3) {
    ...
    var pattern = last3.map(function (e) {
      var h = heavy.some(function (x) {
        return String(e).indexOf(x) >= 0;
      });
      var l = light.some(function (x) {
        return String(e).indexOf(x) >= 0;
      });
      return h ? "H" : l ? "L" : "M";
    }).join("→");
    engine.emotional_cycles = {
      recent: pattern,
      sequence: last3,
      confidence: "low"
    };
  ...
  var clarityWords = [];
  sessions.forEach(function (s) {
    var c = (s.clarity || "").toLowerCase().split(/\s+/).filter(function (w) {
      return w.length >= 4;
    });
    clarityWords.push.apply(clarityWords, c);
  });
  var wordFreq = {};
  clarityWords.forEach(function (w) {
    wordFreq[w] = (wordFreq[w] || 0) + 1;
  });
  var topClarity = Object.entries(wordFreq).sort(function (a, b) {
    return b[1] - a[1];
  }).slice(0, 5).filter(function (e) {
    return e[1] >= goalsThresh;
  });
  if (topClarity.length) engine.repeating_goals = topClarity.map(function (e) {
    return {
      word: e[0],
      count: e[1],
      confidence: e[1] >= goalsThresh + 2 ? "medium" : "low"
    };
  });
  ...
  try {
    localStorage.setItem(peKey, JSON.stringify(engine));
  } catch (e) {}
  return engine;
}
...
function computeNarrativeArc() {
  ...
  for (var start = 0; start < sessions.length; start += CHUNK) {
    ...
    var topThemes = Object.entries(themes).sort(function (a, b) {
      return b[1] - a[1];
  ...
  for (var i = 1; i < archs.length; i++) {
    if (archs[i] && archs[i] !== archs[i - 1]) {
      arc.turning_points.push({
        sessionIndex: i,
        type: "archetype_change",
        description: archs[i - 1] + " → " + archs[i]
      });
    }
  }
  var themeTrack = {};
  ...
  var recurring = Object.entries(themeTrack).filter(function (e) {
    return e[1].sessions.length >= 3;
  }).sort(function (a, b) {
    return b[1].sessions.length - a[1].sessions.length;
  }).slice(0, 5);
  arc.recurring_storylines = recurring.map(function (e) {
    return {
      label: e[1].label,
      sessions: e[1].sessions,
      count: e[1].sessions.length
    };
  });
  var tensionShape = null;
  var tensionCount = 0;
  sessions.forEach(function (s) {
    ...
    if (sh === tensionShape) tensionCount++;else if (!tensionShape || tensionCount < 2) {
      tensionShape = sh;
      tensionCount = 1;
    }
  });
  if (tensionShape && tensionCount >= 2) {
    ...
    for (var ti = 0; ti < sessions.length; ti++) {
      if (sessions[ti].tension && sessions[ti].tension.a && sessions[ti].tension.a + " vs " + sessions[ti].tension.b === tensionShape) {
        firstIdx = ti;
        break;
      }
    }
    if (firstIdx >= 0) arc.turning_points.push({
      sessionIndex: firstIdx,
      type: "recurring_tension",
      description: tensionShape
    });
  }
  try {
    localStorage.setItem("saycrd-" + getCurrentUid() + "-narrative-arc", JSON.stringify(arc));
  } catch (e) {}
  return arc;
}
...
function computeEmergentSignals() {
  ...
  return {
    ...
    fading: (fs.fading || []).map(function (f) {
      return {
        label: f.label,
        delta: f.delta
      };
    }),
    rising: (fs.rising || []).map(function (r) {
      return {
        label: r.label,
        delta: r.delta
      };
...
var FIELD_ALCHEMY = {
  nigredo: {
    ...
    season: "Autumn",
    color: "#888",
    bg: "linear-gradient(160deg, #0D0A10 0%, #1a1018 40%, #44405030 100%)"
  },
  albedo: {
    label: "Albedo",
    sub: "The Whitening",
    season: "Winter",
    color: "#e0e8f0",
    bg: "linear-gradient(160deg, #101418 0%, #1c2028 40%, #c0c8d030 100%)"
  },
  citrinitas: {
    label: "Citrinitas",
    sub: "The Yellowing",
    season: "Spring",
    color: "#f0c840",
    bg: "linear-gradient(160deg, #141008 0%, #2a2010 40%, #d4a83030 100%)"
  },
  rubedo: {
    label: "Rubedo",
    sub: "The Reddening",
    season: "Summer",
    color: "#ff5040",
    bg: "linear-gradient(160deg, #1A0608 0%, #2a0c10 40%, #cc303030 100%)"
  }
};
function JourneyRiver({
  timeline,
  currentArchetypes
}) {
  ...
  return React.createElement("svg", {
    ...
    key: "s0",
    offset: "0%",
    stopColor: "rgba(107,255,184,0.1)"
  }), React.createElement("stop", {
    key: "s1",
    offset: "100%",
    stopColor: "#6BFFB8"
    ...
    key: "river-fill",
    d: pathD + " " + points.slice().reverse().map(function (p, i) {
      var y2 = p.y + 12 + (p.intensity || 0) * 3;
      return (i === 0 ? "L " : "L ") + p.x + " " + y2;
    }).join(" ") + " Z",
    fill: "rgba(107,255,184,0.04)",
    stroke: "none"
    ...
    return React.createElement("g", {
      ...
      r: isLast ? 6 : 3.5,
      fill: mainColor,
      opacity: isLast ? 0.9 : 0.4 + i * 0.04
    }), isLast ? React.createElement("circle", {
      key: "pulse",
      cx: p.x,
      cy: p.y,
      r: "10",
    ...
    }) : null, archs.length > 1 && ARCH_REGISTRY[archs[1]] ? React.createElement("circle", {
      key: "c2",
      cx: p.x + 6,
      cy: p.y - 5,
      r: 2.5,
      fill: ARCH_REGISTRY[archs[1]].color,
      opacity: 0.5
    }) : null]);
  })).concat([React.createElement("text", {
    key: "lbl-start",
    x: pad,
    y: h - 8,
    fontSize: "9",
    ...
    fontFamily: FB
  }, totalSessions > maxShow ? "..." + (totalSessions - maxShow + 1) : "1"), React.createElement("text", {
    key: "lbl-end",
    x: w - pad,
    y: h - 8,
    fontSize: "9",
...
function PatternWeave({
  ...
  var recurring = keys.filter(function (k) {
    return themeHistory[k].appearances.length >= 2;
  }).sort(function (a, b) {
    return themeHistory[b].appearances.length - themeHistory[a].appearances.length;
  }).slice(0, 5);
  ...
  return React.createElement("div", {
    ...
    }, theme.label), React.createElement("div", {
      key: "meta",
      style: {
        fontSize: 11,
    ...
    }, apps.length + " sessions" + (apps.length >= 3 ? " — this keeps returning" : ""))]), React.createElement("div", {
      key: "shift",
      style: {
        fontSize: 18,
        color: dirColor,
...
function TensionCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "TAP A SIDE"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      width: "100%",
    ...
    style: {
      ...
      alignItems: "center",
      cursor: "pointer",
      animation: "riseUp 0.7s ease 0.1s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 100,
    ...
    style: {
      ...
      fontSize: 16,
      fontWeight: 800,
      color: active === "a" ? "white" : c,
      textAlign: "center",
      lineHeight: 1.2,
      padding: 8
    }
  }, poleA))), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 14,
      height: 14,
      borderRadius: "50%",
    ...
    style: {
      ...
      alignItems: "center",
      cursor: "pointer",
      animation: "riseUp 0.7s ease 0.2s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 100,
    ...
    style: {
      ...
      fontSize: 16,
      fontWeight: 800,
      color: active === "b" ? "white" : c,
      textAlign: "center",
      lineHeight: 1.2,
      padding: 8
    }
  }, poleB)))), subText && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: FD,
      fontSize: 17,
      fontStyle: "italic",
      color: "rgba(255,255,255," + (active ? "0.65" : "0.5") + ")",
      maxWidth: 320,
      textAlign: "center",
      lineHeight: 1.7,
      marginTop: 28,
      ...
      animation: "riseUp 0.8s ease 0.4s both"
    }
  }, subText), userFragment && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 52,
      left: 28,
  ...
  }, "you wrote"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
  ...
  }, "\u201C", userFragment, "\u201D")), whisper && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 28,
      fontSize: 10,
...
function AccuracySlider({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      maxWidth: 300,
      marginTop: 22,
      animation: "riseUp 0.6s ease 1.4s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    style: {
      fontSize: 11,
      color: away ? PICKER_ACCENT : "rgba(255,255,255,0.5)",
      fontFamily: FB,
      letterSpacing: "0.05em",
      transition: "color 0.3s"
    }
    ...
    style: {
      fontSize: 11,
      color: alive ? PICKER_ACCENT : "rgba(255,255,255,0.5)",
      fontFamily: FB,
      letterSpacing: "0.05em",
      transition: "color 0.3s"
    }
    ...
    style: {
      ...
      boxShadow: alive ? "0 0 10px " + PICKER_ACCENT + "66" : "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      ...
      height: 18,
      borderRadius: "50%",
      background: alive ? PICKER_ACCENT : "rgba(255,255,255,0.9)",
...
function BookmarkableCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontFamily: FB,
      letterSpacing: "0.1em",
      color: saved ? "#6BFFB8" : holding ? "rgba(255,255,255,0.55)" : "rgba(255,255,255,0.2)",
...
function UnderneathItem({
  ...
  var optC = opt && (opt.color || PICKER_ACCENT);
  var bg = saved ? "rgba(107,255,184,0.1)" : optC ? optC + "22" : holding ? "rgba(184,107,255,0.18)" : "rgba(184,107,255,0.07)";
  var bord = saved ? "1px solid rgba(107,255,184,0.3)" : optC ? "1px solid " + optC + "44" : holding ? "1px solid rgba(184,107,255,0.45)" : "1px solid rgba(184,107,255,0.14)";
  return /*#__PURE__*/React.createElement("div", {
    style: {
      animation: "riseUp 0.5s ease " + index * 0.15 + "s both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    onMouseDown: function (e) {
      startInteract(e.clientX, e);
    },
    onMouseUp: endInteract,
    onMouseLeave: endInteract,
    onTouchStart: function (e) {
      startInteract(e.touches[0].clientX, e);
    },
    ...
    style: {
      ...
      fontFamily: FB,
      letterSpacing: "0.08em",
      color: saved ? "rgba(107,255,184,0.7)" : holding ? "rgba(184,107,255,0.7)" : optC ? optC + "99" : "rgba(255,255,255,0.18)"
    }
...
function ArchGlyph({
  ...
  var dim = c + "44";
  var mid = c + "88";
  var family = /complet|whole|finish|all|full|close|round/.test(nm) ? "completion" : /build|make|found|forge|craft|creat|construct/.test(nm) ? "builder" : /hold|anchor|ground|root|carry|bear|sustain/.test(nm) ? "anchor" : /witness|watch|see|observe|aware|notice/.test(nm) ? "witness" : /bridge|connect|link|weave|thread|join|between/.test(nm) ? "bridge" : /threshold|door|gate|cross|edge|passage|guardian/.test(nm) ? "threshold" : /break|shatter|crack|rupture|burn|fire|collapse/.test(nm) ? "rupture" : /bloom|grow|rise|emerge|unfold|open|blossom/.test(nm) ? "bloom" : /move|flow|river|change|shift|fluid/.test(nm) ? "flow" : /still|quiet|pause|rest|wait|hold/.test(nm) ? "still" : "default";
  var r = s * 0.36;
  if (family === "completion") {
    ...
    var ir = r * 0.52;
    var ix1 = cx + ir * Math.cos(startAngle),
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M " + ix1 + " " + iy1 + " A " + ir + " " + ir + " 0 1 1 " + ix2 + " " + iy2,
      fill: "none",
      stroke: dim,
      strokeWidth: "1.5",
      strokeLinecap: "round"
  ...
  if (family === "builder") {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      points: [cx, cy - r * 0.42, cx - r * 0.36, cy + r * 0.22, cx + r * 0.36, cy + r * 0.22].join(","),
      fill: dim,
      stroke: c,
      strokeWidth: "1.5",
      strokeLinejoin: "round"
  ...
  if (family === "witness") {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      return /*#__PURE__*/React.createElement("line", {
        ...
        x2: cx + r2 * Math.cos(a),
        y2: cy + r2 * Math.sin(a),
        stroke: k % 2 === 0 ? mid : dim,
        strokeWidth: k % 2 === 0 ? 1.5 : 1,
        strokeLinecap: "round"
      });
    }), /*#__PURE__*/React.createElement("circle", {
      cx: cx,
  ...
  if (family === "threshold") {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M " + (cx - archR) + " " + py + " A " + archR + " " + archR + " 0 0 1 " + (cx + archR) + " " + py,
      fill: "none",
      stroke: c,
      strokeWidth: "2.5",
      strokeLinecap: "round"
  ...
  if (family === "anchor") {
    return /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M " + (cx - r * 0.5) + " " + (cy + r * 0.7) + " A " + r * 0.5 + " " + r * 0.5 + " 0 0 0 " + (cx + r * 0.5) + " " + (cy + r * 0.7),
      fill: "none",
      stroke: c,
      strokeWidth: "2.5",
      strokeLinecap: "round"
  ...
  if (family === "rupture") {
    return /*#__PURE__*/React.createElement("svg", {
      ...
      points: [cx - r * 0.7, cy - r * 0.5, cx - r * 0.1, cy - r * 0.1, cx - r * 0.4, cy + r * 0.1, cx, cy, cx + r * 0.2, cy - r * 0.2, cx + r * 0.5, cy + r * 0.6].join(" "),
      fill: "none",
      stroke: c,
      strokeWidth: "2.5",
      strokeLinejoin: "round",
  ...
  if (family === "flow") {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      points: pts2.map(function (p) {
        var parts = p.split(",");
        return parts[0] + "," + (parseFloat(parts[1]) + r * 0.28);
      }).join(" "),
      fill: "none",
      stroke: dim,
      strokeWidth: "1.5",
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    points: [cx + "," + (cy - r * 0.72), cx + r * 0.62 + "," + (cy + r * 0.36), cx - r * 0.62 + "," + (cy + r * 0.36)].join(" "),
    fill: "none",
    stroke: mid,
    strokeWidth: "2",
    strokeLinejoin: "round"
...
function hexDarken(hex, opacity) {
  try {
    ...
    var dr = Math.round(r * opacity),
      dg = Math.round(g * opacity),
      db = Math.round(b * opacity);
    return "rgb(" + dr + "," + dg + "," + db + ")";
  } catch (e) {
    return "#1A0A2E";
  }
...
function FieldConditionCard({
  ...
  var _fcColors = themes.slice(0, 6).map(function (t) {
    return t.color;
  });
  ...
  useEffect(function () {
    if (portrait && portrait.fieldCondition) {
      _fcSetPhrase({
        condition: portrait.fieldCondition,
        undercurrent: portrait.undercurrent || ""
      });
      _fcSetLoading(false);
      return;
    }
    if (portraitReady && !portrait) {
      ...
      (async function () {
        try {
          var themeList = themes.map(function (t) {
            return t.label + "(" + t.weight + ")";
          }).join(", ");
          ...
          if (!cancelled) {
            var dd = parseJSON(rr);
            if (dd) {
              if (dd.phrase && !dd.condition) dd.condition = dd.phrase;
              _fcSetPhrase(dd);
            }
          }
        } catch (e) {} finally {
          if (!cancelled) _fcSetLoading(false);
        }
      })();
      return function () {
        cancelled = true;
  ...
  }, sessionCount > 1 ? "SESSION " + sessionCount + " OF YOUR JOURNEY" : "FIRST SESSION"), sessionCount === 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "rgba(255,255,255,0.25)",
      fontFamily: FD,
  ...
  }, "The report will deepen as you continue")), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  React.createElement("div", {
    ...
    labels: ["signal", "tone", "pull", "undercurrent", "naming"]
  ...
  }, "THE FIELD CONDITION"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 2,
  ...
  })), _fcPhrase && _fcPhrase.undercurrent && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "rgba(255,255,255,0.55)",
      fontFamily: FD,
  ...
  }, _fcPhrase.undercurrent)))), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      padding: _fcBarPad,
      paddingBottom: "calc(" + (isMobile ? 16 : 20) + "px + env(safe-area-inset-bottom, 0px))",
      background: "linear-gradient(0deg, rgba(3,3,8,0.98) 0%, rgba(3,3,8,0.9) 40%, transparent 100%)",
      cursor: "pointer",
      position: "relative",
      zIndex: 2
    },
  ...
  }, _numThemes), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: "rgba(255,255,255,0.6)",
      fontFamily: FB,
  ...
  }, _numConns), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: "rgba(255,255,255,0.6)",
      fontFamily: FB,
  ...
  }, "connections")), primaryArch && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 1,
      height: 36,
      background: "rgba(255,255,255,0.12)"
  ...
  }, /*#__PURE__*/React.createElement(ArchGlyph, {
    name: primaryArch.name || "",
    color: _fcBg1,
    size: 30
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, primaryArch.name))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: "auto"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  })))), goNext && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      fontSize: 11,
      color: "rgba(255,255,255,0.85)",
...
function ArchBillboardCard({
  ...
  useEffect(function () {
    ...
    if (portraitReady && !portrait) {
      ...
      (async function () {
        try {
          var themeCtx = themes.slice(0, 4).map(function (t) {
            return t.label;
          }).join(", ");
          ...
          if (!cancelled) _abSetLoaded(true);
        }
      })();
      return function () {
        cancelled = true;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "YOUR ARCHETYPE"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 36,
      width: "100%",
      paddingRight: 24,
    ...
    style: {
      ...
      background: _abColor,
      marginBottom: 24,
      animation: "riseUp 0.5s ease 0.4s both",
      borderRadius: 1
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, !_abLoaded ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
  ...
  })) : _abLine ? /*#__PURE__*/React.createElement("div", null, _abLine.shift && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 8,
  ...
  }, _abLine.shifted && /*#__PURE__*/React.createElement("div", {
    style: {
      width: 6,
      height: 6,
      borderRadius: "50%",
      background: _abColor,
      boxShadow: "0 0 8px " + _abColor
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
  ...
  }, _abLine.shift)), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, _abLine.recognition)) : /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700,
      color: "rgba(255,255,255,0.9)",
  ...
  }, "You hold what others cannot yet name."))), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      padding: _abBarPad,
      paddingBottom: "calc(" + (isMobile ? 16 : 24) + "px + env(safe-area-inset-bottom, 0px))",
      background: "linear-gradient(0deg, rgba(3,2,8,0.95) 0%, rgba(3,2,8,0.85) 50%, transparent 100%)",
      position: "relative",
      zIndex: 2
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, sessionCount > 1 ? "SESSION " + sessionCount : "FIRST SESSION"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 12
...
function DepthsFieldCard({
    ...
    if (portraitReady && !portrait) {
      ...
      (async function () {
        try {
          ...
          if (!cancelled) {
            var dd = parseJSON(rr);
            if (dd && dd.revelation) _dSetLine(dd.revelation);
          }
        } catch (e) {} finally {
          if (!cancelled) _dSetReady(true);
        }
      })();
      return function () {
        cancelled = true;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 9,
      letterSpacing: "0.55em",
      color: "rgba(107,200,255,0.22)",
      fontFamily: FB,
      textTransform: "uppercase",
      marginBottom: 12
    }
  }, "DESCENDING INTO"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "DEPTHS"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 28 : 38,
      fontWeight: 300,
      color: "rgba(150,200,255,0.5)",
  ...
  }, "OF THE FIELD"))), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      padding: _dBarPad,
      paddingBottom: "calc(" + (isMobile ? 20 : 28) + "px + env(safe-area-inset-bottom, 0px))",
  ...
  }, "JUST OUT OF SIGHT"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      letterSpacing: "0.06em",
  ...
  }, "from what you shared this session"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, !_dReady ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
  ...
  })) : _depthText), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 5,
      marginTop: 18
...
function WhatsGrowingCard({
  ...
  var _branches = Object.keys(_wgFreq).map(function (label, idx) {
    return {
      label: label,
      score: _wgFreq[label],
      color: _allColors[label] || NC2[idx % NC2.length]
    };
  }).sort(function (a, b) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "WHAT'S GROWING")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      display: "flex",
      flexDirection: "column",
      justifyContent: "center",
      padding: isMobile ? "8px 22px 0" : "8px 30px 0",
      boxSizing: "border-box",
      minWidth: 0
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: bi,
      style: {
        marginBottom: isFirst ? 14 : bi === 1 ? 12 : 9,
    ...
    }, labelText), bi <= 1 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: "auto",
        display: "flex",
        gap: 3,
    ...
    style: {
      padding: isMobile ? "18px 22px 0" : "22px 30px 0",
      boxSizing: "border-box"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      minHeight: !_wgReady ? 116 : 60
    }
  }, !_wgReady ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 14
    ...
    text: "Analyzing what\u2019s growing",
    color: _topColor,
    dur: 2.6,
    delay: 0
  }, {
    text: "Uncovering what\u2019s under the surface",
    color: NC2[1],
    dur: 2.9,
    delay: -0.6
  }, {
    text: "Looking to see what wants to arrive",
    color: NC2[2],
    dur: 3.2,
    delay: -1.2
  }].map(function (row, ri) {
  ...
  }, _wgLine || (_branches[0] ? "\u201c" + _branches[0].label + " keeps returning \u2014 it wants something.\u201d" : "The field is learning what it loves."))))), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      padding: _wgBarPad,
      paddingBottom: "calc(" + (isMobile ? 16 : 24) + "px + env(safe-area-inset-bottom, 0px))",
      background: "linear-gradient(0deg, rgba(3,4,5,0.9) 0%, rgba(3,4,5,0.7) 50%, transparent 100%)",
      position: "relative",
      zIndex: 2
    }
  }, /*#__PURE__*/React.createElement("div", {
...
function MirrorCard({
  ...
  var _setLand = setSlider ? function (v) {
    setSlider("the_mirror", v);
  } : function () {};
  var _allSessions = allSessions.length > 0 ? allSessions : function () {
    try {
      return loadSessions();
    } catch (e) {
      return [];
  ...
  useEffect(function () {
    onReadyChange && onReadyChange(_ready);
  }, [_ready]);
  useEffect(function () {
    if (_isFirst) {
      _setReady(true);
    ...
    (async function () {
      try {
        var sessNotes = _allSessions.map(function (s, si) {
          var parts = [];
          if (s.themes && s.themes.length) parts.push("themes:" + s.themes.slice(0, 4).map(function (t) {
            return t.label;
          }).join(","));
          ...
          var corr = s.corrections ? Object.values(s.corrections).filter(function (c) {
            return typeof c === "string" && c.length > 4;
          }) : [];
          if (corr.length) parts.push("said:" + corr.slice(0, 2).join("; ").slice(0, 120));
          return "S" + (si + 1) + ": " + parts.join(" | ");
        }).join("\n\n");
        var currParts = [];
        if (themes.length) currParts.push("themes:" + themes.slice(0, 4).map(function (t) {
          return t.label;
        }).join(","));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 80% 60% at 50% 20%, rgba(140,170,255,0.12) 0%, transparent 55%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      right: 0,
      height: "50%",
      background: "radial-gradient(ellipse 100% 80% at 50% 100%, rgba(180,140,255,0.08) 0%, transparent 60%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: isMobile ? "44px 20px 0" : "52px 28px 0",
      flexShrink: 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "THE MIRROR"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "The Y-axis of your journey \u2014 what appears, what's being revealed")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0,
      display: "flex",
      ...
      padding: isMobile ? "20px 20px 28px" : "24px 28px 36px",
      overflowY: "auto",
      WebkitOverflowScrolling: "touch"
    }
  }, _isFirst ? /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "This is your first session."), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "The mirror needs your journey over time. Come back after another session.")) : /*#__PURE__*/React.createElement("div", null, _ready && _mirrorData ? /*#__PURE__*/React.createElement(React.Fragment, null, _mirrorData.heart && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "The heart of the matter"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, _mirrorData.heart)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: isMobile ? 24 : 28,
  ...
  }, "What appears"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, _mirrorData.before || "—"))), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      color: "rgba(200,220,255,0.4)",
  ...
  }, "What's being revealed"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: isMobile ? "24px 22px" : "28px 24px",
      borderRadius: 20,
  ...
  }, _mirrorData.after || "—")))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: isMobile ? 28 : 32
    },
    "data-noadvance": true
  }, /*#__PURE__*/React.createElement(AccuracySlider, {
    value: _landVal,
    onSlide: _setLand,
    color: _currColor,
    leftLabel: "doesn't land",
    rightLabel: "lands big time"
  ...
  }, "Comparing this session against your history\u2026"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: isMobile ? 24 : 28
    ...
    style: {
      padding: isMobile ? "0 20px 28px" : "0 28px 36px",
      flexShrink: 0,
      display: "flex",
      justifyContent: "space-between",
      alignItems: "center"
...
function RealmCard({
  ...
  useEffect(function () {
    ...
    if (portraitReady && !portrait) {
      ...
      (async function () {
        try {
          var themeStr = themes.slice(0, 4).map(function (t) {
            return t.label;
          }).join(", ");
          ...
          if (!cancelled) {
            var dd = parseJSON(rr);
            if (dd && dd.realmName) {
              dd.realmPosition = Math.max(0.05, Math.min(0.95, parseFloat(dd.realmPosition) || 0.5));
              _setRData(dd);
            }
          }
        } catch (e) {} finally {
          if (!cancelled) _setRReady(true);
        }
      })();
      return function () {
        cancelled = true;
  ...
  var _sparkColor = _pos < 0.2 ? "#FF4422" : _pos < 0.4 ? "#FF8844" : _pos < 0.6 ? "#A88CDF" : _pos < 0.8 ? "#F0C060" : "#FFF8E0";
  var _sparkGlow = _pos < 0.2 ? "rgba(255,60,20,0.6)" : _pos < 0.4 ? "rgba(255,120,40,0.5)" : _pos < 0.6 ? "rgba(160,130,220,0.5)" : _pos < 0.8 ? "rgba(240,190,80,0.5)" : "rgba(255,248,220,0.6)";
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
  ...
  }, _rReady && _rData ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      letterSpacing: "0.55em",
      color: _sparkColor,
  ...
  }, _rData.realmName) : /*#__PURE__*/React.createElement("div", {
    style: {
      width: 120,
      height: 10,
      borderRadius: 3,
  ...
  }), _rReady && _rData && _rData.declaration && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 24,
      fontWeight: 700,
      color: "rgba(255,255,255,0.92)",
  ...
  }, _rData.declaration), /*#__PURE__*/React.createElement("div", {
    style: {
      minHeight: 44
    }
  }, !_rReady ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 7
  ...
  }, _rData && _rData.witness ? _rData.witness : "Every realm on the journey is the journey."))));
}
function ConstellationMap({
  ...
  if (n === 0) return /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(255,255,255,0.35)",
      fontFamily: FD,
  ...
  var pts = (thList || []).map(function (t, i) {
    ...
    return {
      x: cx + Math.cos(ang) * r,
      y: cy + Math.sin(ang) * r * 0.88,
      label: t.label || t.name,
      color: getThemeColor(t, i),
      i: i
    };
  });
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    var a = pts.find(function (p) {
      return (p.label || "").toLowerCase() === (c.from || "").toLowerCase();
    });
    var b = pts.find(function (p) {
      return (p.label || "").toLowerCase() === (c.to || "").toLowerCase();
    });
    if (!a || !b) return null;
    ...
    }), ahov && /*#__PURE__*/React.createElement("path", {
      d: arcPath(a.x, a.y, b.x, b.y),
      fill: "none",
      stroke: a.color,
      strokeWidth: "0.25",
    ...
    return /*#__PURE__*/React.createElement("g", {
    ...
    }, !isHov && /*#__PURE__*/React.createElement("animate", {
      attributeName: "r",
      values: "3.5;4.5;3.5",
      dur: "2.5s",
      repeatCount: "indefinite",
      ...
      style: {
        textShadow: isDark ? "0 0 12px " + p.color + "66" : "none",
        transition: "font-weight 0.2s"
      }
    }, (p.label || "").toUpperCase().slice(0, 12)), showInsight !== false && isHov && function () {
      var connsFrom = (connList || []).filter(function (c) {
        return (c.from || "").toLowerCase() === (p.label || "").toLowerCase() || (c.to || "").toLowerCase() === (p.label || "").toLowerCase();
      });
      var insight = connsFrom.map(function (c) {
        return c.insight || c.label || "";
      }).filter(Boolean)[0];
      if (!insight) return null;
      return /*#__PURE__*/React.createElement("foreignObject", {
        x: Math.max(2, Math.min(p.x - 14, 72)),
        y: Math.max(2, p.y - 16),
        width: 28,
        height: 14,
        style: {
...
var METAMORPHOSIS_STAGES = [{
  key: "eating",
  label: "The hunger is the work",
  desc: "Still building mass. Consuming what you need.",
  alch: "nigredo",
  color: "#6BFFB8"
}, {
  key: "spinning",
  label: "Spinning the cocoon",
  desc: "The old form can't hold. You're making a space for what comes next.",
  alch: "nigredo",
  color: "#7DB7AE"
}, {
  key: "digesting",
  label: "Dissolving",
  desc: "The caterpillar is becoming soup. Imaginal cells are waiting.",
  alch: "albedo",
  color: "#AAAACC"
}, {
  key: "fighting",
  label: "Imaginal cells vs the old",
  desc: "Something new is fighting to form. The old structure resists.",
  alch: "albedo",
  color: "#B86BFF"
}, {
  key: "forming",
  label: "Something coherent forming",
  desc: "The imaginal cells found each other. Wings are taking shape.",
  alch: "citrinitas",
  color: "#D6B26D"
}, {
  key: "emerging",
  label: "Breaking out",
  desc: "The caterpillar wouldn't recognize what's coming. Almost there.",
  alch: "citrinitas",
  color: "#E8B84E"
}, {
  key: "too_soon",
  label: "Came out too soon",
  desc: "The timing wasn't right. The wings need more time.",
  alch: "citrinitas",
  color: "#FFB86B"
}, {
  key: "flying",
  label: "Airborne",
  desc: "Same matter, utterly reconfigured. You're flying.",
  alch: "rubedo",
  color: "#E84393"
}];
function MetamorphosisViz({
  stageKey
}) {
  var st = METAMORPHOSIS_STAGES.find(function (s) {
    return s.key === stageKey;
  }) || METAMORPHOSIS_STAGES[0];
  var c = st.color;
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    rx: "90",
    ry: "70",
    fill: "url(#mvg_" + stageKey + ")"
  }), isCaterpillar && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("ellipse", {
    cx: "100",
    cy: "140",
    rx: "45",
    ry: "12",
    ...
    fill: "#1a3d28",
    opacity: "0.55"
  }), stageKey === "eating" && /*#__PURE__*/React.createElement("circle", {
    cx: "165",
    cy: "128",
    r: "4.5",
    fill: "#5BFFA0",
    ...
    dur: "1.4s",
    repeatCount: "indefinite"
  })), stageKey === "spinning" && /*#__PURE__*/React.createElement("path", {
    d: "M 130 90 Q 110 70 90 85 Q 100 100 130 95",
    ...
    dur: "1.8s",
    repeatCount: "indefinite"
  }))), isChrysalis && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("ellipse", {
    cx: "130",
    cy: "105",
    rx: stageKey === "fighting" ? 29 : 25,
    ry: stageKey === "fighting" ? 56 : 52,
    fill: "rgba(70,55,95,0.5)",
    stroke: c,
    strokeWidth: "1.5",
    strokeOpacity: "0.5"
  }, /*#__PURE__*/React.createElement("animate", {
    ...
    dur: "3.5s",
    repeatCount: "indefinite"
  })), stageKey === "digesting" && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("ellipse", {
    cx: "130",
    cy: "108",
    rx: "14",
    ry: "20",
    fill: "url(#mv_inner_digesting)",
    opacity: "0.9"
  }, /*#__PURE__*/React.createElement("animate", {
    attributeName: "opacity",
    values: "0.5;0.95;0.5",
  ...
  }), (stageKey === "forming" || stageKey === "emerging") && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("path", {
    d: "M 130 95 Q 85 72 68 98 Q 52 124 88 146 Q 114 158 130 132",
    fill: "url(#mvw_" + stageKey + ")",
    fillOpacity: "0.45",
    stroke: c,
    strokeWidth: "1.2",
    strokeOpacity: "0.6"
    ...
    d: "M 130 95 Q 175 72 192 98 Q 208 124 172 146 Q 146 158 130 132",
    fill: "url(#mvw_" + stageKey + ")",
    fillOpacity: "0.4",
    stroke: c,
    strokeWidth: "1",
    ...
    repeatCount: "indefinite",
    begin: "0.2s"
  }))), (stageKey === "emerging" || stageKey === "too_soon") && /*#__PURE__*/React.createElement("path", {
    d: "M 130 86 L 92 55 M 130 86 L 168 55",
    stroke: c,
    strokeWidth: "2.5",
    strokeOpacity: "0.65",
    fill: "none",
    ...
    dur: "1.4s",
    repeatCount: "indefinite"
  }))), isButterfly && /*#__PURE__*/React.createElement("g", {
    style: {
      animation: "riseUp 0.8s ease"
    }
  }, /*#__PURE__*/React.createElement("path", {
    d: "M 130 110 Q 73 58 52 94 Q 30 128 72 162 Q 108 182 130 142",
    fill: "url(#mvw_" + stageKey + ")",
    opacity: "0.95"
  }, /*#__PURE__*/React.createElement("animateTransform", {
    attributeName: "transform",
    type: "rotate",
    values: "-5 130 118;5 130 118;-5 130 118",
    dur: "2s",
    repeatCount: "indefinite"
  })), /*#__PURE__*/React.createElement("path", {
    d: "M 130 110 Q 187 58 208 94 Q 230 128 188 162 Q 152 182 130 142",
    fill: "url(#mvw_" + stageKey + ")",
    opacity: "0.95"
  }, /*#__PURE__*/React.createElement("animateTransform", {
    attributeName: "transform",
    ...
    d: "M 130 110 Q 73 58 52 94",
    stroke: "rgba(255,255,255,0.15)",
    strokeWidth: "0.6",
    fill: "none"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 130 110 Q 187 58 208 94",
    stroke: "rgba(255,255,255,0.15)",
    strokeWidth: "0.6",
    fill: "none"
  }), /*#__PURE__*/React.createElement("ellipse", {
...
function InnerWrappedCard({
  ...
  var evoSessions = _all.length > 0 ? _all : [{
    alchemy: sd.alchemy || null,
    isCurrent: true
  }];
  ...
  var st = METAMORPHOSIS_STAGES.find(function (s) {
    return s.key === stageKey;
  }) || METAMORPHOSIS_STAGES[4];
  useEffect(function () {
    var h = function (e) {
      if (e.key === "ArrowRight") {
        e.preventDefault();
        if (idx < evoSessions.length - 1) setIdx(idx + 1);else goNext && goNext();
      }
      if (e.key === "ArrowLeft") {
        e.preventDefault();
  ...
  useEffect(function () {
    if (evoSessions.length < 1) {
      setMetamorphosisWriteup("");
      return;
    }
    var cancelled = false;
    ...
    ["work", "relationship", "self", "creativity", "money"].forEach(function (d) {
      ...
      if (info && info.stage && info.sessionsCount > 0) {
        var stageLabel = (METAMORPHOSIS_STAGES.find(function (s) {
          return s.key === info.stage;
        }) || {}).label || info.stage;
    ...
    callClaudeClient(p, "Generate the metamorphosis write-up.", 180).then(function (r) {
      ...
      if (!cancelled) setMetamorphosisWriteup("");
    });
    return function () {
      cancelled = true;
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 80% 60% at 50% 30%, " + (st.color || "#6BFFB8") + "12 0%, transparent 60%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "INNER WEATHER"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "rgba(255,255,255,0.5)",
      fontFamily: FD,
  ...
  }, "metamorphosis \xB7 where you are in the continuum"), /*#__PURE__*/React.createElement("div", {
    style: {
      flexShrink: 0,
      maxWidth: 220
    }
  }, /*#__PURE__*/React.createElement(MetamorphosisViz, {
    stageKey: stageKey
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
  ...
  }, st.desc), (metamorphosisWriteup || "") && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: "12px 16px",
      borderRadius: 12,
  ...
  }, metamorphosisWriteup)), evoSessions.length > 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      maxWidth: 280,
      marginTop: 16,
    ...
    type: "range",
    min: 0,
    max: Math.max(0, evoSessions.length - 1),
    value: idx,
    step: 1,
    onChange: function (e) {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Session 1"), /*#__PURE__*/React.createElement("span", null, "Session ", evoSessions.length)))));
}
function MilestoneCard({
  ...
  var msgs = {
    3: {
      ...
      sub: "Your third session. The record is beginning to show what keeps returning.",
      color: "#6BB8FF"
    },
    10: {
      title: "YOUR NARRATIVE ARC",
      sub: "Ten sessions. The arc is taking shape — chapters, turning points, recurring storylines.",
      color: "#B86BFF"
    },
    20: {
      title: "THE META-PATTERN",
      sub: "Twenty sessions. What only becomes visible over time is now in view.",
      color: "#D6B26D"
    },
    50: {
      title: "YOUR RECORD",
      sub: "Fifty sessions. A sustained inner biography. The record speaks.",
      color: "#6BFFB8"
    }
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    onClick: function (e) {
      if (!e.target.closest("button")) goNext && goNext();
    },
    style: {
      position: "absolute",
      inset: 0,
      ...
      alignItems: "center",
      justifyContent: "center",
      background: "linear-gradient(180deg, #0A0618 0%, #080614 50%, #040208 100%)",
      padding: "40px 28px"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 80% 60% at 50% 40%, " + (m.color || "#6BB8FF") + "18 0%, transparent 60%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "SESSION ", milestone || sessionCount), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 32,
      fontWeight: 800,
      color: "white",
...
function ArcRevealCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      overflowY: "auto",
      WebkitOverflowScrolling: "touch",
      background: "linear-gradient(180deg, #040810 0%, #080614 100%)",
    ...
    style: {
      ...
      right: 0,
      height: 120,
      background: "linear-gradient(180deg, #040810 0%, transparent 100%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "YOUR ARC"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 28,
      fontWeight: 800,
      color: "white",
  ...
  }, "WHAT THE RECORD SHOWS"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "rgba(255,255,255,0.45)",
      fontFamily: FD,
  ...
  }, "Chapters, turning points, recurring storylines \u2014 your narrative over ", sessionCount, " sessions"), chapters.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    }, (ch.dominantThemes || []).join(", ") || "—"), (ch.archetype || ch.tension) && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "rgba(255,255,255,0.4)",
        fontFamily: FD,
    ...
    }, [ch.archetype, ch.tension].filter(Boolean).join(" · ")));
  }))), turningPoints.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Turning points"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
    ...
    }, "Session ", tp.sessionIndex + 1, ": ", tp.description || tp.type);
  }))), storylines.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 28
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Recurring storylines"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8
...
function YearReviewCard({
  ...
  var _topArch = Object.keys(_archFreq).sort(function (a, b) {
    return _archFreq[b] - _archFreq[a];
  })[0] || "";
  ...
  return (
    ...
    React.createElement("div", {
    ...
    }, sessionCount, " ", "SESSION" + (sessionCount === 1 ? "" : "S"))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 4
      }
    }, /*#__PURE__*/React.createElement("span", {
    ...
    }, "WHAT'S COME")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 32,
        fontWeight: 200,
        color: "rgba(255,255,255,0.35)",
    ...
    }, "THROUGH THE FIELD"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        paddingBottom: 10,
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: ri,
        style: {
          borderBottom: "0.5px solid rgba(255,255,255," + (isCurr ? "0.12" : "0.05") + ")",
          padding: "13px 0",
        ...
        style: {
          ...
          boxShadow: isCurr ? "0 0 0 3px rgba(255,255,255,0.1), 0 0 16px rgba(255,255,255,0.4)" : "0 0 8px " + row.color + "66"
        }
      })), /*#__PURE__*/React.createElement("div", {
        style: {
          width: 60,
      ...
      }, row.dateStr), row.timeStr && /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 9,
          color: "rgba(255,255,255,0.2)",
          fontFamily: FB,
      ...
      }, row.timeStr)), /*#__PURE__*/React.createElement("div", {
        style: {
          flex: 1,
          minWidth: 0
        }
      }, row.archName ? /*#__PURE__*/React.createElement("div", {
        style: {
          ...
          lineHeight: 1.05,
          textShadow: isCurr ? "0 0 30px " + row.color + "88" : "0 0 12px " + row.color + "44",
          whiteSpace: "nowrap",
          overflow: "hidden",
          textOverflow: "ellipsis"
        }
      }, row.archName) : isCurr ? /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 15,
          fontWeight: 500,
          color: "rgba(255,255,255,0.35)",
      ...
      }, "this session") : /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 11,
    ...
    }), _topArch && _topArchCount >= 2 && /*#__PURE__*/React.createElement("div", {
      style: {
        margin: "22px 0 8px",
        padding: "18px 18px",
        borderRadius: 10,
    ...
    }, "THE RETURNING ONE"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 24,
        fontWeight: 800,
        color: "rgba(255,255,255,0.88)",
    ...
    }, _topArch), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "rgba(255,255,255,0.25)",
        fontFamily: FB
      }
    }, "found you across ", _topArchCount, " sessions")), /*#__PURE__*/React.createElement("div", {
      style: {
        height: 24
      }
    })), /*#__PURE__*/React.createElement("div", {
...
function LandscapeCard({
  ...
  var _archDesc = _archPhases ? Object.values(_archPhases).slice(0, 2).join(" ") : _archLine || "";
  useEffect(function () {
    var cancelled = false;
    (async function () {
      try {
        ...
        themes.forEach(function (t) {
          if (t.label) _freq[t.label] = (_freq[t.label] || 0) + 6;
        });
        var topThemes = Object.keys(_freq).sort(function (a, b) {
          return _freq[b] - _freq[a];
        }).slice(0, 6);
  ...
  function renderStormy() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#040308 0%,#0A0618 25%,#12082A 50%,#0E0C1E 70%,#060410 100%)"
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
      ...
      style: {
        ...
        width: 3,
        height: "22%",
        background: "linear-gradient(0deg,#2A2030,#3A2A45)",
  ...
  function renderDawnMountains() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#06040E 0%,#120820 20%,#2A1025 40%,#3D1A1A 55%,#4A2010 68%,#3A2010 80%,#1A100A 100%)"
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
      ...
      d: "M0 30 L0 18 L8 10 L16 20 L24 8 L32 16 L40 4 L48 14 L56 6 L64 15 L72 5 L80 16 L88 9 L96 18 L100 14 L100 30 Z",
      ...
      d: "M0 22 L0 16 L12 6 L22 14 L34 2 L44 12 L58 0 L68 10 L80 4 L90 13 L100 8 L100 22 Z",
  ...
  function renderDeepForest() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#020308 0%,#040510 30%,#060810 60%,#040608 100%)"
      }
      ...
      width: "2.5",
      height: "40",
      fill: "rgba(4,6,10,0.8)"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M5 35 L6.25 15 L7.5 35 Z",
      fill: "rgba(4,6,10,0.8)"
    }), /*#__PURE__*/React.createElement("rect", {
      x: "18",
      y: "28",
      width: "3",
      height: "47",
      fill: "rgba(5,7,11,0.85)"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M18 28 L19.5 5 L21 28 Z",
      fill: "rgba(5,7,11,0.85)"
    }), /*#__PURE__*/React.createElement("rect", {
      x: "72",
      y: "30",
  ...
  function renderOpenPlain() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#08060E 0%,#150C10 20%,#2A1008 40%,#3D1A06 55%,#4A2408 65%,#3A2010 75%,#180E08 100%)"
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
  ...
  function renderCanyonSunrise() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#0C0804 0%,#1A0C06 15%,#2D1208 30%,#3D1A0A 45%,#1A0C06 65%,#0A0604 100%)"
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
      ...
      d: "M0 0 L0 100 L32 100 L32 60 L28 45 L32 30 L26 15 L32 0 Z",
      fill: "#1A0A04"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M0 0 L0 100 L20 100 L18 60 L22 45 L18 25 L24 10 L20 0 Z",
      fill: "#0E0602"
    }), /*#__PURE__*/React.createElement("line", {
      x1: "25",
      y1: "0",
      ...
      d: "M32 0 L32 100 L0 100 L0 60 L4 45 L0 30 L6 15 L0 0 Z",
      fill: "#1A0A04"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M32 0 L32 100 L12 100 L14 60 L10 45 L14 25 L8 10 L12 0 Z",
      fill: "#0E0602"
    }), /*#__PURE__*/React.createElement("line", {
      x1: "7",
      y1: "0",
  ...
  function renderWinterClearing() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "linear-gradient(180deg,#010208 0%,#020310 25%,#030412 50%,#020308 75%,#010204 100%)"
      }
    }), [[8, 8], [15, 5], [22, 12], [32, 4], [40, 9], [48, 3], [55, 7], [62, 11], [70, 5], [78, 8], [85, 4], [92, 10], [12, 18], [28, 15], [45, 19], [60, 16], [75, 13], [88, 17], [20, 25], [50, 22], [80, 20]].map(function (p, i) {
      return /*#__PURE__*/React.createElement("div", {
        key: i,
        style: {
          position: "absolute",
      ...
      width: "1.2",
      height: "17",
      fill: "rgba(20,25,40,0.7)"
    }), /*#__PURE__*/React.createElement("line", {
      x1: "82.6",
      y1: "22",
      x2: "77",
      y2: "14",
      stroke: "rgba(20,25,40,0.6)",
      strokeWidth: "0.6"
    }), /*#__PURE__*/React.createElement("line", {
      x1: "82.6",
      y1: "20",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      right: 0,
      height: "32%",
      background: "linear-gradient(0deg,rgba(0,0,0,0.97) 0%,rgba(0,0,0,0.75) 45%,transparent 100%)",
      pointerEvents: "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, _archName || "—"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8
  ...
  }, _archIcon), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: "rgba(255,255,255,0.3)",
    ...
    return t.label || "";
  }).filter(Boolean).join(" · "), " · SESSION " + sessionCount)), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 0,
      left: 0,
  ...
  }), _archLine && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      marginBottom: 20,
      flexShrink: 0,
  ...
  }, "\"", _archLine, "\"")), _archPhases && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      overflowY: "auto",
      WebkitOverflowScrolling: "touch"
    ...
    }, phaseName), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 14,
  ...
  })), !_archPhases && _archDesc && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      animation: _panelOpen ? "riseUp 0.5s ease 0.25s both" : "none"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
  ...
  }, _archDesc)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      marginTop: 16,
      flexShrink: 0
...
function UnderdrawingCard({
      ...
      (async function () {
        try {
          ...
          if (!cancelled) {
            var dd = parseJSON(rr);
            if (dd && dd.question) {
              _setQuestion(dd.question);
              _setSubtitle(dd.toward || null);
            }
          }
        } catch (e) {} finally {
          if (!cancelled) _setReady(true);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 8,
      letterSpacing: "0.2em",
      color: "rgba(80,55,20,0.28)",
      fontFamily: FB
    }
  }, sessionCount, " SESSIONS")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 0.75,
      marginBottom: 18,
  ...
  }, "HELD TO THE LIGHT")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      display: "flex",
      flexDirection: "column",
  ...
  }, !_ready ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12,
  ...
  }, _question || "what would it mean to finally stop carrying this?"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 48,
      height: 1.5,
      marginBottom: 18,
  ...
  }), _subtitle && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      fontFamily: FB,
      fontWeight: 400,
    ...
    style: {
      fontSize: 11,
      color: "rgba(100,65,15,0.4)",
      fontFamily: FD,
      fontStyle: "italic",
      lineHeight: 1.6
    }
  }, "The question was always yours."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 3,
      alignItems: "center"
    ...
    length: Math.min(sessionCount, 20)
  }).map(function (_, di) {
    return /*#__PURE__*/React.createElement("div", {
      key: di,
      style: {
        ...
        height: 4,
        borderRadius: "50%",
        background: di === Math.min(sessionCount, 20) - 1 ? "rgba(160,100,20,0.8)" : "rgba(140,90,20," + (0.15 + di * 0.02) + ")"
      }
    });
  })))));
}
...
function FieldReportCard({
  ...
  portraitReady,
  goNext,
  sentenceFeedback: propSentenceFeedback,
  onSentenceFeedback,
  onSessionComplete,
  ...
  var [_lifeFieldResponse, _setLifeFieldResponse] = useState(function () {
    try {
      var s = JSON.parse(localStorage.getItem(_sessionKey()) || "[]");
      var l = s[s.length - 1];
      return l && l.lifeFieldGapResponse ? l.lifeFieldGapResponse : "";
    } catch (e) {
      return "";
    }
  });
  ...
  var [_sentenceFeedback, _setSentenceFeedback] = useState(function () {
    try {
      var s = JSON.parse(localStorage.getItem(_sessionKey()) || "[]");
      var l = s[s.length - 1];
      return l && l.sentenceFeedback ? l.sentenceFeedback : {};
    } catch (e) {
      return {};
    }
  });
  ...
  function _handleReportSentenceClick(s) {
    _setEditingSentence(s);
  }
  function _handleReportSentenceFeedback(text, optionId, optionalComment) {
    var key = normalizeSentKey(text);
    _setSentenceFeedback(function (prev) {
      return Object.assign({}, prev, {
        [key]: optionId
      });
    });
    ...
    if ((optionId === "doesnt_fit" || optionId === "not_feeling" || optionId === "dont_understand") && _report && _report.sections && _report.sections.length > 0) {
      ...
      for (var i = 0; i < _report.sections.length; i++) {
        ...
        if (b.indexOf(text.trim()) >= 0 || b.replace(/\s+/g, " ").indexOf(text.trim().replace(/\s+/g, " ")) >= 0) {
          sectionIdx = i;
          targetSection = _report.sections[i];
          break;
        }
      }
    ...
    try {
      ...
      if (d && d.body) {
        setReport(function (prev) {
          ...
          next[sectionIdx] = Object.assign({}, next[sectionIdx], {
            body: d.body
          });
          if (d.otherSections && Array.isArray(d.otherSections)) {
            d.otherSections.forEach(function (os) {
              var idx = os.index;
              if (typeof idx === "number" && idx >= 0 && idx < next.length && os.body) next[idx] = Object.assign({}, next[idx], {
                body: os.body
              });
            });
          }
      ...
      console.warn("[SAYCRD] Report revision failed:", e);
    } finally {
      _setRevisingSection(null);
    }
  }
  useEffect(function () {
    try {
    ...
    (async function () {
      try {
        ...
        var slimBio = allSessions.map(function (s, si) {
          ...
          var a = s.archetypes && s.archetypes[0] && s.archetypes[0].name || "";
          var th = (s.themes || []).slice(0, 2).map(function (t) {
            return t.label;
          }).join(",");
          var bl = typeof s.blind_spot === "string" ? s.blind_spot.slice(0, 60) : "";
          var op = typeof s.opening === "string" ? s.opening.slice(0, 50) : "";
          var al = s.alchemy && s.alchemy.stage || "";
          var ow = s.corrections ? Object.values(s.corrections).filter(function (c) {
            return typeof c === "string" && c.length > 4;
          }).slice(0, 1).map(function (c) {
            return c.slice(0, 60);
          }).join("") : "";
          var res = s.reactions ? Object.keys(s.reactions).filter(function (rk) {
            return s.reactions[rk] === "resisted";
          }).slice(0, 1).join("") : "";
          return "S" + (si + 1) + ":" + (a ? a + "|" : "") + th + (bl ? "|blind:" + bl : "") + (op ? "|open:" + op : "") + (ow ? "|said:" + ow : "") + (res ? "|resisted:" + res : "") + (s.clarity ? "|clarity:" + String(s.clarity).slice(0, 100) : "") + (s.descent ? "|descent:" + (typeof s.descent === "object" && s.descent.cards ? s.descent.cards.map(function (c) {
            return c.label || c.name || "";
          }).join(",") : String(s.descent).slice(0, 100)) : "");
        }).join("\n");
        ...
        var currSummary = [themes.slice(0, 3).map(function (t) {
          return t.label;
        }).join(", "), sd.tension && sd.tension.a ? sd.tension.a + " vs " + sd.tension.b : currSession.tension && currSession.tension.a ? currSession.tension.a + " vs " + currSession.tension.b : "", sd.blind_spot ? String(sd.blind_spot).slice(0, 80) : currSession.blind_spot ? String(currSession.blind_spot).slice(0, 80) : "", sd.opening ? String(sd.opening).slice(0, 80) : currSession.opening ? String(currSession.opening).slice(0, 80) : "", sd.clarity ? String(sd.clarity).slice(0, 80) : currSession.clarity ? String(currSession.clarity).slice(0, 80) : "", sd.descent || currSession.descent ? function (d) {
          return typeof d === "object" && d.cards ? d.cards.map(function (c) {
            return c.label || c.name || c.phrase || c.prompt || "";
          }).join(", ") : String(d).slice(0, 80);
        }(sd.descent || currSession.descent) : ""].filter(Boolean).join(" | ");
        var whatsNewBlurb = "";
        if (total >= 2 && lastSession) {
          var lastThemeList = (lastSession.themes || []).map(function (t) {
            return (t.label || "").trim();
          }).filter(Boolean);
          var currThemeList = themes.slice(0, 4).map(function (t) {
            return (t.label || "").trim();
          }).filter(Boolean);
          ...
          var newThemes = currThemeList.filter(function (t) {
            return t && lastThemeList.indexOf(t) < 0;
          });
          var returningThemes = currThemeList.filter(function (t) {
            return t && lastThemeList.indexOf(t) >= 0;
          });
        ...
        function collectCorrections(s) {
          ...
          Object.keys(s.corrections).forEach(function (ck) {
            ...
            if (typeof c === "string" && c.length > 6) {
              ...
              correctionsWithContext.push({
                wrong: (ck || "").slice(0, 120),
                right: c.trim().slice(0, 250)
              });
            }
          });
        }
        ...
        var topResist = Object.keys(resistFreq).sort(function (a, b) {
          return resistFreq[b] - resistFreq[a];
        }).slice(0, 3);
        var intensities = allSessions.map(function (s, si) {
          return {
            si: si + 1,
            v: s.intensity || 0
          };
        });
        var maxIntense = intensities.reduce(function (m, x) {
          return x.v > m.v ? x : m;
        }, {
          si: 0,
          v: 0
        });
        var recentAvg = intensities.slice(-3).reduce(function (s, x) {
          return s + x.v;
        }, 0) / Math.max(intensities.slice(-3).length, 1);
        var earlyAvg = intensities.slice(0, 3).reduce(function (s, x) {
          return s + x.v;
        }, 0) / Math.max(Math.min(3, intensities.length), 1);
        var intensityDir = recentAvg > earlyAvg + 0.5 ? "deepening" : recentAvg < earlyAvg - 0.5 ? "settling" : "steady";
        var archJourney = allSessions.map(function (s) {
          return s.archetypes && s.archetypes[0] && s.archetypes[0].name || "";
        }).filter(Boolean);
        var uniqueArchs = archJourney.filter(function (a, i) {
          return i === 0 || archJourney[i - 1] !== a;
        });
        var themeRecurrence = {};
        allSessions.forEach(function (s) {
          (s.themes || []).forEach(function (t) {
        ...
        var persistentThemes = Object.keys(themeRecurrence).filter(function (l) {
          return themeRecurrence[l] >= 3;
        }).sort(function (a, b) {
          return themeRecurrence[b] - themeRecurrence[a];
        });
        var returningThemes = Object.keys(themeRecurrence).filter(function (l) {
          return themeRecurrence[l] === 2;
        });
        var arcPatternBlurb = "";
        if (total >= 5) {
          var parts = [];
        ...
        var currThemeLabels = themes.map(function (t) {
          return t && t.label || "";
        }).filter(Boolean);
        var newTerritoryThemes = currThemeLabels.filter(function (l) {
          return (themeRecurrence[l] || 0) <= 1;
        });
        var shiftBlurb = "";
        if (total >= 3 && newTerritoryThemes.length >= 1 && persistentThemes.length >= 1) {
          var overlap = newTerritoryThemes.filter(function (t) {
            return persistentThemes.indexOf(t) >= 0;
          });
          if (overlap.length < newTerritoryThemes.length) {
            var trulyNew = newTerritoryThemes.filter(function (t) {
              return persistentThemes.indexOf(t) < 0;
            });
        ...
        var firstDate = allSessions.length > 0 && allSessions[0].date ? new Date(allSessions[0].date).toLocaleDateString("en-US", {
          month: "short",
          day: "numeric"
        }) : "";
        var lastDate = allSessions.length > 0 && allSessions[allSessions.length - 1].date ? new Date(allSessions[allSessions.length - 1].date).toLocaleDateString("en-US", {
          month: "short",
          day: "numeric",
          year: "numeric"
        }) : "";
        var stats = total + " sessions. Intensity trend: " + intensityDir + ". Peak: S" + maxIntense.si + ".";
        if (allCorrections.length) stats += " Subject said in their own words: " + allCorrections.slice(0, 3).map(function (c) {
          return '"' + c + '"';
        }).join(", ") + ".";
        ...
        var mapNotesBlurb = mapNotesLines.length > 0 ? "MAP NOTES (subject's words about connections — when using these in the report, QUOTE them in full, e.g. 'The subject said: \"...\"'):\n" + mapNotesLines.slice(0, 20).join("\n") + "\n\n" : "";
        ...
        var lifeFieldResponseBlurb = lifeFieldResponseEntries.length > 0 ? "SUBJECT'S RESPONSE TO LIFE FOCUS QUESTION — HIGHEST PRIORITY (their words override any interpretation; use exact phrasing when relevant):\n" + lifeFieldResponseEntries.join("\n") + "\n\n" : "";
        ...
        var revisedSynthesisBlurb = currRevSyn && currRevSyn.synthesis ? "REVISED SYNTHESIS (subject corrected the reading — use this, NOT the original): \"" + String(currRevSyn.synthesis).trim().slice(0, 400) + "\"\n\n" : "";
        var correctionsBlurb = correctionsWithContext.length > 0 ? "══ SUBJECT CORRECTED — HIGHEST PRIORITY ══\nThe subject pushed back during the session. What the AI suggested was WRONG. Use ONLY what they said. NEVER repeat what the AI suggested.\n\n" + (revisedSynthesisBlurb ? revisedSynthesisBlurb : "") + correctionsWithContext.slice(0, 8).map(function (x) {
          return "AI suggested (WRONG — do not use): \"" + x.wrong + "\"\nSubject corrected: \"" + x.right + "\" — USE THIS.\n";
        }).join("\n") + "\n" : revisedSynthesisBlurb ? "══ SUBJECT CORRECTED — HIGHEST PRIORITY ══\n" + revisedSynthesisBlurb : "";
        var subjectWordsBlurb = subjectWordsList.length > 0 ? "SUBJECT'S OWN WORDS (session corrections and map notes — when citing these, use the exact quote in the report):\n" + subjectWordsList.slice(0, 14).map(function (w) {
          return "\"" + w + "\"";
        }).join("\n") + "\n\n" : "";
        ...
        var sentFbBlurb = Object.keys(_effectiveSentFb).length > 0 ? "SENTENCE FEEDBACK (how session/field/report lines landed — use ONLY when the subject EXPLICITLY gave this feedback; do NOT infer from absence):\n" + Object.keys(_effectiveSentFb).map(function (k) {
          var v = _effectiveSentFb[k];
          var lab = (SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
            return o.id === v;
          }) || {}).label || v;
          return "\"" + k.slice(0, 80) + (k.length > 80 ? "…" : "") + "\" → " + lab;
        ...
        allSessions.forEach(function (s) {
          var u = s.underneath;
          if (Array.isArray(u)) u.forEach(function (x) {
            if (typeof x === "string" && x.trim()) underList.push(x.trim());
          });else if (typeof u === "string" && u.trim()) underList.push(u.trim());
        });
        if (sd && sd.underneath) {
          if (Array.isArray(sd.underneath)) sd.underneath.forEach(function (x) {
            if (typeof x === "string" && x.trim()) underList.push(x.trim());
          });else if (typeof sd.underneath === "string" && sd.underneath.trim()) underList.push(sd.underneath.trim());
        }
        var underBlurb = underList.length ? "What's underneath (pattern intelligence — patterns hard for the subject to self-see: repetition, structure, blind spots; use these exact ideas in prose, never write labels like underneath_0): " + underList.map(function (u, i) {
          return "(" + (i + 1) + ") \"" + u.slice(0, 120) + (u.length > 120 ? "…" : "") + "\"";
        }).join("; ") + ".\n\n" : "";
        var tensionsRecord = [];
        ...
        allSessions.forEach(function (s, si) {
          ...
          if (t && (t.a || t.b)) {
            ...
            var fb = _effectiveSentFb[txt] ? (SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
              return o.id === _effectiveSentFb[txt];
            }) || {}).label || _effectiveSentFb[txt] : null;
          ...
          if (bs) {
            ...
            var bsFb = _effectiveSentFb[bsKey] ? (SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
              return o.id === _effectiveSentFb[bsKey];
            }) || {}).label || _effectiveSentFb[bsKey] : null;
        ...
        if (currDescent && typeof currDescent === "object" && currDescent.cards && currDescent.answers) {
          ...
          currDescent.cards.forEach(function (card, i) {
            ...
            var display = "";
            if (card.type === "energy") {
              var v = typeof ans === "number" ? ans : parseInt(ans, 10);
              display = v >= 0 && v <= 5 ? v + "/5 intensity" : String(ans);
            } else if (card.type === "spectrum") {
              var pct = typeof ans === "number" ? Math.round(ans) : parseInt(ans, 10);
              var toward = pct >= 0 && pct <= 100 ? pct >= 50 ? {
                p: pct,
                pole: card.pole_b || "right",
                side: "right"
              } : {
                p: 100 - pct,
                pole: card.pole_a || "left",
                side: "left"
              } : null;
              display = toward ? "value=" + pct + " CHOSE toward " + toward.side + ": \"" + toward.pole + "\" (" + toward.p + "%)" : String(ans);
            } else if (card.type === "binary") {
              display = ans === "a" || ans === "b" ? "CHOSE: \"" + (ans === "a" ? card.option_a || "a" : card.option_b || "b") + "\" (left=a, right=b)" : String(ans);
        ...
        var SLIDER_LABELS = {
          the_mirror: "doesn't land → lands big time",
          synthesis: "doesn't fit → exactly this",
          bigword: "coincidence → significant",
          connection: "forced → I see it",
          tension: "not quite → that's the one",
          blind_spot: "way off → that's the gap",
          live_tension: "pushing away → lands"
        };
        var SLIDER_POLES = {
          the_mirror: {
            left: "doesn't land",
            right: "lands big time"
          },
          synthesis: {
            left: "doesn't fit",
            right: "exactly this"
        ...
        var cfKeys = Object.keys(sliderValues).filter(function (k) {
          return sliderValues[k] !== undefined && SLIDER_LABELS[k];
        });
        if (cfKeys.length > 0) {
          var cfLines = cfKeys.map(function (k) {
            var v = sliderValues[k];
            return k + ": value=" + v + " → " + sliderToChose(k, v) + " (scale: 0=left \"" + (SLIDER_POLES[k] ? SLIDER_POLES[k].left : "") + "\", 100=right \"" + (SLIDER_POLES[k] ? SLIDER_POLES[k].right : "") + "\")";
          });
        ...
        if (Object.keys(currMap).length > 0) {
          ...
          Object.keys(currMap).forEach(function (k) {
            ...
            var from = (parts[0] || "").trim(),
              to = (parts[1] || "").trim();
            var conn = allConns.find(function (c) {
              return (c.from || "").trim() === from && (c.to || "").trim() === to;
            });
        ...
        if (total >= 3) {
          ...
          if (!pe && total >= 2) {
            try {
              pe = computePatternEngine();
            } catch (e) {}
          }
          if (pe) {
            var peLines = [];
            if (pe.recurring_obstacles && pe.recurring_obstacles.length) peLines.push("Recurring obstacles (pushed back 2+ times): " + pe.recurring_obstacles.map(function (o) {
              return o.key + " (" + o.count + "x)" + (o.confidence ? " [" + o.confidence + "]" : "");
            }).join("; "));
            if (pe.identity_shifts && pe.identity_shifts.length) peLines.push("Identity shifts: " + pe.identity_shifts.map(function (s) {
              return s.from + " → " + s.to;
            }).join("; "));
            if (pe.emerging_strengths && pe.emerging_strengths.length) peLines.push("Emerging strengths (rising themes): " + pe.emerging_strengths.map(function (s) {
              return s.label + " (+" + s.delta + ")" + (s.confidence ? " [" + s.confidence + "]" : "");
            }).join(", "));
            if (pe.repeating_goals && pe.repeating_goals.length) peLines.push("Repeating in clarity: " + pe.repeating_goals.map(function (g) {
              return g.word + " (" + g.count + "x)" + (g.confidence ? " [" + g.confidence + "]" : "");
            }).join(", "));
            ...
            if (pe.connection_arcs && pe.connection_arcs.length) peLines.push("Connection arcs (how map feedback evolved): " + pe.connection_arcs.slice(0, 5).map(function (a) {
              return a.connectionKey + " " + a.trend + " (" + a.summary.slice(-80) + ")";
            }).join("; "));
            if (pe.pattern_morphology && pe.pattern_morphology.length) peLines.push("Pattern evolution (subject refined readings over time): " + pe.pattern_morphology.map(function (m) {
              return m.type === "blind_spot" ? "blind spot: \"" + m.before + "\" → \"" + m.after + "\"" : m.key + " refined " + m.count + "x";
            }).join("; "));
            if (pe.life_domain_signals && pe.life_domain_signals.length) peLines.push("Life domains (where themes cluster): " + pe.life_domain_signals.map(function (d) {
              return d.domain + ": " + d.topThemes.join(", ");
            }).join("; "));
            if (pe.focus_over_time && pe.focus_over_time.byDomain) {
              var fot = pe.focus_over_time;
              var fotLines = fot.byDomain.filter(function (d) {
                return d.avgFocus > 0.02;
              }).map(function (d) {
                return d.label + ": " + Math.round(d.avgFocus * 100) + "% avg" + (d.shift !== 0 ? " (shift " + (d.shift > 0 ? "+" : "") + Math.round(d.shift * 100) + "%)" : "");
              });
            ...
            if (lifeFieldGap) {
              var gapLines = ["FIELD OF LIFE INTELLIGENCE: Focus (where energy goes) is " + lifeFieldGap.dominantLabel + " at " + lifeFieldGap.pct + "%. But they brought up: " + lifeFieldGap.undermentioned.map(function (u) {
                return u.label + " (S" + u.firstSession + (u.count > 1 ? ", " + u.count + "x total" : "") + ")";
              }).join("; ") + ". When focus is on one area and they mention another — especially briefly or in passing — that may be what wants attention or what they're avoiding. Surface it: 'Your focus has been on " + lifeFieldGap.dominantLabel.toLowerCase() + ". You brought up " + (lifeFieldGap.undermentioned[0] ? lifeFieldGap.undermentioned[0].label.toLowerCase() : "other areas") + " in passing. What\'s there?' Frame as curiosity, not accusation."];
              peLines.push(gapLines.join(" "));
            }
            _setLifeFieldGap(lifeFieldGap || null);
            if (pe.regression_context && pe.regression_context.length) peLines.push("Regressions (when themes/map values dropped — prior context): " + pe.regression_context.map(function (r) {
              return "S" + (r.sessionIndex + 1) + " " + r.type + " " + r.key + (r.priorContext ? " — prior: " + r.priorContext.slice(0, 60) : "");
            }).join("; "));
        ...
        if (total >= 10) {
          ...
          if (nar) {
            var narLines = [];
            if (nar.chapters && nar.chapters.length) narLines.push("Chapters: " + nar.chapters.map(function (c) {
              return "S" + (c.sessionRange[0] + 1) + "-S" + (c.sessionRange[1] + 1) + ": " + c.dominantThemes.join(", ") + (c.archetype ? " | " + c.archetype : "") + (c.tension ? " | " + c.tension : "");
            }).join("; "));
            if (nar.turning_points && nar.turning_points.length) narLines.push("Turning points: " + nar.turning_points.map(function (t) {
              return "S" + (t.sessionIndex + 1) + " " + t.type + ": " + t.description;
            }).join("; "));
            if (nar.recurring_storylines && nar.recurring_storylines.length) narLines.push("Recurring storylines (3+ sessions): " + nar.recurring_storylines.map(function (s) {
              return s.label + " (" + s.count + "x)";
            }).join(", "));
        ...
        if (total >= 5) {
          ...
          if (es) {
            ...
            if (es.rising && es.rising.length) esLines.push("Rising (approaching): " + es.rising.map(function (r) {
              return r.label + " (+" + r.delta + ")";
            }).join(", "));
            if (es.fading && es.fading.length) esLines.push("Fading (releasing): " + es.fading.map(function (f) {
              return f.label + " (" + f.delta + ")";
            }).join(", "));
        ...
        if (dd && dd.sections && dd.sections.length >= 3) {
          ...
          try {
            ...
            var sectionsBrief = (dd.sections || []).map(function (s) {
              return (s.title || "") + ": " + (s.body || "").slice(0, 350);
            }).join("\n\n");
            var historyKey = "saycrd-report-history-" + getCurrentUid();
            var reportHistory = JSON.parse(localStorage.getItem(historyKey) || "[]");
            reportHistory.push({
              sessionIndex: total,
              oneLine: (dd.oneLineVerdict || "").slice(0, 100),
              firstOpen: firstOpen,
              sectionsBrief: sectionsBrief,
    ...
    return paras.map(function (para, pi) {
      ...
      if (isBulletBlock && bulletLines.length > 0) {
        return /*#__PURE__*/React.createElement("div", {
          key: pi,
          style: {
            marginBottom: pi < paras.length - 1 ? 16 : 0,
            fontSize: fontSize,
            textAlign: "left",
            textIndent: 0
          }
          ...
          var opt = fb ? SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
            return o.id === fb;
          }) : null;
          var optC = opt && (opt.color || PICKER_ACCENT);
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              display: "flex",
              gap: 10,
              marginBottom: li < bulletLines.length - 1 ? 8 : 0,
              lineHeight: 1.7,
              textAlign: "left",
              textIndent: 0
            }
          ...
          }, "\u2022"), onSentenceClick ? /*#__PURE__*/React.createElement("span", {
            onClick: function () {
              onSentenceClick(clean);
            },
            style: {
              flex: 1,
              textAlign: "left",
            ...
            onMouseEnter: function (e) {
              if (!fb) e.currentTarget.style.background = "rgba(0,0,0,0.04)";
            },
            onMouseLeave: function (e) {
              if (!fb) e.currentTarget.style.background = "transparent";
            }
      ...
      if (onSentenceClick && sentences.length > 0) {
        return /*#__PURE__*/React.createElement("div", {
          key: pi,
          style: {
            marginBottom: pi < paras.length - 1 ? 24 : 0,
          ...
          return /*#__PURE__*/React.createElement("span", {
            ...
            onMouseLeave: function (e) {
              if (!fb) e.currentTarget.style.background = isAha ? "rgba(184,107,255,0.1)" : "transparent";
            }
          }, s), si < sentences.length - 1 ? " " : null);
        }));
      }
      ...
      }, _bold[0] ? /*#__PURE__*/React.createElement("span", {
        style: {
          fontWeight: fw,
          opacity: fw >= 600 ? 1 : 0.92
        }
      }, _bold[0]) : null, _bold[1]);
    });
  }
  if (!_ready) {
    return /*#__PURE__*/React.createElement(ReportWritingScreen, {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, _editingSentence && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 2147483647,
    ...
    text: _editingSentence,
    onFeedback: function (text, id, comment) {
      _handleReportSentenceFeedback(text, id, comment);
      _setEditingSentence(null);
      _setGreyFlowActive(false);
    },
    onClose: function () {
    ...
    onGreyFlowActive: _setGreyFlowActive,
    captureSource: "report"
  }))), document.body), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 3,
      flexShrink: 0,
    ...
    style: {
      padding: isMobile ? "calc(44px + env(safe-area-inset-top, 0px)) 20px 0" : "34px 30px 0",
      flexShrink: 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "SAYCRD \xB7 FIELD REPORT"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, sessionCount, " ", sessionCount === 1 ? "SESSION" : "SESSIONS")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "right",
      flexShrink: 0
    }
  }, _report && _report.dateRange && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 11 : 13,
      color: "rgba(0,0,0,0.28)",
      letterSpacing: "0.08em",
  ...
  }, _report.dateRange), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 11 : 13,
    ...
    style: {
      flex: 1,
      overflowY: "auto",
      padding: isMobile ? "0 20px calc(120px + env(safe-area-inset-bottom, 0px))" : "0 30px calc(60px + env(safe-area-inset-bottom, 0px))",
      WebkitOverflowScrolling: "touch",
      minHeight: 0
    }
  }, _report ? /*#__PURE__*/React.createElement("div", {
    style: {
      paddingTop: 24,
      position: "relative",
      maxWidth: isMobile ? "none" : 680,
  ...
  }, _report.generationFailed ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      padding: "28px 24px",
  ...
  }, "The report couldn't be generated. Your session is recorded \u2014 the patterns are yours to notice."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      fontSize: 14,
      color: "rgba(0,0,0,0.5)",
  ...
  }, "Add your notes below. What stands out? What are you hearing yourself say?")) : /*#__PURE__*/React.createElement(React.Fragment, null, _report.oneLineVerdict && _report.oneLineVerdict.trim().toLowerCase() !== "omit" && _report.oneLineVerdict.trim().length >= 4 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 26,
      padding: "16px 18px",
  ...
  }, _report.oneLineVerdict)), _report.whatMightWantToHappen && _report.whatMightWantToHappen.trim().toLowerCase() !== "omit" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20,
      padding: "14px 18px",
  ...
  }, "What might want to happen"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "rgba(0,0,0,0.7)",
      fontFamily: FD,
    ...
    return hasMapOrSessionWords ? /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 20,
        padding: "10px 14px",
        background: "rgba(0,0,0,0.02)",
    ...
    }, "Grounded in your input"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 13,
    ...
    }, "This report used your words from the map and session \u2014 your corrections and notes shape what appears here.")) : null;
  })(), isMobile && (_report.sections || []).length >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20,
      padding: "14px 0",
  ...
  }, "Jump to section"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8
    ...
    return /*#__PURE__*/React.createElement("a", {
      ...
      onClick: function (e) {
        e.preventDefault();
        var el = document.getElementById("report-sec-" + si);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      id: "report-sec-" + si,
      style: {
        marginBottom: isConclusion ? 0 : 30,
        padding: isConclusion ? "32px 24px 40px" : "24px 20px 30px",
        background: isConclusion ? "linear-gradient(180deg, rgba(0,0,0,0.02) 0%, rgba(0,0,0,0.04) 100%)" : "rgba(0,0,0,0.02)",
        borderRadius: 12,
        border: isConclusion ? "2px solid " + _accent : "1px solid rgba(0,0,0,0.06)",
        ...(si < 2 && !isConclusion ? {
      ...
      style: {
        fontSize: isConclusion ? 11 : 13,
        letterSpacing: isConclusion ? "0.6em" : "0.5em",
        color: _accent,
        marginBottom: sub && !isConclusion ? 6 : 16,
        fontWeight: isConclusion ? 800 : 700,
        opacity: isConclusion ? 0.9 : 0.75,
        textAlign: "left",
        textIndent: 0
      }
    }, sec.title), sub && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "rgba(0,0,0,0.5)",
        fontFamily: FD,
      ...
      style: {
        position: "relative",
        fontSize: isConclusion ? 22 : 20,
        color: isConclusion ? "rgba(0,0,0,0.9)" : "rgba(0,0,0,0.82)",
        fontFamily: FD,
        lineHeight: isConclusion ? 1.75 : 1.9,
        fontWeight: isConclusion ? 500 : 400,
        fontStyle: isConclusion ? "normal" : "normal",
        textAlign: "left",
        textIndent: 0
      }
    }, _revisingSection === si && /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
    ...
    }, "Incorporating your feedback\u2026"), renderBody(sec.body, isConclusion, _handleReportSentenceClick, _mergedReportFb)));
  })), _lifeFieldGap && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      marginBottom: 24,
      paddingTop: 24,
  ...
  }, "What's there?"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 16,
      color: "rgba(0,0,0,0.78)",
      fontFamily: FD,
  ...
  }, "Your focus has been on " + _lifeFieldGap.dominantLabel.toLowerCase() + ". You brought up " + (_lifeFieldGap.undermentioned[0] ? _lifeFieldGap.undermentioned[0].label.toLowerCase() : "other areas") + " in passing. What's there?"), /*#__PURE__*/React.createElement("textarea", {
    value: _lifeFieldResponse,
    onChange: function (e) {
      var v = e.target.value;
      _setLifeFieldResponse(v);
    },
    onBlur: function () {
      ...
      updateLastSession({
        lifeFieldGapResponse: v,
        lifeFieldGapQuestion: v ? q : ""
      });
    },
  ...
  }, "What stands out? What are you hearing yourself say?"), /*#__PURE__*/React.createElement("textarea", {
    value: _reportNotes,
    onChange: function (e) {
      var v = e.target.value;
      _setReportNotes(v);
  ...
  }), _reportNotes.trim() && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderLeft: "3px solid rgba(92,74,58,0.35)",
      borderRadius: 4,
      whiteSpace: "pre-wrap"
    }
  }, _reportNotes.trim()), !_notesSummary && /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      if (_notesSummarizing) return;
      _setNotesSummarizing(true);
      var userWords = [];
      allSessions.forEach(function (s) {
        if (s.corrections) Object.values(s.corrections).forEach(function (c) {
          if (typeof c === "string" && c.trim()) userWords.push("\"" + c.trim().slice(0, 150) + "\"");
        });
        if (s.mapResponses) Object.keys(s.mapResponses).forEach(function (k) {
          var mr = s.mapResponses[k];
          if (mr && mr.comment && String(mr.comment).trim()) userWords.push("\"" + String(mr.comment).trim().slice(0, 150) + "\"");
        });
      });
      if (Object.keys(_sentenceFeedback || {}).length > 0) {
        userWords.push("SENTENCE FEEDBACK (how report lines landed):");
        Object.keys(_sentenceFeedback).forEach(function (k) {
          var v = _sentenceFeedback[k];
          var lab = (SENTENCE_FEEDBACK_OPTIONS.find(function (o) {
            return o.id === v;
          }) || {}).label || v;
          userWords.push("  \"" + k.slice(0, 60) + (k.length > 60 ? "…" : "") + "\" → " + lab);
        });
      }
      var reportExcerpt = "";
      if (_report) {
        reportExcerpt = "REPORT ONE-LINE: \"" + (_report.oneLineVerdict || "") + "\"\n";
        (_report.sections || []).slice(0, 2).forEach(function (sec) {
          reportExcerpt += "SECTION " + (sec.title || "") + ": " + (sec.body || "").slice(0, 200) + "...\n";
        });
      }
      ...
      callClaudeClient(p, "notes_summary", 220).then(function (r) {
        ...
        if (d && d.summary) {
          ...
          try {
            localStorage.setItem(_notesKey + "-summary", disp);
          } catch (x) {}
        }
      }).catch(function () {}).finally(function () {
        _setNotesSummarizing(false);
      });
    },
    ...
    style: {
      ...
      borderRadius: 6,
      color: "rgba(0,0,0,0.6)",
      cursor: _notesSummarizing ? "default" : "pointer"
    }
  }, _notesSummarizing ? "Reflecting…" : "Reflect on my notes"), _notesSummary && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: "16px 18px",
  ...
  }, _notesSummary))))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20,
      padding: "14px 16px",
      background: "rgba(0,0,0,0.03)",
  ...
  }, "This report is for personal insight and reflection only. It is not a clinical assessment, medical advice, or psychological diagnosis. Nothing here should be used to make health or treatment decisions. If you are experiencing mental health difficulties, please speak with a qualified professional.")), /*#__PURE__*/React.createElement("div", {
    style: {
      paddingBottom: 10,
      display: "flex",
      justifyContent: "space-between",
  ...
  }, "END OF REPORT"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 3,
      alignItems: "center"
    ...
    length: Math.min(sessionCount, 24)
  }).map(function (_, di) {
    return /*#__PURE__*/React.createElement("div", {
      key: di,
      style: {
        ...
        height: 4,
        borderRadius: "50%",
        background: di === Math.min(sessionCount, 24) - 1 ? _accent : "rgba(0,0,0," + (0.07 + di * 0.004) + ")"
      }
    });
  })))) : /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Report unavailable.")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 28
    }
  }), onSessionComplete && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "0 32px 8px",
      textAlign: "center"
    }
    ...
    onClick: function () {
      ...
      requestAnimationFrame(function () {
        ...
        fade.querySelector("div").style.opacity = "1";
      });
      setTimeout(function () {
        fade.remove();
        onSessionComplete();
    ...
    style: {
      ...
      letterSpacing: "0.05em",
      cursor: "pointer",
      boxShadow: "0 8px 32px rgba(184,107,255,0.3)",
      minHeight: 52,
      touchAction: "manipulation"
    }
  }, "Your Journey \u2192")), isMobile && onNavigateToJourneys && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "0 20px 16px",
      textAlign: "center"
    }
...
function FieldPhase({
  ...
  var themes = (sd.themes || []).map(function (t, i) {
    return {
      label: t.label,
      weight: t.weight || 1,
      color: t.color || NC[i % NC.length]
  ...
  if (archetypes.length === 0 && themes.length > 0) {
    ...
    var archScores = [{
      key: "chrysalis",
      words: ["transform", "change", "becoming", "dissolving", "letting go", "shift", "shed", "release"],
      title: "Something is dissolving",
      line: "What you were is making room for what you're becoming."
    }, {
      key: "sisyphus",
      words: ["again", "loop", "repeat", "cycle", "stuck", "same", "keep", "pattern", "tired", "push"],
      title: "The beautiful repetition",
      line: "What looks like going nowhere might be building the strength you need."
    }, {
      key: "tower",
      words: ["fall", "break", "collapse", "end", "fail", "shatter", "crumble", "lose", "wrong"],
      title: "The necessary collapse",
      line: "What's falling apart was supposed to fall apart."
    }, {
      key: "phoenix",
      words: ["fire", "burn", "rise", "rebirth", "ash", "new", "emerge", "born", "start over"],
      title: "Rising from the heat",
      line: "Something had to burn before this could exist."
    }, {
      key: "hermit",
      words: ["alone", "quiet", "silence", "solitude", "withdraw", "space", "retreat", "still"],
      title: "The lamp in the dark",
      line: "You stepped away to hear something."
    }, {
      key: "threshold",
      words: ["door", "choice", "decide", "leave", "enter", "between", "edge", "ready", "step", "next"],
      title: "Standing at the door",
      line: "You already know which side you belong on."
    }, {
      key: "weaver",
      words: ["connect", "thread", "pattern", "link", "weave", "together", "relate", "between", "across"],
      title: "The threads are connecting",
      line: "What seemed separate is revealing itself as one pattern."
    }, {
      key: "star",
      words: ["hope", "light", "small", "gentle", "quiet", "tender", "soft", "okay", "fine"],
      title: "Light after collapse",
      line: "Something survived that wasn't supposed to."
    }];
    archScores.forEach(function (arch) {
      arch.score = 0;
      arch.words.forEach(function (w) {
        if (allText.indexOf(w) >= 0) arch.score++;
      });
    });
    archScores.sort(function (a, b) {
      return b.score - a.score;
    });
    archetypes = archScores[0].score > 0 ? [archScores[0]] : [{
      key: "chrysalis",
      title: "Something is dissolving",
      line: "What you were is making room for what you're becoming."
    }];
  ...
  useEffect(function () {
    if (!savedRef.current && sd.themes) {
      savedRef.current = true;
      saveSession(Object.assign({}, sd, {
        rawText: rawText,
  ...
  var history = useMemo(function () {
    return getArchetypeHistory();
  }, []);
  var timeline = useMemo(function () {
    return getSessionTimeline();
  }, []);
  ...
  var prevArch = prevSession && prevSession.archetypes && prevSession.archetypes[0] ? prevSession.archetypes[0] : null;
  var themeRecurrence = {};
  allSessions.forEach(function (s) {
    var seen = {};
    (s.themes || []).forEach(function (t) {
      if (!seen[t.label]) {
        seen[t.label] = true;
        themeRecurrence[t.label] = (themeRecurrence[t.label] || 0) + 1;
      }
    });
  });
  ...
  var hasPersistentThemes = themesClassified.some(function (t) {
    return t.tier === "persistent";
  });
  var hasReturningThemes = themesClassified.some(function (t) {
    return t.tier === "returning" || t.tier === "persistent";
  });
  var alchemyArc = allSessions.map(function (s) {
    return {
      stage: s.alchemy ? s.alchemy.stage : null,
      date: s.date
    };
  }).filter(function (a) {
    return a.stage;
  ...
  if (currentTensionA || currentTensionB) {
    allSessions.forEach(function (s) {
      ...
      if (pa && (pa === currentTensionA || pa === currentTensionB) || pb && (pb === currentTensionA || pb === currentTensionB)) {
        tensionReturnCount++;
      }
    });
  }
  ...
  var topWord = Object.keys(freq).sort(function (a, b) {
    return freq[b] - freq[a];
  })[0] || "this";
  var topWordCount = freq[topWord] || 0;
  var strongConn = conns[0] || null;
  var primaryArch = archetypes[0] ? Object.assign({
    color: themes[0] && themes[0].color || "#E84393"
  }, archetypes[0]) : null;
  ...
  useEffect(function () {
    ...
    (async function () {
      try {
        ...
        if (themes.length) currBrief += "themes:" + themes.map(function (t) {
          return t.label;
        }).join(",") + "\n";
        ...
        var corrVoice = Object.values(corrections).filter(function (c) {
          return typeof c === "string" && c.length > 4;
        }).slice(0, 2);
        ...
        var arcBrief = allSessions.slice(-6).map(function (s, si) {
          ...
          if (s.themes && s.themes[0]) parts.push("theme:" + s.themes.slice(0, 2).map(function (t) {
            return t.label;
          }).join(","));
          if (s.tension && s.tension.a) parts.push("tension:" + s.tension.a + "vs" + s.tension.b);
          ...
          var sc = s.corrections ? Object.values(s.corrections).filter(function (c) {
            return typeof c === "string" && c.length > 4;
          }).slice(0, 1) : [];
  ...
  useEffect(function () {
    ...
    (async function () {
      try {
        if (allSessions.length + 1 < 2) {
          setWgLineReady(true);
          return;
        } // whats_growing isn't shown before session 2
        var wgFreq = {};
        allSessions.slice(-5).forEach(function (s, si) {
          var w = si + 1;
          (s.themes || []).forEach(function (t) {
            if (!t.label) return;
            wgFreq[t.label] = (wgFreq[t.label] || 0) + w;
          });
        });
        themes.forEach(function (t) {
          if (!t.label) return;
        ...
        if (!cancelled) setWgLineReady(true);
      }
    })();
    return function () {
      cancelled = true;
  ...
  function setCardComment(key, text) {
    setCardComments(function (prev) {
      return Object.assign({}, prev, {
        [key]: text
      });
    });
    ...
    setFieldCardSentenceFeedback(function (prev) {
      ...
      try {
        ...
        if (sessions.length > 0) {
          ...
          sessions[sessions.length - 1] = Object.assign({}, last, {
            sentenceFeedback: merged
          });
          localStorage.setItem(_sessionKey(), JSON.stringify(sessions));
          if (window.storage && window.currentUser && window.currentUser.id !== "local-user") {
            window.storage.set("sessions", JSON.stringify(sessions)).catch(function () {});
  ...
  var [bookmarks, setBookmarks] = useState(function () {
    try {
      return JSON.parse(localStorage.getItem("saycrd-" + getCurrentUid() + "-bookmarks") || "[]");
    } catch (e) {
      return [];
    }
  });
  useEffect(function () {
    function onAuth() {
      try {
        setBookmarks(JSON.parse(localStorage.getItem("saycrd-" + getCurrentUid() + "-bookmarks") || "[]"));
      } catch (e) {
        setBookmarks([]);
      }
    }
  ...
  var renderCard = function () {
    switch (card.type) {
      case "milestone":
        {
          return /*#__PURE__*/React.createElement(MilestoneCard, {
      ...
      case "field_condition":
        {
          return /*#__PURE__*/React.createElement(FieldConditionCard, {
            themes: themes,
            sd: sd,
      ...
      case "arch_billboard":
        {
          return /*#__PURE__*/React.createElement(ArchBillboardCard, {
            themes: themes,
            sd: sd,
            primaryArch: primaryArch,
            archColor: archColor,
      ...
      case "depths_field":
        {
          return /*#__PURE__*/React.createElement(DepthsFieldCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            portrait: portrait,
      ...
      case "whats_growing":
        {
          return /*#__PURE__*/React.createElement(WhatsGrowingCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            portrait: portrait,
            portraitReady: portraitReady,
            wgLine: wgLine,
            wgLineReady: wgLineReady,
            goNext: advance
          });
        }
      case "the_mirror":
        {
          return /*#__PURE__*/React.createElement(MirrorCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            rawText: rawText,
            ...
            setSlider: setSlider,
            sliderValues: sliderValues,
            onReadyChange: setMirrorReady
          });
        }
      case "the_realm":
        {
          return /*#__PURE__*/React.createElement(RealmCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            portrait: portrait,
      ...
      case "year_review":
        {
          return /*#__PURE__*/React.createElement(YearReviewCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            portrait: portrait,
      ...
      case "field_report":
        {
          return /*#__PURE__*/React.createElement(FieldReportCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            allSessions: allSessions,
            ...
            onSentenceFeedback: handleFieldCardFeedback,
      ...
      case "the_underdrawing":
        {
          return /*#__PURE__*/React.createElement(UnderdrawingCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            portrait: portrait,
      ...
      case "the_landscape":
        {
          return /*#__PURE__*/React.createElement(LandscapeCard, {
            themes: themes,
            sd: sd,
            sessionCount: sessionCount,
            primaryArch: primaryArch,
      ...
      case "archetype_poster":
        {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              ...
              height: 300,
              borderRadius: "50%",
              background: "radial-gradient(circle, " + apColor + "18, transparent 70%)",
              filter: "blur(50px)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
          ...
          }, sessionCount > 1 ? "SESSION " + sessionCount : "FIRST SESSION"), apShowEvol && apLastArch && /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
              top: 48,
              right: 28,
          ...
          }, "evolving from", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
            style: {
              color: apColor + "99"
            }
          }, apLastArch.name)), /*#__PURE__*/React.createElement("div", {
            style: {
            ...
            color: apColor,
            size: 150
          })), apThe && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              letterSpacing: "0.55em",
              color: apColor + "66",
              fontFamily: FB,
              marginBottom: 4,
              animation: "riseUp 0.8s ease 0.15s both"
            }
          }, apThe), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: apHero.length > 16 ? 26 : apHero.length > 12 ? 34 : apHero.length > 8 ? 40 : 48,
              fontWeight: 700,
              color: "white",
              fontFamily: FB,
              letterSpacing: "0.06em",
              textAlign: "center",
              lineHeight: 1.1,
              animation: "riseUp 0.8s ease 0.25s both",
              textShadow: "0 0 60px " + apColor + "44",
              maxWidth: "100%",
              paddingLeft: 20,
              paddingRight: 20,
              boxSizing: "border-box",
          ...
          }, apHero), apLine && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 14,
              fontSize: 16,
              color: "rgba(255,255,255,0.5)",
          ...
          }, apLine), apSources.length > 0 && /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              gap: 8,
              flexWrap: "wrap",
              justifyContent: "center",
              marginTop: 22,
              animation: "riseUp 0.7s ease 0.6s both"
            }
            ...
            return /*#__PURE__*/React.createElement("div", {
              ...
              style: {
                ...
                padding: "4px 10px",
                borderRadius: 12,
                border: "1px solid " + apColor + "22",
                background: apColor + "0A"
              }
            }, src);
          })));
        }
      case "arch_evolution":
        {
          ...
          return /*#__PURE__*/React.createElement("div", {
          ...
          }, "what shifted"), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              alignItems: "center",
              gap: 24,
          ...
          }, ev ? ev.name : ""), ev && ev.line && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              color: "rgba(255,255,255,0.2)",
              fontFamily: FD,
          ...
          }, ev.line.slice(0, 60), ev.line.length > 60 ? "…" : "")), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
            ...
            style: {
              width: 2,
              height: 40,
              background: "linear-gradient(180deg, rgba(255,255,255,0.06), " + evCurColor + "55)"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 18,
            ...
            style: {
              fontSize: evCurName.length > 14 ? 14 : evCurName.length > 10 ? 15 : 17,
              color: "rgba(255,255,255,0.85)",
              fontFamily: FB,
              fontWeight: 700,
              marginTop: 4,
          ...
          }, evCurName), evCur.line && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              color: "rgba(255,255,255,0.4)",
              fontFamily: FD,
          ...
          }, evCur.line.slice(0, 60), evCur.line.length > 60 ? "…" : ""))), sd.synthesis && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 32,
              fontSize: 14,
              color: "rgba(255,255,255,0.35)",
      ...
      case "live_tension":
        {
          ...
          var ltColA = card.colA || "#E84393";
          var ltColB = card.colB || "#6BB8FF";
          var ltArchName = card.archName || "";
          var ltArchLine = card.archLine || "";
          ...
          var surpriseQs = ["What does " + ltA + " need from " + ltB + " that it hasn't asked for yet?", "If " + ltA + " and " + ltB + " switched places for a day — what breaks?", "What would it cost to fully separate " + ltA + " from " + ltB + "?", "Which one is protecting the other?", "What do " + ltA + " and " + ltB + " have in common that you haven't named yet?"];
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              ...
              height: 260,
              borderRadius: "50%",
              background: "radial-gradient(circle, " + ltColA + "1A, transparent 65%)",
              filter: "blur(60px)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              ...
              height: 240,
              borderRadius: "50%",
              background: "radial-gradient(circle, " + ltColB + "18, transparent 65%)",
              filter: "blur(60px)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement(FieldParticles, {
            color: ltAlive ? ltColA : "rgba(255,255,255,0.3)",
            count: ltAlive ? 18 : 10
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
          ...
          }, ltUser ? "YOUR INSIGHT" : "THE CONNECTION"), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              alignItems: "center",
              width: "100%",
            ...
            style: {
              ...
              padding: "14px 16px",
              borderRadius: 16,
              background: ltColA + "18",
              border: "1.5px solid " + ltColA + "44",
              textAlign: "center",
              minWidth: 0
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: ltA.length > 14 ? 12 : ltA.length > 10 ? 13 : 15,
              color: "rgba(255,255,255,0.9)",
              fontFamily: FB,
              fontWeight: 700,
              lineHeight: 1.3,
          ...
          }, ltA)), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
            ...
            style: {
              width: 2,
              height: 20,
              background: "linear-gradient(180deg," + ltColA + "66, " + ltColB + "66)"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 8,
          ...
          }, axisLabel), /*#__PURE__*/React.createElement("div", {
            style: {
              width: 2,
              height: 20,
              background: "linear-gradient(180deg," + ltColA + "66, " + ltColB + "66)"
            ...
            style: {
              ...
              padding: "14px 16px",
              borderRadius: 16,
              background: ltColB + "18",
              border: "1.5px solid " + ltColB + "44",
              textAlign: "center",
              minWidth: 0
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: ltB.length > 14 ? 12 : ltB.length > 10 ? 13 : 15,
              color: "rgba(255,255,255,0.9)",
              fontFamily: FB,
              fontWeight: 700,
              lineHeight: 1.3,
          ...
          }, ltB))), ltInsight && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 22,
              fontSize: ltInsight.length > 80 ? 17 : 21,
              color: ltAlive ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.72)",
              fontFamily: FD,
              fontStyle: "italic",
              lineHeight: 1.7,
              textAlign: "center",
              ...
              animation: "riseUp 0.8s ease 0.25s both",
              transition: "color 0.4s",
              textShadow: ltAlive ? "0 0 40px " + ltColA + "33" : "none"
            }
          }, ltUser && /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 10,
              color: ltColA + "99",
              fontFamily: FB,
          ...
          }, "you said \u2193"), "\"", ltInsight, "\""), !ltAway && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 20,
              padding: "14px 18px",
              borderRadius: 16,
              ...
              maxWidth: 310,
              animation: "riseUp 0.8s ease 0.45s both"
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 10,
          ...
          }, "to sit with"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 15,
              color: ltAlive ? "rgba(255,255,255,0.78)" : "rgba(255,255,255,0.5)",
              fontFamily: FD,
              lineHeight: 1.65,
              transition: "color 0.4s"
            }
          }, surpriseQ)), ltArchName && (ltA.length > 0 || ltB.length > 0) && !ltAway && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 16,
              display: "flex",
              alignItems: "center",
            ...
            style: {
              fontSize: 9,
              color: ltArchColor + "88",
              fontFamily: FB,
              letterSpacing: "0.2em",
              textTransform: "uppercase"
            }
          }, ltArchName), ltArchLine && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              color: "rgba(255,255,255,0.3)",
              fontFamily: FD,
          ...
          }, ltArchLine))), /*#__PURE__*/React.createElement("div", {
            style: {
              width: "100%",
              maxWidth: 320,
              marginTop: 20,
              animation: "riseUp 0.7s ease 0.7s both"
            },
            "data-noadvance": "true"
          }, /*#__PURE__*/React.createElement("div", {
            style: {
          ...
          }, "PUSHING AWAY"), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 10,
              color: "rgba(255,255,255,0.25)",
              fontFamily: FB,
          ...
          }, "LANDS")), /*#__PURE__*/React.createElement("div", {
            style: {
              position: "relative",
              height: 6,
            ...
            style: {
              ...
              height: "100%",
              width: ltSv + "%",
              background: "linear-gradient(90deg," + ltColA + "66," + ltColB + ")",
              borderRadius: 3,
              transition: "width 0.15s",
              boxShadow: ltAlive ? "0 0 10px " + ltColB + "55" : "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
              ...
              height: 16,
              borderRadius: "50%",
              background: ltAlive ? ltColB : "rgba(255,255,255,0.4)",
              border: "2px solid rgba(255,255,255,0.6)",
              transition: "left 0.15s, background 0.3s",
              boxShadow: ltAlive ? "0 0 8px " + ltColB : "none"
            }
          })), ltAway && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 10,
              fontSize: 12,
              color: "rgba(255,255,255,0.4)",
      ...
      case "arrival":
        return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
          color: "#E84393",
          count: 28
        }), /*#__PURE__*/React.createElement("div", {
          style: {
        ...
        }, sessionCount > 1 ? "SESSION " + sessionCount : "THIS SESSION"), /*#__PURE__*/React.createElement(FHero, {
          size: 48,
          color: "white"
        }, arrival ? arrival.line : "Your\nField"), arrival && arrival.energy && /*#__PURE__*/React.createElement("div", {
          style: {
            marginTop: 28,
            display: "flex",
            alignItems: "center",
          ...
          style: {
            ...
            borderRadius: "50%",
            background: "#E84393",
            boxShadow: "0 0 14px rgba(232,67,147,0.5)"
          }
        }), /*#__PURE__*/React.createElement("span", {
          style: {
            fontSize: 12,
        ...
        }, arrival.energy)), archetypes.length > 0 && archReg && /*#__PURE__*/React.createElement("div", {
          style: {
            display: "flex",
            gap: 10,
            marginTop: 36,
            flexWrap: "wrap",
            justifyContent: "center",
            animation: "riseUp 0.8s ease 0.8s both"
          }
        }, /*#__PURE__*/React.createElement("div", {
          style: {
            padding: "6px 16px",
            borderRadius: 20,
            background: archReg.color + "14",
            border: "1px solid " + archReg.color + "30",
            fontSize: 12,
            color: archReg.color + "cc",
            fontFamily: FB
          }
      ...
      case "words":
        {
          ...
          var tones = [{
            ...
            label: "Doubt",
            color: "#6BB8FF",
            words: ["maybe", "unsure", "wonder", "question", "not sure", "unclear", "confused", "doubt", "uncertain", "hesit"]
          }, {
            key: "clarity",
            label: "Clarity",
            color: "#6BFFB8",
            words: ["clear", "understand", "realize", "see now", "know", "certain", "obvious", "makes sense", "finally"]
          }, {
            key: "optimism",
            label: "Optimism",
            color: "#FFD700",
            words: ["hope", "better", "possible", "excited", "looking forward", "believe", "will", "can", "going to", "good"]
          }, {
            key: "frustration",
            label: "Frustration",
            color: "#FF6B9D",
            words: ["frustrated", "stuck", "again", "why", "tired", "enough", "over it", "annoyed", "keeps", "always", "never"]
          }, {
            key: "curiosity",
            label: "Curiosity",
            color: "#B86BFF",
            words: ["curious", "wonder", "what if", "interesting", "explore", "discover", "notice", "find", "question", "how"]
          }, {
            key: "urgency",
            label: "Urgency",
            color: "#FFB86B",
            words: ["need", "must", "now", "urgent", "soon", "time", "quickly", "asap", "before", "deadline", "running out"]
          }];
          ...
          return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            ...
            color: "#6BFFB8"
          }, "YOU POURED"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: wordCount > 999 ? 90 : 116,
              fontWeight: 300,
              color: "white",
              lineHeight: 1,
              fontFamily: FD,
          ...
          }, "What came through"), scored.map(function (t, i) {
            var pct = Math.min(100, Math.round(t.score / maxScore * 100));
            return /*#__PURE__*/React.createElement("div", {
              key: t.key,
              style: {
                animation: "riseUp 0.5s ease " + (0.45 + i * 0.12) + "s both"
              }
            }, /*#__PURE__*/React.createElement("div", {
              style: {
                display: "flex",
              ...
              style: {
                ...
                borderRadius: 3,
                animation: "growWidth 0.9s ease " + (0.5 + i * 0.15) + "s both",
      ...
      case "top_themes":
        return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
          ...
          color: "#FF6B9D"
        }, "YOUR FORCES"), /*#__PURE__*/React.createElement("div", {
          style: {
            display: "flex",
            flexDirection: "column",
            gap: 14,
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              ...
              alignItems: "center",
              gap: 14,
              animation: "riseUp 0.5s ease " + i * 0.12 + "s both"
            }
          }, /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 26,
            ...
            style: {
              ...
              background: "linear-gradient(90deg, " + t.color + "55, " + t.color + ")",
              borderRadius: 3,
              animation: "growWidth 1s ease " + i * 0.15 + "s both"
            }
          }))));
        })));
      case "synthesis":
        {
          ...
          return /*#__PURE__*/React.createElement(BookmarkableCard, {
            text: synthesis,
            label: "The Reading",
            color: "#D6B26D"
          }, /*#__PURE__*/React.createElement("div", {
            ...
            color: alive ? "#E8B84E" : "#D6B26D",
            count: alive ? 20 : 8
          }), /*#__PURE__*/React.createElement(FLabel, {
            color: "#D6B26D"
          }, "THE READING"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 22,
              color: alive ? "white" : "rgba(255,255,255,0.85)",
              fontFamily: FD,
              lineHeight: 1.65,
              textAlign: "center",
              maxWidth: 320,
            ...
            text: synText,
            feedbackMap: mergedSentenceFeedback,
            onFeedback: handleFieldCardFeedback,
            dark: true
          ...
          }), noticing && !away && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 24,
              padding: "12px 18px",
              borderRadius: 12,
              background: "rgba(214,178,109,0.07)",
          ...
          }, "didn't land \u2014 keep moving"), /*#__PURE__*/React.createElement(AccuracySlider, {
            value: sv,
            onSlide: function (v) {
              setSlider("synthesis", v);
            },
            color: "#D6B26D",
            leftLabel: "doesn't fit",
            rightLabel: "exactly this"
          })));
        }
      case "bigword":
        {
          ...
          var bwAlive = bwSv >= 68;
          var bwQuestions = ["What does " + topWord + " want from you right now?", "Every time you wrote " + topWord + ", something needed to be named. What is it?", "You reached for " + topWord + " " + topWordCount + " times. What does it carry?", "The word " + topWord + " showed up repeatedly. Is it a craving, or a weight?"];
          var bwQ = bwQuestions[topWordCount % bwQuestions.length];
          return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            color: bwAlive ? "#A8E8DA" : "#7ECABA",
            count: bwAlive ? 24 : 14
          }), /*#__PURE__*/React.createElement(FLabel, {
            color: "#7ECABA"
          }, "HIDDEN PATTERN"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 14,
              color: "rgba(255,255,255,0.65)",
              fontFamily: FB,
          ...
          }, "you wrote the word"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 52,
              color: bwAlive ? "#A8E8DA" : "#7ECABA",
              fontFamily: FD,
              animation: "riseUp 0.7s ease 0.2s both",
              letterSpacing: "-0.01em",
              textShadow: bwAlive ? "0 0 50px rgba(126,202,186,0.5)" : "none",
              transition: "all 0.4s"
            }
          }, topWord), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 100,
              fontWeight: 300,
              color: "white",
          ...
          }, topWordCount), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 16,
              color: "rgba(255,255,255,0.55)",
              fontFamily: FB,
              animation: "riseUp 0.6s ease 0.45s both",
              marginBottom: 4
            }
            ...
            style: {
              marginTop: 16,
              fontSize: 15,
              color: "rgba(126,202,186,0.8)",
              fontFamily: FD,
              maxWidth: 280,
              textAlign: "center",
              lineHeight: 1.65,
              animation: "riseUp 0.8s ease 0.9s both"
            }
          }, bwQ), /*#__PURE__*/React.createElement(AccuracySlider, {
            value: bwSv,
            onSlide: function (v) {
              setSlider("bigword", v);
            },
      ...
      case "connection":
        {
          ...
          var cAlive = cSv >= 55;
          var cAway = cSv <= 40;
          var fromColor = themes.find(function (t) {
            return t.label === strongConn?.from;
          }) || {
            color: "#FFB86B"
          };
          var toColor = themes.find(function (t) {
            return t.label === strongConn?.to;
          }) || {
            color: "#6BB8FF"
          };
          return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            color: cAlive ? "#9DCFFF" : "#6BB8FF",
            count: cAlive ? 22 : 12
          }), /*#__PURE__*/React.createElement(FLabel, {
            color: "#6BB8FF"
          }, "THE LINK"), strongConn && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              alignItems: "center",
              gap: 14,
              margin: "16px 0",
              animation: "riseUp 0.7s ease 0.1s both",
              filter: cAway ? "opacity(0.4)" : "none",
              transition: "filter 0.4s"
            }
          }, /*#__PURE__*/React.createElement(FOrb, {
            color: fromColor.color
          }, (strongConn.from || "").length > 10 ? strongConn.from.slice(0, 9) + "…" : strongConn.from), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
            ...
            style: {
              width: cAlive ? 64 : 44,
              height: cAlive ? 3 : 2,
              background: "linear-gradient(90deg," + fromColor.color + "," + toColor.color + ")",
              boxShadow: cAlive ? "0 0 12px rgba(107,184,255,0.4)" : "none",
              transition: "all 0.4s"
            }
          }), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: strongConn.label.length > 12 ? 9 : strongConn.label.length > 8 ? 10 : 11,
              color: "rgba(255,255,255,0.55)",
              fontFamily: FB,
              fontWeight: 700,
              textTransform: "uppercase",
          ...
          }, strongConn.label)), /*#__PURE__*/React.createElement(FOrb, {
            color: toColor.color
          }, (strongConn.to || "").length > 10 ? strongConn.to.slice(0, 9) + "…" : strongConn.to)), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 19,
              color: cAlive ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.72)",
              fontFamily: FD,
              maxWidth: 290,
              lineHeight: 1.65,
              animation: "riseUp 0.8s ease 0.35s both",
              textShadow: cAlive ? "0 0 30px rgba(107,184,255,0.3)" : "none",
              transition: "all 0.4s"
            }
          }, strongConn.insight), cAlive && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 12,
              fontSize: 14,
              color: "rgba(107,184,255,0.7)",
              fontFamily: FB,
              animation: "riseUp 0.5s ease both"
            }
          }, "What does this connection ask of you?"), cAway && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 12,
              fontSize: 14,
              color: "rgba(255,255,255,0.5)",
          ...
          }, "Not quite \u2014 explore the map to find the link that does fit.")), /*#__PURE__*/React.createElement(AccuracySlider, {
            value: cSv,
            onSlide: function (v) {
              setSlider("connection", v);
            },
            color: "#6BB8FF",
            leftLabel: "forced",
            rightLabel: "I see it",
      ...
      case "tension":
        {
          ...
          var tAlive = tSv >= 68;
          var tAway = tSv <= 32;
          var tQuestions = ["What would it cost you to stop managing this tension?", "Which side are you secretly on?", "What if the tension IS the answer — not a problem to solve?", "Who taught you these two things couldn't coexist?"];
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            color: "#6BB8FF"
          }, "YOUR TENSION"), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: tStack ? "column" : "row",
              justifyContent: "space-between",
              gap: 12,
              width: "100%",
              maxWidth: 340,
            ...
            style: {
              ...
              fontSize: String(tA).length > 14 ? 16 : String(tA).length > 10 ? 18 : 20,
              color: "#FF8080",
              fontFamily: FD,
              fontWeight: 600,
              whiteSpace: "nowrap"
            ...
            style: {
              ...
              fontSize: String(tB).length > 14 ? 16 : String(tB).length > 10 ? 18 : 20,
              color: "#6BC5FF",
              fontFamily: FD,
              fontWeight: 600,
              whiteSpace: "nowrap"
            }
          }, tB)), /*#__PURE__*/React.createElement(TensionPull, {
            clicked: clicked
            ...
            style: {
              fontSize: 19,
              color: tAlive ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.78)",
              fontFamily: FD,
              maxWidth: 290,
              lineHeight: 1.65,
              transition: "color 0.3s",
              textShadow: tAlive ? "0 0 30px rgba(107,184,255,0.25)" : "none"
            }
          }, tText), tAlive && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 18,
              fontSize: 15,
              color: "rgba(107,197,255,0.75)",
              fontFamily: FD,
              maxWidth: 280,
              lineHeight: 1.6,
              animation: "riseUp 0.5s ease both"
            }
          }, tQ), tAway && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 18,
              fontSize: 14,
              color: "rgba(255,255,255,0.5)",
          ...
          }, "This doesn't fit \u2014 bring your real tension into the map."), /*#__PURE__*/React.createElement(AccuracySlider, {
            value: tSv,
            onSlide: function (v) {
              setSlider("tension", v);
            },
      ...
      case "underneath":
        {
          ...
          var uAlive = uSv >= 68;
          return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            color: uAlive ? "#D08BFF" : "#B86BFF",
            count: uAlive ? 20 : 10
          }), /*#__PURE__*/React.createElement(FLabel, {
            color: "#B86BFF"
          }, "WHAT'S UNDERNEATH"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              color: "rgba(255,255,255,0.35)",
              fontFamily: FB,
          ...
          }, "Patterns that are hard to see yourself \u2014 repetition, structure, what's in hiding."), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "column",
              gap: 12,
            ...
            return /*#__PURE__*/React.createElement(UnderneathItem, {
              key: idx,
              text: text,
              index: idx,
              feedback: propSentenceFeedback ? propSentenceFeedback[(text || "").slice(0, 100)] : null,
              onFeedback: onSentenceFeedback
            });
          })));
        }
      case "blind_spot":
        {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            return /*#__PURE__*/React.createElement("div", {
              ...
              style: {
                ...
                animation: "sweep " + (4 + i * 1.5) + "s ease-in-out infinite",
          ...
          }, "WHAT YOU MIGHT NOT SEE"), /*#__PURE__*/React.createElement("div", {
            style: {
              textAlign: "center",
              maxWidth: 320,
              marginBottom: 16
            ...
            return /*#__PURE__*/React.createElement("span", {
              ...
              style: {
                ...
                marginBottom: 4,
                transition: "color 0.4s",
                textShadow: bsAlive ? "0 0 20px rgba(80,140,255,0.4)" : "none"
              }
            }, w);
          })), bsAlive && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 15,
          ...
          }, "What becomes possible when you can finally see this?"), bsAway && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 14,
              color: "rgba(255,255,255,0.5)",
              fontFamily: FB,
          ...
          }, "Not the right angle \u2014 keep exploring."), /*#__PURE__*/React.createElement(AccuracySlider, {
            value: bsSv,
            onSlide: function (v) {
              setSlider("blind_spot", v);
            },
            color: "#5090FF",
            leftLabel: "way off",
            rightLabel: "that's the gap"
          })));
        }
      case "archetype":
        {
          ...
          try {
            vizEl = /*#__PURE__*/React.createElement(Viz, {
              phase: archPhase,
              color: c
            });
          } catch (e) {
            vizEl = /*#__PURE__*/React.createElement("div", {
              style: {
                fontSize: 52
              }
            }, archReg.icon);
          }
          if (!clicked) return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            color: c,
            count: 20
          }), /*#__PURE__*/React.createElement(FLabel, {
            color: c
          }, archReg.name.toUpperCase()), /*#__PURE__*/React.createElement(FHero, {
            size: 26,
            color: "rgba(255,255,255,0.6)"
          }, primaryArch.title || archReg.name), /*#__PURE__*/React.createElement("div", {
            style: {
              margin: "16px 0"
            }
          }, vizEl));
          return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
            ...
            color: c
          }, archReg.name.toUpperCase()), primaryArch.phase && archReg.phases && archReg.phases[primaryArch.phase] && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 11,
              color: c,
              opacity: 0.5,
          ...
          }, primaryArch.phase.replace(/_/g, " ")), /*#__PURE__*/React.createElement("div", {
            style: {
              margin: "8px 0 14px"
            }
          }, vizEl), /*#__PURE__*/React.createElement("div", {
          ...
          }, primaryArch.reading || primaryArch.line || archReg.phases?.dissolving || ""), timesAppeared > 1 && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 16,
              fontSize: 12,
              color: c + "77",
              fontFamily: FB,
              animation: "riseUp 0.6s ease 0.6s both"
            }
          }, "This pattern has visited you ", timesAppeared, " times."), alchemyData && alchemyData.stage && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 22,
              padding: "10px 18px",
              borderRadius: 12,
          ...
          }, (FIELD_ALCHEMY[alchemyData.stage] || {}).label || alchemyData.stage), alchemyData.evidence && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 13,
      ...
      case "portrait":
        return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
          ...
          color: "#E84393"
        }, "SESSION PORTRAIT"), /*#__PURE__*/React.createElement(DataPortrait, {
          themes: themes
        }));
      case "opening":
        return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
          ...
          color: "#6BFFB8"
        }, "WHAT'S OPENING"), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 26,
            color: "#6BFFB8",
            fontFamily: FD,
        ...
        }, opening || "Something is trying to emerge."), /*#__PURE__*/React.createElement("div", {
          style: {
            marginTop: 40,
            textAlign: "center",
            animation: "riseUp 0.8s ease 0.5s both"
        ...
        }, "Your first word"), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 28,
            color: "rgba(255,255,255,0.3)",
            fontFamily: FD,
        ...
        }, firstWord), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 13,
            color: "rgba(255,255,255,0.25)",
            fontFamily: FB,
        ...
        }, "Your last word"), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 36,
            color: "#6BFFB8",
            fontFamily: FD,
      ...
      case "submersion":
        {
          ...
          return /*#__PURE__*/React.createElement("div", {
            style: {
              ...
              inset: 0,
              overflow: "hidden",
              background: subInteracted ? subZone === "truth" ? "linear-gradient(190deg, #010308 0%, #020D1A 30%, #03202E 65%, #041C2A 100%)" : subZone === "uncertain" ? "linear-gradient(190deg, #010308 0%, #0D0B04 30%, #1A1404 65%, #120F04 100%)" : "linear-gradient(190deg, #010308 0%, #04080E 30%, #070A10 65%, #060810 100%)" : "linear-gradient(190deg, #010308 0%, #020810 30%, #030E1C 60%, #040C18 100%)"
            }
          }, !subInteracted && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
              top: "8%",
              left: "20%",
            ...
            style: {
              ...
              filter: "blur(60px)",
              animation: "pulse 5s ease 2s infinite",
              pointerEvents: "none"
            }
          })), subInteracted && /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
              bottom: -40,
              left: "50%",
            ...
            }), isMark && /*#__PURE__*/React.createElement("text", {
              key: "t" + pct,
              x: 2,
              y: y + 3,
              fontSize: 5,
            ...
            cx: 20,
            cy: depthPct / 100 * 550 + 30,
            r: 4,
            fill: subInteracted ? zoneGlow : "rgba(60,140,200,0.5)",
            style: {
              transition: "cy 1.4s cubic-bezier(.25,.46,.45,.94)",
              filter: "url(#blur)"
            }
          }), /*#__PURE__*/React.createElement("polygon", {
            points: "6," + (depthPct / 100 * 550 + 26) + " 20," + (depthPct / 100 * 550 + 30) + " 6," + (depthPct / 100 * 550 + 34),
            fill: subInteracted ? zoneGlow : "rgba(60,140,200,0.4)",
            style: {
              transition: "all 1.4s cubic-bezier(.25,.46,.45,.94)"
            }
          })), /*#__PURE__*/React.createElement(FieldParticles, {
            color: subInteracted ? zoneGlow : "rgba(80,160,220,0.5)",
            count: subInteracted && subZone === "truth" ? 22 : 8
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
              inset: 0,
            ...
            style: {
              fontSize: 8,
              letterSpacing: "0.5em",
              color: subInteracted ? zoneGlow + "CC" : "rgba(60,140,200,0.3)",
              fontFamily: FB,
              textTransform: "uppercase",
              marginBottom: 22,
          ...
          }, depthLabel), subInteracted && subComment && /*#__PURE__*/React.createElement("div", {
            style: {
              width: "100%",
              maxWidth: 300,
              marginBottom: 18,
              padding: "12px 16px",
              borderRadius: 14,
              background: "rgba(" + zoneGlowRGB + ",0.1)",
              border: "1px solid rgba(" + zoneGlowRGB + ",0.3)",
              animation: "riseUp 0.8s ease both"
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
          ...
          }, subZone === "away" ? "YOUR READ" : "YOUR WORDS"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 18,
              color: "rgba(255,255,255,0.88)",
              fontFamily: FD,
          ...
          }, "\"", subComment, "\"")), /*#__PURE__*/React.createElement("div", {
            style: {
              width: "100%",
              maxWidth: 300,
              marginBottom: subInteracted ? 14 : 20
            }
          }, !subInteracted && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 9,
              letterSpacing: "0.3em",
              color: "rgba(60,140,200,0.3)",
              fontFamily: FB,
              textTransform: "uppercase",
              marginBottom: 14,
              animation: "riseUp 0.7s ease 0.1s both"
            }
          }, "BELOW THE SURFACE"), subInteracted && !subComment && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 9,
              letterSpacing: "0.3em",
              color: zoneGlow + "88",
          ...
          }, subZone === "truth" ? "SURFACED" : subZone === "uncertain" ? "SOMETHING STIRS" : "RECEDING"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: subInteracted && subZone === "truth" ? 22 : 19,
              color: subInteracted ? subZone === "truth" ? "rgba(255,255,255,0.92)" : subZone === "uncertain" ? "rgba(255,255,255,0.62)" : "rgba(255,255,255,0.28)" : "rgba(255,255,255,0.42)",
              fontFamily: FD,
              fontStyle: "italic",
              lineHeight: 1.78,
              maxWidth: 300,
          ...
          }, subDeepText)), subSecText && !subInteracted && /*#__PURE__*/React.createElement("div", {
            style: {
              width: "100%",
              maxWidth: 300,
              marginBottom: 16,
            ...
            style: {
              width: "100%",
              height: 1,
              background: "linear-gradient(90deg, transparent, rgba(60,140,200,0.15), transparent)",
              marginBottom: 12
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
          ...
          }, subSecText.slice(0, 120), subSecText.length > 120 ? "…" : "")), subInteracted && subZone === "truth" && primaryArch && /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              alignItems: "center",
              gap: 10,
          ...
          }, "not mine"), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 9,
              color: "rgba(255,255,255,0.12)",
              fontFamily: FB,
          ...
          }, "something there"), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 9,
              color: "rgba(255,255,255,0.2)",
              fontFamily: FB,
          ...
          }, "deep truth")), /*#__PURE__*/React.createElement("div", {
            style: {
              position: "relative",
              height: 6,
              background: "rgba(255,255,255,0.05)",
            ...
            style: {
              ...
              height: "100%",
              width: (subSv || 50) + "%",
              background: subInteracted ? "linear-gradient(90deg, rgba(70,100,160,0.5), " + zoneGlow + ")" : "linear-gradient(90deg, rgba(30,80,130,0.3), rgba(60,140,200,0.3))",
              borderRadius: 3,
              transition: "width 0.15s, background 0.7s",
            ...
            value: subComment,
            onChange: function (e) {
              setCardComment("submersion", e.target.value);
            },
            ...
            onFocus: function (e) {
              e.currentTarget.style.borderColor = "rgba(" + zoneGlowRGB + ",0.45)";
            },
            onBlur: function (e) {
              e.currentTarget.style.borderColor = "rgba(" + zoneGlowRGB + ",0.18)";
            },
            onKeyDown: function (e) {
              e.stopPropagation();
            },
      ...
      case "theme_arc":
        {
          var tierGroups = {
            persistent: themesClassified.filter(function (t) {
              return t.tier === "persistent";
            }),
            returning: themesClassified.filter(function (t) {
              return t.tier === "returning";
            }),
            new_t: themesClassified.filter(function (t) {
              return t.tier === "new";
            })
          };
          var taMaxSessions = themesClassified.reduce(function (m, t) {
            return Math.max(m, t.sessions || 1);
          }, 1);
          var tierDefs = [{
            key: "persistent",
            label: "STILL WITH YOU",
            sub: "recurring",
            themes: tierGroups.persistent
          }, {
            key: "returning",
            label: "RETURNING",
            sub: "came back",
            themes: tierGroups.returning
          }, {
            key: "new_t",
            label: "EMERGING NOW",
            sub: "first time",
            themes: tierGroups.new_t
          }].filter(function (g) {
            return g.themes.length > 0;
          });
          return /*#__PURE__*/React.createElement("div", {
            style: {
              position: "absolute",
            ...
            style: {
              ...
              width: 300,
              height: 200,
              background: "radial-gradient(ellipse, rgba(107,184,255,0.05), transparent 70%)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
          ...
          }, "YOUR PATTERNS OVER TIME"), /*#__PURE__*/React.createElement("div", {
            style: {
              width: "100%",
              maxWidth: 340,
              display: "flex",
            ...
            return /*#__PURE__*/React.createElement("div", {
              key: tier.key,
              style: {
                animation: "riseUp 0.6s ease " + (0.1 + ti * 0.15) + "s both"
              }
            }, /*#__PURE__*/React.createElement("div", {
              style: {
                display: "flex",
              ...
              return /*#__PURE__*/React.createElement("div", {
                ...
                style: {
                  fontSize: 13,
                  color: "rgba(255,255,255," + (tier.key === "persistent" ? "0.92" : tier.key === "returning" ? "0.68" : "0.45") + ")",
                  fontFamily: FB,
                  fontWeight: 600
                }
              }, t.label), tier.key !== "new_t" && /*#__PURE__*/React.createElement("div", {
                style: {
                  display: "flex",
                  gap: 3
                }
            ...
            style: {
              ...
              fontFamily: FB,
              letterSpacing: "0.15em",
              animation: "riseUp 0.6s ease 0.5s both"
            }
          }, "session ", sessionCount, " of your record"));
        }
      case "alchemy_journey":
        {
          ...
          var stageCounts = {};
          arcArr.forEach(function (a) {
            stageCounts[a.stage] = (stageCounts[a.stage] || 0) + 1;
          });
          var longestSt = Object.keys(stageCounts).reduce(function (b, k) {
            return (stageCounts[k] || 0) > (stageCounts[b] || 0) ? k : b;
          }, Object.keys(stageCounts)[0] || "nigredo");
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            color: curMeta ? curMeta.color : "#B86BFF",
            count: 14
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 9,
          ...
          }, "YOUR ALCHEMICAL ARC"), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              gap: 18,
              marginBottom: 24,
            ...
            var m = ALCH_META[stKey];
            var isCur = stKey === curStage;
            var cnt = stageCounts[stKey] || 0;
            return /*#__PURE__*/React.createElement("div", {
              key: stKey,
              style: {
                display: "flex",
              ...
              style: {
                ...
                borderRadius: "50%",
                background: m.color,
                boxShadow: isCur ? "0 0 14px " + m.color + "99" : "none",
                border: isCur ? "2px solid rgba(255,255,255,0.6)" : "none",
                transition: "all 0.3s"
              }
            }), /*#__PURE__*/React.createElement("span", {
              style: {
                fontSize: 8,
                color: isCur ? "rgba(255,255,255,0.75)" : "rgba(255,255,255,0.25)",
                fontFamily: FB,
                letterSpacing: "0.08em",
                textTransform: "uppercase"
              }
            }, m.label), cnt > 0 && /*#__PURE__*/React.createElement("span", {
              style: {
                fontSize: 8,
                color: "rgba(255,255,255,0.18)",
                fontFamily: FB
            ...
            var m2 = ALCH_META[a.stage] || ALCH_META.nigredo;
            var isCur = di === dotLine.length - 1;
            return /*#__PURE__*/React.createElement("div", {
              key: di,
              style: {
                display: "flex",
              ...
              style: {
                ...
                borderRadius: "50%",
                background: m2.color,
                boxShadow: isCur ? "0 0 18px " + m2.color + "aa" : "none",
                border: isCur ? "2.5px solid rgba(255,255,255,0.7)" : "none",
                flexShrink: 0,
                animation: isCur ? "pulse 2.5s ease infinite" : "none"
              }
            }), di < dotLine.length - 1 && /*#__PURE__*/React.createElement("div", {
              style: {
                width: 12,
                height: 1.5,
          ...
          })), curMeta && /*#__PURE__*/React.createElement("div", {
            style: {
              textAlign: "center",
              animation: "riseUp 0.8s ease 0.35s both"
            }
            ...
            style: {
              ...
              fontWeight: 700,
              letterSpacing: "0.04em",
              textShadow: "0 0 40px " + curMeta.color + "55"
            }
          }, curMeta.label), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 13,
              color: "rgba(255,255,255,0.38)",
              fontFamily: FD,
          ...
          }, curMeta.sub), alchemyData && alchemyData.evidence && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 14,
              fontSize: 14,
              color: "rgba(255,255,255,0.5)",
          ...
          }, "\"", alchemyData.evidence, "\"")), longestSt && longestSt !== curStage && /*#__PURE__*/React.createElement("div", {
            style: {
              marginTop: 14,
              fontSize: 10,
              color: "rgba(255,255,255,0.18)",
          ...
          }, "you've spent the most time in ", (ALCH_META[longestSt] || {
            label: longestSt
          }).label));
        }
      case "opening_shift":
        {
          var osPast = card.past || "";
          var osNow = card.now || "";
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              position: "absolute",
              inset: 0,
              background: "linear-gradient(180deg,transparent 40%," + osColor + "07 100%)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
          ...
          }, "LAST SESSION"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 16,
          ...
          }, osPast.slice(0, 160), osPast.length > 160 ? "…" : "")), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              justifyContent: "center",
              padding: "7px 0",
            ...
            style: {
              width: 1,
              height: 10,
              background: "linear-gradient(180deg,rgba(255,255,255,0.08)," + osColor + "55)"
            }
          }), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 13,
            ...
            style: {
              ...
              background: osColor + "0B",
              border: "1px solid " + osColor + "26",
              animation: "riseUp 0.7s ease 0.25s both"
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 8,
            ...
            style: {
              ...
              fontStyle: "italic",
              lineHeight: 1.7,
              textShadow: "0 0 30px " + osColor + "1A"
            }
          }, osNow.slice(0, 160), osNow.length > 160 ? "…" : ""))));
        }
      case "tension_return":
        {
          var trCount = card.count || 2;
          var trA = tension ? tension.a : "";
          var trB = tension ? tension.b : "";
          var trText = tension ? tension.text : "";
          var trColA = (themes.find(function (t) {
            return t.label === trA;
          }) || themes[0] || {
            color: "#FF8080"
          }).color;
          var trColB = (themes.find(function (t) {
            return t.label === trB;
          }) || themes[1] || themes[0] || {
            color: "#6BB8FF"
          }).color;
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              ...
              height: 200,
              borderRadius: "50%",
              background: "radial-gradient(circle," + trColA + "10,transparent 65%)",
              filter: "blur(50px)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
            style: {
              ...
              height: 200,
              borderRadius: "50%",
              background: "radial-gradient(circle," + trColB + "10,transparent 65%)",
              filter: "blur(50px)",
              pointerEvents: "none"
            }
          }), /*#__PURE__*/React.createElement("div", {
          ...
          }, "THIS TENSION HAS RETURNED"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 50,
              fontWeight: 300,
          ...
          }, retLabel), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              alignItems: "center",
              gap: 12,
          ...
          }, trA), /*#__PURE__*/React.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
            ...
            style: {
              width: 30,
              height: 1.5,
              background: "linear-gradient(90deg," + trColA + "," + trColB + ")"
            }
          }), /*#__PURE__*/React.createElement("span", {
            style: {
              fontSize: 7,
          ...
          }, trB)), trText && /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 16,
              color: "rgba(255,255,255,0.6)",
              fontFamily: FD,
          ...
          }, trText), /*#__PURE__*/React.createElement("div", {
            style: {
              padding: "14px 20px",
              borderRadius: 14,
              background: "rgba(255,255,255,0.025)",
              border: "1px solid rgba(255,255,255,0.06)",
              maxWidth: 300,
              animation: "riseUp 0.7s ease 0.45s both"
            }
          }, /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 8,
          ...
          }, "worth asking"), /*#__PURE__*/React.createElement("div", {
            style: {
              fontSize: 14,
              color: "rgba(255,255,255,0.5)",
              fontFamily: FD,
          ...
          }, "This keeps coming back. Is it something to resolve \u2014 or something to live inside?")));
        }
      case "closing":
        return /*#__PURE__*/React.createElement(FC, null, /*#__PURE__*/React.createElement(FieldParticles, {
          color: "#6BFFB8",
          ...
          return /*#__PURE__*/React.createElement("circle", {
            ...
            attributeName: "opacity",
            values: 0.1 + i * 0.08 + ";" + (0.2 + i * 0.1) + ";" + (0.1 + i * 0.08),
            dur: 3 + i * 0.6 + "s",
            repeatCount: "indefinite"
          }));
        }), /*#__PURE__*/React.createElement("circle", {
          ...
          cy: "80",
          r: "7",
          fill: themes[0] ? themes[0].color : "#6BFFB8",
          opacity: "0.9"
        }, /*#__PURE__*/React.createElement("animate", {
          attributeName: "r",
          values: "7;9;7",
        ...
        }, "THE FIELD"), /*#__PURE__*/React.createElement(FHero, {
          size: 38,
          color: "white"
        }, "You named", /*#__PURE__*/React.createElement("br", null), "what you're", /*#__PURE__*/React.createElement("br", null), "carrying"), primaryArch && /*#__PURE__*/React.createElement("div", {
          style: {
            marginTop: 28,
            padding: "8px 18px",
            borderRadius: 20,
            background: _archColor + "14",
            border: "1px solid " + _archColor + "28",
            fontSize: 13,
            color: _archColor,
            fontFamily: FB
          }
        }, "\u25C6 ", primaryArch.name || archReg && archReg.name || "Your Pattern"), /*#__PURE__*/React.createElement("div", {
          style: {
            marginTop: 32,
            fontSize: 14,
            color: "rgba(255,255,255,0.2)",
      ...
      case "cross_session_portrait":
        return /*#__PURE__*/React.createElement(CrossSessionCard, {
          pastSessions: card.pastSessions || [],
          currentSd: sd
        });
      default:
        return null;
  ...
  if (!card) {
    ...
    }, /*#__PURE__*/React.createElement("div", null, "CARDS: ", CARDS.length, " | current: ", current), CARDS.map(function (c, i) {
      return /*#__PURE__*/React.createElement("div", {
        key: i,
        style: {
          fontSize: 10,
  ...
  return /*#__PURE__*/React.createElement(FieldMobileContext.Provider, {
    value: isMobile
  }, /*#__PURE__*/React.createElement("div", {
    ref: containerRef,
    onClick: handleClick,
    style: {
      ...
      position: "absolute",
      inset: 0,
      cursor: cardStillLoading ? "wait" : "pointer",
      userSelect: "none",
  ...
  }, current + 1, " of ", CARDS.length), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
    ...
    style: {
      ...
      animation: "navGlimmer 3s ease-in-out infinite"
    }
  ...
  }, current < CARDS.length - 1 ? /*#__PURE__*/React.createElement("button", {
    onClick: function (e) {
      e.stopPropagation();
      advance();
    },
    ...
    style: {
      ...
      right: 0,
      bottom: 0,
      animation: clicked ? "morphIn 0.5s ease" : "slideIn 0.35s ease-out"
    }
  }, function () {
    try {
      return renderCard();
    } catch (e) {
      console.error("[FIELD] renderCard crashed on card", current, "type:", card && card.type, "error:", e.message || e);
      return /*#__PURE__*/React.createElement("div", {
        style: {
          position: "absolute",
          inset: 0,
...
function JourneysPhase({
  ...
  var isMobile = typeof window !== "undefined" && window.innerWidth < 480;
  var [captures, setCaptures] = useState(function () {
    try {
      return JSON.parse(localStorage.getItem("saycrd-" + getCurrentUid() + "-captures") || "[]");
    } catch (e) {
      return [];
    }
  });
  useEffect(function () {
    function refresh() {
      try {
        setCaptures(JSON.parse(localStorage.getItem("saycrd-" + getCurrentUid() + "-captures") || "[]"));
      } catch (e) {}
    }
    window.addEventListener("saycrd-captures-updated", refresh);
    return function () {
      window.removeEventListener("saycrd-captures-updated", refresh);
    };
  }, []);
  ...
  function guardedStart() {
    ...
    if (window._showAuthOverlay) {
      window._showAuthOverlay(onStart);
    } else {
      onStart();
    }
  }
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      overflowY: "auto",
      WebkitOverflowScrolling: "touch",
      background: "linear-gradient(160deg, #0A0814 0%, #120A1E 40%, #0E0C1A 100%)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
    ...
    style: {
      ...
      height: 600,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(184,107,255,0.12), transparent 65%)",
      filter: "blur(80px)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      height: 500,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(107,184,255,0.08), transparent 65%)",
      filter: "blur(60px)"
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      maxWidth: 480,
      margin: "0 auto",
      padding: "calc(60px + env(safe-area-inset-top, 0px)) 24px calc(80px + env(safe-area-inset-bottom, 0px))"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
  ...
  }, "YOUR JOURNEYS"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "Your sessions over time")), sessions.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "32px 24px",
      background: "rgba(255,255,255,0.03)",
      borderRadius: 16,
  ...
  }, "No sessions yet. Start your first.")) : isMobile ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    var dateStr = s.date ? new Date(s.date).toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
      year: "numeric"
    }) : "";
    var th = s.map_title || s.mapTitle || (s.themes || []).slice(0, 2).map(function (t) {
      return t.label;
    }).join(" · ") || "—";
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      onClick: onNavigateToReport ? function () {
        onNavigateToReport(idx - 1);
      } : undefined,
      style: {
        gridColumn: "span " + span,
        padding: isMilestone ? "22px 20px" : "16px 18px",
        background: "rgba(255,255,255,0.06)",
        backdropFilter: "blur(12px)",
        WebkitBackdropFilter: "blur(12px)",
        borderRadius: 16,
        border: "1px solid rgba(255,255,255,0.1)",
        animation: "riseUp 0.5s ease " + i * 0.06 + "s both",
        cursor: onNavigateToReport ? "pointer" : "default",
        minHeight: 44,
        touchAction: "manipulation"
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        letterSpacing: "0.2em",
        color: "rgba(184,107,255,0.8)",
        fontFamily: FB,
        fontWeight: 600
      }
    }, "SESSION ", idx), dateStr && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "rgba(255,255,255,0.5)",
        fontFamily: FD,
      ...
      style: {
        fontSize: isMilestone ? 15 : 14,
        color: "rgba(255,255,255,0.85)",
        fontFamily: FD,
        lineHeight: 1.5,
        letterSpacing: "0.01em"
      }
    }, String(th).slice(0, isMilestone ? 80 : 40), String(th).length > (isMilestone ? 80 : 40) ? "…" : ""), arch && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8,
        fontSize: 13,
        color: s.archetypes && s.archetypes[0] && s.archetypes[0].color || "#E84393",
        fontFamily: FD,
        fontStyle: "italic"
      }
    }, arch));
    ...
    var th = (s.themes || []).slice(0, 3).map(function (t) {
      return t.label;
    }).join(" · ");
    var arch = s.archetypes && s.archetypes[0] ? s.archetypes[0].name : "";
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, (s.map_title || s.mapTitle || th || "—").slice(0, 60), (s.map_title || s.mapTitle || th || "").length > 60 ? "…" : ""), arch && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8,
        fontSize: 13,
        color: s.archetypes && s.archetypes[0] && s.archetypes[0].color || "#E84393",
    ...
    }, arch), onNavigateToReport && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 10,
        fontSize: 12,
        color: "rgba(184,107,255,0.6)",
        fontFamily: FB,
        letterSpacing: "0.08em"
      }
    }, "Read full report \u2192"));
  })), captures.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      maxHeight: 260,
      overflowY: "auto",
  ...
  }, "YOUR CAPTURES"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
    ...
    var d = c.date ? new Date(c.date).toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
      year: "numeric"
    }) : "";
    ...
    }, "\"", c.text, "\""), c.note && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 13,
        color: "rgba(255,255,255,0.7)",
        fontFamily: FB,
    ...
    }, c.note), d && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 10,
        fontSize: 11,
        color: "rgba(255,255,255,0.4)",
  ...
  }, "Start a new session"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      fontSize: 14,
      color: "rgba(255,255,255,0.45)",
  ...
  }, "Your field grows with each session."), sessions.length >= 2 && isMobile && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      fontSize: 13,
      color: "rgba(184,107,255,0.6)",
...
function CompletionPhase({
  ...
  var dateStr = lastSession && lastSession.date ? new Date(lastSession.date).toLocaleDateString("en-US", {
    month: "short",
    day: "numeric",
    year: "numeric"
  }) : "";
  var titleStr = lastSession ? lastSession.map_title || lastSession.mapTitle || (themes || []).slice(0, 3).map(function (t) {
    return t.label;
  }).join(" · ") : "";
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "SESSION COMPLETE"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: "clamp(30px, 7vw, 42px)",
      fontFamily: FD,
      fontWeight: 400,
  ...
  }, "You've woven another thread.")), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, arch && arch.name && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isMobile ? 24 : 26,
      fontWeight: 600,
      color: (arch.color || "#E84393") + "ee",
      fontFamily: FD,
      fontStyle: "italic",
      letterSpacing: "0.01em",
      marginBottom: 10,
  ...
  }, arch.name), titleStr && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 16,
      color: "rgba(255,255,255,0.82)",
      fontFamily: FB,
  ...
  }, titleStr), dateStr && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "rgba(255,255,255,0.45)",
      fontFamily: FB,
      letterSpacing: "0.06em",
      marginBottom: introStr ? 14 : 0
    }
  }, dateStr, " \xB7 SESSION ", sessions.length), introStr && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "rgba(255,255,255,0.68)",
      fontFamily: FD,
  ...
  }, introStr), themes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      paddingTop: 16,
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        padding: "6px 12px",
        borderRadius: 10,
        background: (t.color || "#6BB8FF") + "22",
        color: t.color || "#6BB8FF",
        fontSize: 13,
        fontFamily: FB,
        fontWeight: 500,
        letterSpacing: "0.02em"
  ...
  }))), onNavigateToReport && lastIndex >= 0 && /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      onNavigateToReport(lastIndex);
    },
    style: {
      width: "100%",
      textAlign: "left",
      ...
      marginBottom: 32,
      borderRadius: 20,
      background: "linear-gradient(135deg, rgba(232,67,147,0.16), rgba(184,107,255,0.16))",
  ...
  }, "Read Your Report \u2192"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      color: "rgba(255,255,255,0.6)",
      fontFamily: FD,
  ...
  }, "See the full field report")), sessions.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      letterSpacing: "0.4em",
      color: "rgba(184,107,255,0.55)",
      fontFamily: FB,
      marginBottom: 14,
      fontWeight: 600
    }
  }, "YOUR SESSIONS"), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    var idx = sessions.length - i;
    var sDateStr = s.date ? new Date(s.date).toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
      year: "numeric"
    }) : "";
    var sTitle = s.map_title || s.mapTitle || (s.themes || []).slice(0, 3).map(function (t) {
      return t.label;
    }).join(" · ") || "—";
    ...
    }, "SESSION ", idx), sDateStr && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "rgba(255,255,255,0.5)",
        fontFamily: FD,
    ...
    }, sDateStr)), sArch && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 16,
        color: sColor,
        fontFamily: FD,
    ...
    }, sArch), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 14,
        color: "rgba(255,255,255,0.75)",
        fontFamily: FD,
    ...
    }, String(sTitle).slice(0, 60), String(sTitle).length > 60 ? "…" : ""));
  }))), captures.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 32,
      maxHeight: 280,
  ...
  }, "Start a new session"), isRealAccount ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      fontSize: 13,
      color: "rgba(255,255,255,0.4)",
  ...
  }, "Your sessions are saved to your account.") : /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      padding: "18px 20px",
      borderRadius: 16,
  ...
  }, "Your sessions are currently saved only on this device. Create an account to keep your maps and reports connected and available whenever you return."), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      if (window._showAuthOverlay) window._showAuthOverlay(function () {});
    },
    style: {
      padding: "12px 24px",
      borderRadius: 999,
...
function ReportViewerPhase({
  ...
  if (!session) {
    ...
    }, "That report couldn't be found."), /*#__PURE__*/React.createElement("button", {
      onClick: onBack,
      style: {
        padding: "12px 24px",
        borderRadius: 999,
  ...
  var themes = (session.themes || []).map(function (t, i) {
    return {
      label: t.label,
      weight: t.weight || 1,
      color: t.color || NC[i % NC.length]
  ...
  return /*#__PURE__*/React.createElement(FieldMobileContext.Provider, {
  ...
  }, /*#__PURE__*/React.createElement(FieldReportCard, {
    themes: themes,
    sd: session,
    sessionCount: idx + 1,
    allSessions: allSessions,
    ...
    portraitReady: true,
    goNext: function () {},
    sentenceFeedback: session.sentenceFeedback || {},
    onSentenceFeedback: function () {},
    onSessionComplete: undefined,
    onNavigateToJourneys: undefined
  }))));
}
function LandingPhase({
  ...
  useEffect(function () {
    function onAuth() {
      setAuthUser(window.currentUser || null);
    }
    window.addEventListener("saycrd-auth-change", onAuth);
    setAuthUser(window.currentUser || null);
    return function () {
  ...
  useEffect(function () {
    var el = document.getElementById("ws-signout");
    if (el) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 800,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(184,107,255,0.14), transparent 65%)",
      filter: "blur(120px)",
    ...
    style: {
      ...
      height: 700,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(232,67,147,0.11), transparent 65%)",
      filter: "blur(100px)",
      animation: "floatWord 26s ease-in-out infinite",
      animationDelay: "-8s"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      height: 600,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(107,184,255,0.1), transparent 65%)",
      filter: "blur(90px)",
    ...
    style: {
      ...
      height: 500,
      borderRadius: "50%",
      background: "radial-gradient(circle, rgba(107,255,184,0.07), transparent 65%)",
      filter: "blur(80px)",
      animation: "floatWord 18s ease-in-out infinite",
      animationDelay: "-4s"
    }
    ...
    style: {
      ...
      fontWeight: 700,
      letterSpacing: "0.3em",
      background: "linear-gradient(90deg, #E84393, #B86BFF)",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent",
      flexShrink: 0
    }
  }, "SAYCRD"), authUser ? /*#__PURE__*/React.createElement("button", {
    onClick: function () {
  ...
  }, (authUser.email || "").split("@")[0].charAt(0).toUpperCase() || "S") : /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      if (window._showAuthOverlay) window._showAuthOverlay(guardedStart);
    },
    style: {
      flexShrink: 0,
      padding: "8px 16px",
  ...
  }, authUser ? returning ? "new session" : "start a session" : "begin"))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      zIndex: 1,
      maxWidth: 1400,
      margin: "0 auto",
      padding: "0 7vw calc(80px + env(safe-area-inset-bottom, 0px))"
    }
  ...
  }, "A place to go in the moment"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: FD,
  ...
  }, "The space between your inner world and the next true move."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 21,
      fontWeight: 300,
  ...
  }, "SAYCRD listens like a human, shapes what you say into a living visual, and remembers your patterns without turning you into a project."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 14,
      flexWrap: "wrap",
  ...
  }, authUser ? returning ? "continue your journey" : "start a session" : returning ? "continue" : "start a session"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      var el = document.getElementById("saycrd-why");
      if (el) el.scrollIntoView({
        behavior: "smooth"
      });
    },
  ...
  }, "see the concept")), !authUser && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      opacity: show ? 1 : 0,
  ...
  }, "Log in or create an account to save your sessions")), returning && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
  ...
  }, sessions.length, " session", sessions.length !== 1 ? "s" : "", " in your field", authUser ? "" : " · log in to sync across devices"), /*#__PURE__*/React.createElement("div", {
    className: "saycrd-landing-grid",
    style: {
      display: "grid",
  ...
  }, "The Pour"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "rgba(255,255,255,0.35)",
      fontFamily: FD,
  ...
  }, "say everything"))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
      position: "relative",
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      fill: "#E84393",
      opacity: 0.4
    }), i < 8 && /*#__PURE__*/React.createElement("line", {
      x1: x + "%",
      y1: 18 + i * 7 + "%",
  ...
  }, "The Synthesis"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "rgba(255,255,255,0.35)",
      fontFamily: FD,
  ...
  }, "meaning emerges"))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
      position: "relative",
  ...
  }, "you, mapped"))))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      height: 220,
      borderRadius: 24,
    ...
    style: {
      ...
      boxShadow: "0 0 40px rgba(232,67,147,0.3)"
    }
  })), [{
    text: "What matters",
    top: "15%",
    left: "8%",
    c: "rgba(184,107,255,0.15)"
  }, {
    text: "The friction",
    top: "18%",
    right: "10%",
    c: "rgba(232,67,147,0.15)"
  }, {
    text: "What I keep avoiding",
    top: "50%",
    left: "5%",
    c: "rgba(107,184,255,0.1)"
  }, {
    text: "The pull",
    top: "42%",
    right: "12%",
    c: "rgba(232,67,147,0.12)"
  }, {
    text: "Quiet hope",
    bottom: "18%",
    left: "26%",
    c: "rgba(107,255,184,0.1)"
  }, {
    text: "Rest",
    bottom: "22%",
    right: "18%",
    ...
    style: {
      ...
      letterSpacing: "0.2em",
      fontFamily: FB,
      background: "linear-gradient(90deg, #6BB8FF, #B86BFF)",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent"
    }
  }, "MEANING \xB7 NOT RAW WORDS")), /*#__PURE__*/React.createElement("section", {
    id: "saycrd-why",
    style: {
      marginBottom: 72
    }
    ...
    style: {
      ...
      marginBottom: 28,
      letterSpacing: "0.02em",
      background: "linear-gradient(90deg, #6BFFB8, #6BB8FF)",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent"
    }
  }, "Why it exists"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
  ...
  }, [[20, 20], [45, 35], [70, 15], [90, 40], [15, 55], [55, 60], [80, 50], [30, 75], [60, 80], [85, 70], [10, 35], [40, 10], [75, 65], [95, 25], [25, 90], [50, 45], [65, 30], [35, 60], [82, 85], [12, 70]].map(function (p, i) {
  ...
  }, "The gap in the world"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 16,
      fontWeight: 300,
      fontStyle: "italic",
      color: "rgba(220,180,200,0.65)",
      lineHeight: 1.72,
      margin: 0
    }
  }, "There is a moment when you are scattered and nothing feels clear. Journals are blank pages. To-do apps are laughable. Friends are tired. SAYCRD is the place you go in that moment."))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
    ...
    cy: "50%",
    r: "12",
    fill: "rgba(107,255,184,0.12)",
    stroke: "#6BFFB8",
    strokeWidth: "1",
    opacity: "0.4"
  }), [0, 60, 120, 180, 240, 300].map(function (deg, i) {
    var rad = deg * Math.PI / 180;
    var ox = 50 + Math.cos(rad) * 38,
      oy = 50 + Math.sin(rad) * 38;
    var ix = 50 + Math.cos(rad) * 26,
      iy = 50 + Math.sin(rad) * 26;
    return React.createElement("line", {
      key: i,
      x1: ox + "%",
      y1: oy + "%",
  ...
  }, "The loop closes"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 16,
      fontWeight: 300,
  ...
  }, "Internal becomes external, in real time. Seeing the map changes how you relate to it. That shift is the mechanism. It is not productivity. It is clarity."))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
    ...
    var x = 50 + Math.cos(rad) * s.r,
      y = 50 + Math.sin(rad) * s.r * 0.55;
    return React.createElement("circle", {
      key: i,
      cx: x + "%",
      cy: y + "%",
  ...
  }, "The system remembers"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 16,
      fontWeight: 300,
  ...
  }, "The map stays with you. It recognizes patterns across sessions without feeling like surveillance. You build a living map of your inner life."))))), /*#__PURE__*/React.createElement("section", {
    style: {
      marginBottom: 72
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      marginBottom: 24,
      letterSpacing: "0.02em",
      background: "linear-gradient(90deg, #6BB8FF, #E84393)",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent"
    }
  }, "What the system does"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "AI that listens"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 15,
      fontStyle: "italic",
  ...
  }, "It hears what is underneath, collapses related themes, and keeps the map clean even when the dump is long."))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
      position: "relative",
    ...
    return React.createElement("circle", {
      ...
      cx: n[0] + "%",
      cy: n[1] * 130 / 100,
      r: [7, 4, 5, 3, 4, 3, 2.5, 3, 2.5, 2][i],
      fill: "#6BFFB8",
      opacity: [0.9, 0.6, 0.7, 0.5, 0.6, 0.4, 0.4, 0.5, 0.4, 0.35][i]
    });
  ...
  }, "Visual that is alive"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 15,
      fontStyle: "italic",
  ...
  }, "A living field that holds vagueness, weight, proximity, and change over time."))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
      position: "relative",
    ...
    return React.createElement("circle", {
      key: i + 10,
      cx: 50 + Math.cos(rad) * 28 + "%",
      cy: 65 + Math.sin(rad) * 20,
      r: "2.5",
      fill: "#B86BFF",
      opacity: "0.6"
    });
    ...
    return React.createElement("circle", {
      key: i + 20,
      cx: 50 + Math.cos(rad) * 20 + "%",
      cy: 65 + Math.sin(rad) * 15,
      r: "1.8",
      fill: "#6BB8FF",
      opacity: "0.45"
    });
  ...
  }, "Memory with care"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 15,
      fontStyle: "italic",
  ...
  }, "Patterns are remembered, not tracked. The system knows what to surface and what to leave alone."))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: 20,
      overflow: "hidden",
      position: "relative",
    ...
    return React.createElement("line", {
      ...
      y1: 65 + Math.sin(rad) * 12,
      x2: 50 + Math.cos(rad) * 22 + "%",
      y2: 65 + Math.sin(rad) * 22,
      stroke: "#D6B26D",
      strokeWidth: "0.8",
      opacity: "0.2"
    });
  ...
  }, "Practice, not features"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 15,
      fontStyle: "italic",
  ...
  }, "A breath, a pause, a reflection \u2014 only when needed. The experience stays whole."))))), /*#__PURE__*/React.createElement("section", {
    style: {
      textAlign: "center",
      padding: "56px 32px",
      borderRadius: 28,
  ...
  }, "Ready to listen to yourself?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: FD,
      fontSize: 19,
      fontWeight: 300,
  ...
  }, "No account needed. Your session stays private. Just start."), /*#__PURE__*/React.createElement("button", {
    ...
    title: "Download your sessions and patterns as JSON"
...
function SessionLoadingOverlay() {
  ...
  useEffect(function () {
    var t = setInterval(function () {
      setIdx(function (i) {
        return (i + 1) % SESSION_LOADING_PHRASES.length;
      });
    }, 2200);
    return function () {
      clearInterval(t);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "YOUR SESSION"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: isDesktopWide ? 34 : 18,
      fontFamily: FD,
      fontStyle: "italic",
  ...
  }, "Your reading will appear in a moment")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0
    }
    ...
    title: "Weaving your reading",
    labels: ["feedback", "patterns", "threads", "reading", "mirror"],
    isDesktopWide: isDesktopWide
  })));
}
function CoSynthPhase({
  rawText,
  synthesisData,
  mapResponses,
  onSynthesis,
    ...
    (async function () {
      try {
        ...
        Object.keys(mr).forEach(function (key) {
          ...
          var origConn = (sd.connections || []).find(function (c) {
        ...
        if (data && data.themes && data.themes.length > 0) {
          ...
          data.themes = data.themes.map(function (t, i) {
            return Object.assign({}, t, {
              color: NC[i % NC.length]
            });
          });
          ...
          if (data.connections) data.connections = data.connections.map(function (c) {
            var ft = (data.themes || []).find(function (t) {
              return t.label === c.from;
            });
            return Object.assign({}, c, {
              color: ft ? ft.color : NC[0]
  ...
  }, /*#__PURE__*/React.createElement(SessionLoadingOverlay, null));
}
function UserMenu({
  phase,
  setPhase
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderRadius: "50%",
      border: "1px solid rgba(255,255,255,0.2)",
      background: authUser ? "rgba(0,0,0,0.35)" : "rgba(255,255,255,0.08)",
      color: authUser ? "rgba(247,241,231,0.9)" : "rgba(255,255,255,0.7)",
      fontSize: 14,
      fontWeight: 600,
      fontFamily: FB,
      cursor: "pointer",
    ...
    "aria-label": "Account"
  }, authUser ? (authUser.email || "").split("@")[0].charAt(0).toUpperCase() || "S" : "⋯"), open && /*#__PURE__*/React.createElement("div", {
    onClick: function (e) {
      e.stopPropagation();
    },
    style: {
      ...
      animation: "fallIn 0.2s ease both"
    }
  }, showBackToReport && /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      setPhase(6);
      setOpen(false);
    },
  ...
  }, "\u2190 Back to report"), authUser ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, (authUser.email || "").split("@")[0]), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "rgba(255,255,255,0.5)",
      fontFamily: FB
    }
  }, (authUser.email || "").slice(0, 28), (authUser.email || "").length > 28 ? "…" : "")), showDashboard && /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      setPhase(7);
      setOpen(false);
    },
    ...
    onClick: function () {
      if (window._showAuthOverlay) window._showAuthOverlay();
      setOpen(false);
    },
    style: {
      display: "block",
...
function SAYCRDFlow() {
  ...
  const [phase, setPhase] = useState(function () {
    return _hasReturningSessions() ? 7 : 0;
  });
  ...
  useEffect(function () {
    ...
    return function () {
      window.removeEventListener("saycrd-auth-change", handleAuthChange);
    };
  }, []);
    ...
    setSynthesisData(function (prev) {
      ...
      if (patch.connections) {
        ...
        var updated = existing.map(function (c) {
          var m = patch.connections.find(function (pc) {
            return pc.from === c.from && pc.to === c.to;
          });
          return m ? Object.assign({}, c, m) : c;
        });
        patch.connections.forEach(function (pc) {
          if (!updated.find(function (c) {
            return c.from === pc.from && c.to === pc.to;
          })) updated.push(pc);
        });
  ...
  useEffect(function () {
    document.body.classList.toggle("saycrd-landing", cp === "landing");
    document.body.classList.toggle("saycrd-internal", cp !== "landing");
    return function () {
      document.body.classList.remove("saycrd-landing", "saycrd-internal");
    };
  }, [cp]);
  function enterField() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "saycrd-app-shell",
    style: {
      width: "100%",
      background: cp === "map" ? GRADIENTS.map : "linear-gradient(160deg, #0A0A2E 0%, #1A1A4B 40%, #2D1B6B 100%)",
      display: "flex",
      justifyContent: "center",
      alignItems: "stretch"
    }
  }, /*#__PURE__*/React.createElement("link", {
    href: "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400&family=Lora:ital,wght@0,400;0,500;0,600;1,400&family=Space+Grotesk:wght@300;400;500;600&display=swap",
    rel: "stylesheet"
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      maxWidth: cp === "landing" || cp === "complete" || cp === "journeys" || cp === "report" ? "100%" : "var(--saycrd-shell-w)",
      height: "100%",
      minHeight: 0,
      background: GRADIENTS[cp],
      position: "relative",
      display: "flex",
      flexDirection: "column",
      overflow: "hidden",
  ...
  }, phase >= 1 && phase < 6 && /*#__PURE__*/React.createElement(PhaseIndicator, {
    current: phase - 1,
    phases: PHASES.slice(1, 5)
  }), /*#__PURE__*/React.createElement("div", {
    key: phase,
    style: {
      width: "100%",
  ...
  }, cp === "landing" && /*#__PURE__*/React.createElement(LandingPhase, {
    onStart: function () {
      setPhase(1);
    }
  }), cp === "pour" && /*#__PURE__*/React.createElement(PourPhase, {
  ...
  }), cp === "map" && /*#__PURE__*/React.createElement(MapPhase, {
    onComplete: function (mapData) {
      setMapResponses(mapData || {});
      setPhase(4);
    },
    synthesisData: synthesisData,
    rawText: rawText,
    onSynthesis: setSynthesisData,
    onPatchSynthesis: onPatchSynthesis,
    onBack: function () {
      setPhase(1);
    }
  }), cp === "cosynth" && /*#__PURE__*/React.createElement(CoSynthPhase, {
    rawText: rawText,
    synthesisData: synthesisData,
  ...
  }), cp === "session" && /*#__PURE__*/React.createElement(SessionPhase, {
    onComplete: function (sData) {
      setSessionData(sData || {});
      enterField();
    },
    synthesisData: synthesisData,
    onPatchSynthesis: onPatchSynthesis
  }), cp === "field" && /*#__PURE__*/React.createElement(FieldPhase, {
    synthesisData: synthesisData,
    rawText: rawText,
    mapResponses: mapResponses,
    ...
    onNavigateToJourneys: function () {
      setPhase(8);
    }
  }), cp === "complete" && /*#__PURE__*/React.createElement(CompletionPhase, {
    onStart: function () {
      setPhase(1);
    },
    onNavigateToJourneys: function () {
    ...
    onNavigateToReport: function (idx) {
      setReportSessionIndex(idx);
      setPhase(9);
    }
  }), cp === "journeys" && /*#__PURE__*/React.createElement(JourneysPhase, {
    onStart: function () {
      setPhase(1);
    },
    onBack: function () {
  ...
  }), cp === "report" && /*#__PURE__*/React.createElement(ReportViewerPhase, {
    sessionIndex: reportSessionIndex,
    onBack: function () {
      setPhase(7);
    }
  }), fieldTransition && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 999,
      ...
      alignItems: "center",
      justifyContent: "center",
      animation: "morphIn 0.4s ease both"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: FB,
  ...
  }, "entering the field")), cp !== "landing" && /*#__PURE__*/React.createElement(UserMenu, {
    phase: phase,
    setPhase: setPhase
